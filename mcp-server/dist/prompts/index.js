 ...
 */
export async function handleGetPrompt(name, args, state) {
    switch (name) {
        case 'create_wallet':
 ...
 */
async function handleCreateWalletPrompt(args, state) {
    const walletType = args.type || 'standard';
 ...
 */
async function handleSecurityAuditPrompt(state) {
 ...
 */
async function handleBatchGeneratePrompt(args, state) {
