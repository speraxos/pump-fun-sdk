...
class RoturExtension {
  constructor(runtime) {
    ...
    fetch("https://raw.githubusercontent.com/Mistium/Origin-speraxOS/main/Resources/info.json")
      .then((response) => {
  ...
  if (data == "roturEXT_whenAuthenticated") {
    ...
    (async () => {
      ...
      if (localroturdata) {
        ...
        roturExtension.login_prompt({ STYLE_URL: "https://pump-sdk.vercel.app//sperax-dev-repl-rl/libs/roturstyle.css" });
      }
    })();
  }
}
