...
- [Fee Sponsorship](https://solana.com/cookbook/transactions/fee-sponsorship?utm_source=llms&utm_medium=ai&utm_campaign=txt): Learn about Solana's fee sponsorship, including how to sponsor fees for other users and how to get paid for sponsoring fees.
...
- [Pay Fees with Any Token](https://solana.com/cookbook/transactions/pay-fees-with-any-token?utm_source=llms&utm_medium=ai&utm_campaign=txt): Learn how to pay transaction fees with any token using Solana's native fee payer and batching features.
...
- [@solana/client](https://solana.com/docs/ar/frontend/client?utm_source=llms&utm_medium=ai&utm_campaign=txt): قم ببناء واجهات سولانا خفيفة باستخدام بيئة تشغيل عميل سولانا بدون واجهة.
- [@solana/react-hooks](https://solana.com/docs/ar/frontend/react-hooks?utm_source=llms&utm_medium=ai&utm_campaign=txt): شارك حالة @solana/client عبر تطبيق React الخاص بك مع خطافات جاهزة للاستخدام.
- [@solana/web3-compat](https://solana.com/docs/ar/frontend/web3-compat?utm_source=llms&utm_medium=ai&utm_campaign=txt): طبقة توافق مباشرة تتيح لكود @solana/web3.js القديم العمل على أساسيات Kit.
- [Cross Program Invocation](https://solana.com/docs/ar/core/cpi?utm_source=llms&utm_medium=ai&utm_campaign=txt): تعرف على Cross Program Invocation (CPI) في سولانا — كيف يمكن للبرامج استدعاء تعليمات على برامج أخرى، والتعامل مع موقعي PDA، وتكوين الوظائف عبر شبكة سولانا.
- [Mollusk](https://solana.com/docs/ar/programs/testing/mollusk?utm_source=llms&utm_medium=ai&utm_campaign=txt): دليل شامل لاختبار برامج سولانا باستخدام Mollusk
- [Next.js + خطافات React لسولانا](https://solana.com/docs/ar/frontend/nextjs-solana?utm_source=llms&utm_medium=ai&utm_campaign=txt): إعداد تكامل محفظة سولانا في Next.js مع @solana/client و @solana/react-hooks لإرسال تحويلات SOL.
- [Next.js - سولانا كيت](https://solana.com/docs/ar/frontend/kit?utm_source=llms&utm_medium=ai&utm_campaign=txt): إعداد تكامل محفظة سولانا في Next.js مع سولانا كيت.
...
- [أساسيات واجهة سطر أوامر Anchor](https://solana.com/docs/ar/intro/installation/anchor-cli-basics?utm_source=llms&utm_medium=ai&utm_campaign=txt): يستعرض هذا القسم بعض أوامر واجهة سطر أوامر Anchor الشائعة لمساعدتك على البدء.
- [أساسيات واجهة سطر أوامر سولانا](https://solana.com/docs/ar/intro/installation/solana-cli-basics?utm_source=llms&utm_medium=ai&utm_campaign=txt): يستعرض هذا القسم بعض أوامر واجهة سطر أوامر سولانا الشائعة لمساعدتك على البدء.
- [أساسيات واجهة سطر أوامر سيرفبول](https://solana.com/docs/ar/intro/installation/surfpool-cli-basics?utm_source=llms&utm_medium=ai&utm_campaign=txt): تعلم أوامر واجهة سطر أوامر سيرفبول الأساسية للتطوير المحلي على سولانا، بما في ذلك تشغيل validator وكيفية استخدام استوديو سيرفبول.
...
- [إغلاق العملة](https://solana.com/docs/ar/tokens/extensions/close-mint?utm_source=llms&utm_medium=ai&utm_campaign=txt): تعلم كيفية تمكين امتداد MintCloseAuthority.
- [إغلاق حساب التوكن](https://solana.com/docs/ar/tokens/basics/close-account?utm_source=llms&utm_medium=ai&utm_campaign=txt): تعلم كيفية إغلاق حسابات التوكن.
- [إلغاء المفوض](https://solana.com/docs/ar/tokens/basics/revoke-delegate?utm_source=llms&utm_medium=ai&utm_campaign=txt): تعلم كيفية إلغاء مفوض حساب الرمز المميز.
- [إلغاء تجميد الحساب](https://solana.com/docs/ar/tokens/basics/thaw-account?utm_source=llms&utm_medium=ai&utm_campaign=txt): تعلم كيفية إلغاء تجميد حساب توكن مجمد.
- [إنشاء العملاء](https://solana.com/docs/ar/programs/codama/clients?utm_source=llms&utm_medium=ai&utm_campaign=txt): دليل كامل لإنشاء عملاء لبرامج سولانا باستخدام واجهة سطر أوامر Codama.
...
- [إنشاء عملة رمزية](https://solana.com/docs/ar/tokens/basics/create-mint?utm_source=llms&utm_medium=ai&utm_campaign=txt): تعلم كيفية إنشاء عملة رمزية SPL.
...
- [البرامج](https://solana.com/docs/ar/core/programs?utm_source=llms&utm_medium=ai&utm_campaign=txt): تعرف على برامج سولانا (العقود الذكية) وكيفية تطويرها باستخدام Rust أو إطار عمل Anchor. افهم نشر البرامج وترقياتها والتحقق منها على شبكة سولانا.
- [التثبيت السريع](https://solana.com/docs/ar/intro/installation/?utm_source=llms&utm_medium=ai&utm_campaign=txt): دليل تثبيت سريع يتيح لك إعداد بيئة تطوير سولانا المحلية بأمر واحد. قم بتثبيت Rust وواجهة سطر أوامر سولانا وإطار عمل Anchor على نظام ويندوز (WSL) ولينكس وماك.
- [التحقق من البرامج](https://solana.com/docs/ar/programs/verified-builds?utm_source=llms&utm_medium=ai&utm_campaign=txt): البناءات المتحقق منها هي طريقة لربط برنامجك بكود المصدر الخاص به والسماح للجميع بالتحقق بشكل مستقل من أن البرنامج تم بناؤه بالفعل من كود المصدر المقدم.
...
- [التعليمات](https://solana.com/docs/ar/core/instructions?utm_source=llms&utm_medium=ai&utm_campaign=txt): تعرف على تعليمات سولانا - اللبنات الأساسية للتفاعل مع بلوكتشين سولانا. افهم تكوين التعليمات من خلال أمثلة عملية.
...
- [الحالة الافتراضية](https://solana.com/docs/ar/tokens/extensions/default-state?utm_source=llms&utm_medium=ai&utm_campaign=txt): تعلم كيفية تمكين DefaultAccountStateExtension.
- [الحسابات](https://solana.com/docs/ar/core/accounts?utm_source=llms&utm_medium=ai&utm_campaign=txt): تعرف على نموذج حساب سولانا، بما في ذلك كيفية تخزين الحسابات للبيانات والبرامج، وآليات الإيجار (rent)، وملكية الحساب، والعلاقة بين البرامج وحسابات البيانات. افهم المفاهيم الأساسية لنظام تخزين المفاتيح والقيم في سولانا.
- [الرموز المميزة ذات الفائدة](https://solana.com/docs/ar/tokens/extensions/interest-bearing-tokens?utm_source=llms&utm_medium=ai&utm_campaign=txt): تعلم كيفية تمكين InterestBearingMintExtension.
- [الرموز غير القابلة للتحويل](https://solana.com/docs/ar/tokens/extensions/non-transferrable-tokens?utm_source=llms&utm_medium=ai&utm_campaign=txt): تعلم كيفية تمكين InitializeNonTransferableMint.
...
- [المعاملات](https://solana.com/docs/ar/core/transactions?utm_source=llms&utm_medium=ai&utm_campaign=txt): تعرف على معاملات سولانا - اللبنات الأساسية للتفاعل مع بلوكتشين سولانا. افهم بنية المعاملات وتكوين التعليمات مع أمثلة عملية.
- [المفاهيم الأساسية](https://solana.com/docs/ar/core/?utm_source=llms&utm_medium=ai&utm_campaign=txt): تعلم المفاهيم الأساسية لبلوكتشين سولانا بما في ذلك الحسابات والمعاملات والبرامج والعناوين المشتقة من البرامج واستدعاءات البرامج المتقاطعة، وكيفية عمل الرموز على سولانا.
- [المفوض الدائم](https://solana.com/docs/ar/tokens/extensions/permanent-delegate?utm_source=llms&utm_medium=ai&utm_campaign=txt): تعلم كيفية تنفيذ امتداد InitializePermanentDelegate.
- [الموافقة على المفوض](https://solana.com/docs/ar/tokens/basics/approve-delegate?utm_source=llms&utm_medium=ai&utm_campaign=txt): تعلم كيفية الموافقة على المفوضين لحساب token account.
- [الواجهة الأمامية](https://solana.com/docs/ar/frontend/?utm_source=llms&utm_medium=ai&utm_campaign=txt): تعلم كيفية بناء واجهات لبرامج سولانا.
- [امتدادات البيانات الوصفية ومؤشر البيانات الوصفية](https://solana.com/docs/ar/tokens/extensions/metadata?utm_source=llms&utm_medium=ai&utm_campaign=txt): تعلم كيفية تمكين امتداد MetadataPointerExtension وامتداد TokenMetadata.
...
- [بنية البرنامج](https://solana.com/docs/ar/programs/rust/program-structure?utm_source=llms&utm_medium=ai&utm_campaign=txt): تعلم كيفية هيكلة برامج سولانا في لغة Rust، بما في ذلك نقاط الدخول، وإدارة الحالة، ومعالجة التعليمات، والاختبار.
- [تثبيت التبعيات](https://solana.com/docs/ar/intro/installation/dependencies?utm_source=llms&utm_medium=ai&utm_campaign=txt): دليل لإعداد بيئة تطوير سولانا المحلية الخاصة بك. تعلم كيفية تثبيت Rust وواجهة سطر أوامر سولانا وإطار عمل Anchor على نظام ويندوز (WSL) ولينكس وماك.
- [تجميد الحساب](https://solana.com/docs/ar/tokens/basics/freeze-account?utm_source=llms&utm_medium=ai&utm_campaign=txt): تعلم كيفية تجميد حسابات token.
...
- [تحويل الرموز](https://solana.com/docs/ar/tokens/basics/transfer-tokens?utm_source=llms&utm_medium=ai&utm_campaign=txt): تعلم كيفية تحويل الرموز بين حسابات الرموز.
- [تحويل المذكرة](https://solana.com/docs/ar/tokens/extensions/memo-transfer?utm_source=llms&utm_medium=ai&utm_campaign=txt): تعلم كيفية تمكين MemoTransferExtension.
...
- [تعيين السلطة](https://solana.com/docs/ar/tokens/basics/set-authority?utm_source=llms&utm_medium=ai&utm_campaign=txt): تعلم كيفية تعيين السلطة لحسابات mint أو حسابات الرموز.
...
- [حرق الرموز](https://solana.com/docs/ar/tokens/basics/burn-tokens?utm_source=llms&utm_medium=ai&utm_campaign=txt): تعلم كيفية حرق الرموز.
- [حسابات الرهن](https://solana.com/docs/ar/references/staking/stake-accounts?utm_source=llms&utm_medium=ai&utm_campaign=txt)
- [حماية CPI](https://solana.com/docs/ar/tokens/extensions/cpi-guard?utm_source=llms&utm_medium=ai&utm_campaign=txt): تعلم كيفية تمكين CpiGuardExtension.
...
- [رسوم التحويل](https://solana.com/docs/ar/tokens/extensions/transfer-fees?utm_source=llms&utm_medium=ai&utm_campaign=txt): تعلم كيفية تنفيذ TransferFeeExtension.
...
- [عنوان مشتق من البرنامج](https://solana.com/docs/ar/core/pda?utm_source=llms&utm_medium=ai&utm_campaign=txt): تعرف على عناوين سولانا المشتقة من البرنامج (PDAs) — عناوين حسابات محددة تمكّن من توقيع البرنامج الآمن. افهم اشتقاق PDA، والقيم الإضافية القانونية، وكيفية إنشاء حسابات PDA.
...
- [مجموعات الرموز والأعضاء](https://solana.com/docs/ar/tokens/extensions/group-member?utm_source=llms&utm_medium=ai&utm_campaign=txt): تعلم كيفية تمكين GroupPointerExtension وGroupMemberPointerExtension.
- [مجموعات تطوير برمجيات الألعاب على سولانا](https://solana.com/docs/ar/clients/community/game-sdks?utm_source=llms&utm_medium=ai&utm_campaign=txt): قائمة بمجموعات تطوير برمجيات الألعاب على سولانا لمساعدتك في بدء إنشاء لعبتك الأولى على سولانا
...
- [مزامنة SOL الأصلي](https://solana.com/docs/ar/tokens/basics/sync-native?utm_source=llms&utm_medium=ai&utm_campaign=txt): تعلم كيفية تحويل SOL الأصلي إلى SOL المغلف.
...
- [مكتبة Rust للتطوير](https://solana.com/docs/ar/clients/official/rust?utm_source=llms&utm_medium=ai&utm_campaign=txt): حزم Rust الرسمية للبناء على سولانا.
...
- [مكتبة تايبسكريبت SDK](https://solana.com/docs/ar/clients/official/javascript?utm_source=llms&utm_medium=ai&utm_campaign=txt): تعلم كيفية التفاعل مع سولانا باستخدام مكتبات العميل جافاسكريبت/تايبسكريبت.
...
- [مكتبة تطوير البرمجيات لبايثون](https://solana.com/docs/ar/clients/community/python?utm_source=llms&utm_medium=ai&utm_campaign=txt): تعلم كيفية التفاعل مع سولانا باستخدام مكتبة تطوير البرمجيات لبايثون (michaelhly/solana-py).
- [مكتبة تطوير برمجيات Go](https://solana.com/docs/ar/clients/community/go?utm_source=llms&utm_medium=ai&utm_campaign=txt): تعلم كيفية التفاعل مع سولانا باستخدام مكتبة تطوير برمجيات Go (gagliardetto/solana-go).
- [نشر البرامج](https://solana.com/docs/ar/programs/deploying?utm_source=llms&utm_medium=ai&utm_campaign=txt): دليل شامل لبناء ونشر وإدارة برامج سولانا باستخدام واجهة سطر أوامر سولانا.
- [نشر برنامج](https://solana.com/docs/ar/intro/quick-start/deploying-programs?utm_source=llms&utm_medium=ai&utm_campaign=txt): تعلم كيفية بناء ونشر واختبار برنامجك الأول على سولانا باستخدام إطار عمل Anchor وSolana Playground. هذا الدليل المناسب للمبتدئين يشرح خطوات إنشاء برنامج بسيط، ونشره على شبكة devnet، وتشغيل الاختبارات، وإغلاق البرنامج.
- [نقاط نهاية RPC](https://solana.com/docs/ar/references/clusters?utm_source=llms&utm_medium=ai&utm_campaign=txt): تعرف على مجموعات شبكة سولانا (Devnet وTestnet وMainnet)، ونقاط نهاية RPC العامة الخاصة بها، وحدود المعدل، وحالات الاستخدام. تعلم كيفية الاتصال بشبكات سولانا المختلفة للتطوير والاختبار والإنتاج.
- [هياكل البيانات بصيغة JSON](https://solana.com/docs/ar/rpc/json-structures?utm_source=llms&utm_medium=ai&utm_campaign=txt)
- [واجهة برمجة التطبيقات بلغة جافا](https://solana.com/docs/ar/clients/community/java?utm_source=llms&utm_medium=ai&utm_campaign=txt): تعلم كيفية التفاعل مع سولانا باستخدام واجهة برمجة التطبيقات بلغة جافا (sava-software/sava).

## Docs - De

- [@solana/client](https://solana.com/docs/de/frontend/client?utm_source=llms&utm_medium=ai&utm_campaign=txt): Erstellen Sie schlanke Solana-Frontends mit der headless Solana-Client-Runtime.
- [@solana/react-hooks](https://solana.com/docs/de/frontend/react-hooks?utm_source=llms&utm_medium=ai&utm_campaign=txt): Teilen Sie den @solana/client-Status in Ihrer React-App mit sofort einsatzbereiten Hooks.
- [@solana/web3-compat](https://solana.com/docs/de/frontend/web3-compat?utm_source=llms&utm_medium=ai&utm_campaign=txt): Drop-in-Kompatibilitätsschicht, die es Legacy-@solana/web3.js-Code ermöglicht, auf Kit-Primitiven zu laufen.
- [Abhängigkeiten installieren](https://solana.com/docs/de/intro/installation/dependencies?utm_source=llms&utm_medium=ai&utm_campaign=txt): Eine Anleitung zum Einrichten Ihrer lokalen Solana-Entwicklungsumgebung. Erfahren Sie, wie Sie Rust, die Solana CLI und das Anchor Framework unter Windows (WSL), Linux und Mac installieren.
- [Anchor CLI Grundlagen](https://solana.com/docs/de/intro/installation/anchor-cli-basics?utm_source=llms&utm_medium=ai&utm_campaign=txt): Dieser Abschnitt führt durch einige gängige Anchor CLI-Befehle, um Ihnen den Einstieg zu erleichtern.
- [Anweisungen](https://solana.com/docs/de/core/instructions?utm_source=llms&utm_medium=ai&utm_campaign=txt): Erfahren Sie mehr über Solana Anweisungen—die grundlegenden Bausteine für die Interaktion mit der Solana-Blockchain. Verstehen Sie die Zusammensetzung von Anweisungen mit praktischen Beispielen.
...
- [Autorität festlegen](https://solana.com/docs/de/tokens/basics/set-authority?utm_source=llms&utm_medium=ai&utm_campaign=txt): Erfahren Sie, wie Sie Autoritäten für Mint-Konten oder Token-Konten festlegen.
- [CPI Guard](https://solana.com/docs/de/tokens/extensions/cpi-guard?utm_source=llms&utm_medium=ai&utm_campaign=txt): Erfahren Sie, wie Sie die CpiGuardExtension aktivieren können.
- [Cross Program Invocation](https://solana.com/docs/de/core/cpi?utm_source=llms&utm_medium=ai&utm_campaign=txt): Erfahren Sie mehr über Cross Program Invocation (CPI) auf Solana — wie Programme Anweisungen auf anderen Programmen aufrufen, PDA-Signers verwalten und Funktionalitäten im gesamten Solana-Netzwerk kombinieren können.
- [Daten vom Netzwerk lesen](https://solana.com/docs/de/intro/quick-start/reading-from-network?utm_source=llms&utm_medium=ai&utm_campaign=txt): Erfahren Sie, wie Sie Daten aus dem Solana-Blockchain-Netzwerk lesen können. Dieser Leitfaden behandelt das Abrufen von Wallet-Konten, Programm-Konten und Token-Mint-Konten mit JavaScript/TypeScript und enthält praktische Beispiele mit der Solana web3.js-Bibliothek.
- [Datenstrukturen als JSON](https://solana.com/docs/de/rpc/json-structures?utm_source=llms&utm_medium=ai&utm_campaign=txt)
- [Delegate genehmigen](https://solana.com/docs/de/tokens/basics/approve-delegate?utm_source=llms&utm_medium=ai&utm_campaign=txt): Erfahren Sie, wie Sie Delegates für ein Token-Konten genehmigen.
- [Delegierten widerrufen](https://solana.com/docs/de/tokens/basics/revoke-delegate?utm_source=llms&utm_medium=ai&utm_campaign=txt): Erfahren Sie, wie Sie den Delegierten eines Token-Kontos widerrufen können.
...
- [Ein Programm bereitstellen](https://solana.com/docs/de/intro/quick-start/deploying-programs?utm_source=llms&utm_medium=ai&utm_campaign=txt): Lernen Sie, wie Sie Ihr erstes Solana-Programm mit dem Anchor-Framework und Solana Playground erstellen, bereitstellen und testen. Diese anfängerfreundliche Anleitung führt durch die Erstellung eines einfachen Programms, die Bereitstellung im Devnet, die Durchführung von Tests und das Schließen des Programms.
...
- [Frontend](https://solana.com/docs/de/frontend/?utm_source=llms&utm_medium=ai&utm_campaign=txt): Erfahren Sie mehr über die Entwicklung von Benutzeroberflächen für Solana-Programme.
- [Generierung von Clients](https://solana.com/docs/de/programs/codama/clients?utm_source=llms&utm_medium=ai&utm_campaign=txt): Vollständige Anleitung zur Generierung von Clients für Solana-Programme mit der Codama CLI.
...
- [Go SDK](https://solana.com/docs/de/clients/community/go?utm_source=llms&utm_medium=ai&utm_campaign=txt): Erfahren Sie, wie Sie mit dem Go SDK (gagliardetto/solana-go) mit Solana interagieren können.
...
- [Java SDK](https://solana.com/docs/de/clients/community/java?utm_source=llms&utm_medium=ai&utm_campaign=txt): Erfahren Sie, wie Sie mit dem Java SDK (sava-software/sava) mit Solana interagieren können.
- [Kernkonzepte](https://solana.com/docs/de/core/?utm_source=llms&utm_medium=ai&utm_campaign=txt): Lerne wesentliche Konzepte der Solana-Blockchain kennen, einschließlich Konten, Transaktionen, Programme, programmabgeleitete Adressen, programmübergreifende Aufrufe und wie Tokens auf Solana funktionieren.
- [Konten](https://solana.com/docs/de/core/accounts?utm_source=llms&utm_medium=ai&utm_campaign=txt): Erfahren Sie mehr über Solanas Kontenmodell, einschließlich wie Konten Daten und Programme speichern, Rent-Mechanismen, Konteneigentum und die Beziehung zwischen Programmen und Datenkonten. Verstehen Sie die Kernkonzepte von Solanas Key-Value-Speichersystem.
- [Konto auftauen](https://solana.com/docs/de/tokens/basics/thaw-account?utm_source=llms&utm_medium=ai&utm_campaign=txt): Erfahren Sie, wie Sie ein eingefrorenes Token-Konto auftauen können.
- [Konto einfrieren](https://solana.com/docs/de/tokens/basics/freeze-account?utm_source=llms&utm_medium=ai&utm_campaign=txt): Erfahren Sie, wie Sie Token-Konten einfrieren können.
...
- [Memo-Übertragung](https://solana.com/docs/de/tokens/extensions/memo-transfer?utm_source=llms&utm_medium=ai&utm_campaign=txt): Erfahren Sie, wie Sie die MemoTransferExtension aktivieren können.
- [Metadata & Metadata Pointer Extensions](https://solana.com/docs/de/tokens/extensions/metadata?utm_source=llms&utm_medium=ai&utm_campaign=txt): Erfahren Sie, wie Sie die MetadataPointerExtension und TokenMetadata-Extension aktivieren können.
...
- [Mint schließen](https://solana.com/docs/de/tokens/extensions/close-mint?utm_source=llms&utm_medium=ai&utm_campaign=txt): Erfahren Sie, wie Sie die MintCloseAuthority-Erweiterung aktivieren.
- [Mollusk](https://solana.com/docs/de/programs/testing/mollusk?utm_source=llms&utm_medium=ai&utm_campaign=txt): Umfassender Leitfaden zum Testen von Solana-Programmen mit Mollusk
...
- [Next.js + Solana React Hooks](https://solana.com/docs/de/frontend/nextjs-solana?utm_source=llms&utm_medium=ai&utm_campaign=txt): Richten Sie die Solana Wallet-Integration in Next.js mit @solana/client und @solana/react-hooks ein, um SOL-Überweisungen zu senden.
- [Next.js - Solana Kit](https://solana.com/docs/de/frontend/kit?utm_source=llms&utm_medium=ai&utm_campaign=txt): Richten Sie die Solana Wallet-Integration in Next.js mit Solana Kit ein.
- [Nicht-übertragbare Token](https://solana.com/docs/de/tokens/extensions/non-transferrable-tokens?utm_source=llms&utm_medium=ai&utm_campaign=txt): Erfahren Sie, wie Sie die InitializeNonTransferableMint-Erweiterung aktivieren.
- [Permanenter Delegierter](https://solana.com/docs/de/tokens/extensions/permanent-delegate?utm_source=llms&utm_medium=ai&utm_campaign=txt): Erfahren Sie, wie Sie die InitializePermanentDelegate-Erweiterung implementieren.
...
- [Programm-abgeleitete Adresse](https://solana.com/docs/de/core/pda?utm_source=llms&utm_medium=ai&utm_campaign=txt): Erfahren Sie mehr über Solanas programm-abgeleitete Adressen (PDAs) — deterministische Kontenadressen, die eine sichere Programmunterzeichnung ermöglichen. Verstehen Sie PDA-Ableitung, kanonische Bumps und wie man PDA-Konten erstellt.
- [Programme](https://solana.com/docs/de/core/programs?utm_source=llms&utm_medium=ai&utm_campaign=txt): Erfahren Sie mehr über Solana-Programme (Smart Contracts) und wie man sie mit Rust oder dem Anchor-Framework entwickelt. Verstehen Sie Deployment, Upgrades und Verifizierung von Programmen im Solana-Netzwerk.
- [Programme deployen](https://solana.com/docs/de/programs/deploying?utm_source=llms&utm_medium=ai&utm_campaign=txt): Vollständiger Leitfaden zum Erstellen, Bereitstellen und Verwalten von Solana-Programmen mit der Solana CLI.
- [Programme verifizieren](https://solana.com/docs/de/programs/verified-builds?utm_source=llms&utm_medium=ai&utm_campaign=txt): Verifizierte Builds sind eine Möglichkeit, dein Programm mit seinem Quellcode zu verknüpfen und allen zu ermöglichen, unabhängig zu überprüfen, ob das Programm tatsächlich aus diesem bereitgestellten Quellcode erstellt wurde.
...
- [Python SDK](https://solana.com/docs/de/clients/community/python?utm_source=llms&utm_medium=ai&utm_campaign=txt): Erfahren Sie, wie Sie mit dem Python SDK (michaelhly/solana-py) mit Solana interagieren können.
- [RPC-Endpunkte](https://solana.com/docs/de/references/clusters?utm_source=llms&utm_medium=ai&utm_campaign=txt): Erfahren Sie mehr über Solanas Netzwerk-Cluster (Devnet, Testnet und Mainnet), ihre öffentlichen RPC-Endpunkte, Ratenlimits und Anwendungsfälle. Lernen Sie, wie Sie sich mit verschiedenen Solana-Netzwerken für Entwicklung, Tests und Produktion verbinden.
...
- [Rust SDK](https://solana.com/docs/de/clients/official/rust?utm_source=llms&utm_medium=ai&utm_campaign=txt): Offizielle Rust-Crates für die Entwicklung auf Solana.
...
- [Schnellinstallation](https://solana.com/docs/de/intro/installation/?utm_source=llms&utm_medium=ai&utm_campaign=txt): Eine Schnellinstallationsanleitung, mit der Sie Ihre lokale Solana-Entwicklungsumgebung mit einem einzigen Befehl einrichten können. Installieren Sie Rust, die Solana CLI und das Anchor Framework unter Windows (WSL), Linux und Mac.
...
- [Solana CLI Grundlagen](https://solana.com/docs/de/intro/installation/solana-cli-basics?utm_source=llms&utm_medium=ai&utm_campaign=txt): Dieser Abschnitt führt durch einige gängige Solana CLI-Befehle, um Ihnen den Einstieg zu erleichtern.
...
- [Solana Gaming SDKs](https://solana.com/docs/de/clients/community/game-sdks?utm_source=llms&utm_medium=ai&utm_campaign=txt): Eine Liste von Solana Gaming SDKs, um dir den Einstieg in die Entwicklung deines ersten Solana-Spiels zu erleichtern
...
- [Standardzustand](https://solana.com/docs/de/tokens/extensions/default-state?utm_source=llms&utm_medium=ai&utm_campaign=txt): Erfahren Sie, wie Sie die DefaultAccountStateExtension aktivieren.
- [Surfpool CLI Grundlagen](https://solana.com/docs/de/intro/installation/surfpool-cli-basics?utm_source=llms&utm_medium=ai&utm_campaign=txt): Lernen Sie wesentliche Surfpool CLI-Befehle für die lokale Solana-Entwicklung kennen, einschließlich des Startens eines Validators und der Verwendung von Surfpool Studio.
- [Sync Native](https://solana.com/docs/de/tokens/basics/sync-native?utm_source=llms&utm_medium=ai&utm_campaign=txt): Erfahren Sie, wie Sie natives SOL in Wrapped SOL umwandeln können.
...
- [Token verbrennen](https://solana.com/docs/de/tokens/basics/burn-tokens?utm_source=llms&utm_medium=ai&utm_campaign=txt): Erfahren Sie, wie Sie Token verbrennen können.
...
- [Token-Gruppen und Mitglieder](https://solana.com/docs/de/tokens/extensions/group-member?utm_source=llms&utm_medium=ai&utm_campaign=txt): Erfahren Sie, wie Sie die GroupPointerExtension und GroupMemberPointerExtension aktivieren können.
- [Token-Konto schließen](https://solana.com/docs/de/tokens/basics/close-account?utm_source=llms&utm_medium=ai&utm_campaign=txt): Erfahren Sie, wie Sie Token-Konten schließen können.
...
- [Transaktionen](https://solana.com/docs/de/core/transactions?utm_source=llms&utm_medium=ai&utm_campaign=txt): Erfahren Sie mehr über Solana-Transaktionen – die grundlegenden Bausteine für die Interaktion mit der Solana-Blockchain. Verstehen Sie Transaktionsstruktur und Anweisungszusammensetzung mit praktischen Beispielen.
- [Transaktionsgebühren](https://solana.com/docs/de/core/fees?utm_source=llms&utm_medium=ai&utm_campaign=txt): Erfahren Sie mehr über Solanas Transaktionsgebühren, einschließlich der Basis- und Prioritätsgebühren, wie diese angewendet werden und bewährte Methoden zur Verwaltung von Compute-Einheiten in Ihren Transaktionen.
- [Transfer-Fee](https://solana.com/docs/de/tokens/extensions/transfer-fees?utm_source=llms&utm_medium=ai&utm_campaign=txt): Erfahren Sie, wie Sie die TransferFeeExtension implementieren.
...
- [Typescript SDK](https://solana.com/docs/de/clients/official/javascript?utm_source=llms&utm_medium=ai&utm_campaign=txt): Erfahren Sie, wie Sie mit den JavaScript/TypeScript-Client-Bibliotheken mit Solana interagieren können.
- [Unveränderlicher Eigentümer](https://solana.com/docs/de/tokens/extensions/immutable-owner?utm_source=llms&utm_medium=ai&utm_campaign=txt): Erfahren Sie, wie Sie die ImmutableOwner-Erweiterung aktivieren.
...
- [Zinstragende Token](https://solana.com/docs/de/tokens/extensions/interest-bearing-tokens?utm_source=llms&utm_medium=ai&utm_campaign=txt): Erfahren Sie, wie Sie die InterestBearingMintExtension aktivieren können.
...
- [@solana/client](https://solana.com/docs/el/frontend/client?utm_source=llms&utm_medium=ai&utm_campaign=txt): Δημιουργήστε ελαφριά Solana frontends με το headless Solana client runtime.
- [@solana/react-hooks](https://solana.com/docs/el/frontend/react-hooks?utm_source=llms&utm_medium=ai&utm_campaign=txt): Μοιραστείτε την κατάσταση του @solana/client σε ολόκληρη την εφαρμογή React με έτοιμα προς χρήση hooks.
- [@solana/web3-compat](https://solana.com/docs/el/frontend/web3-compat?utm_source=llms&utm_medium=ai&utm_campaign=txt): Επίπεδο συμβατότητας drop-in που επιτρέπει στον παλαιό κώδικα @solana/web3.js να εκτελείται σε primitives του Kit.
- [CPI Guard](https://solana.com/docs/el/tokens/extensions/cpi-guard?utm_source=llms&utm_medium=ai&utm_campaign=txt): Μάθετε πώς να ενεργοποιήσετε το CpiGuardExtension.
...
- [Frontend](https://solana.com/docs/el/frontend/?utm_source=llms&utm_medium=ai&utm_campaign=txt): Μάθετε για την κατασκευή διεπαφών για προγράμματα Solana.
...
- [Go SDK](https://solana.com/docs/el/clients/community/go?utm_source=llms&utm_medium=ai&utm_campaign=txt): Μάθετε πώς να αλληλεπιδράτε με το Solana χρησιμοποιώντας το Go SDK (gagliardetto/solana-go).
...
- [Java SDK](https://solana.com/docs/el/clients/community/java?utm_source=llms&utm_medium=ai&utm_campaign=txt): Μάθετε πώς να αλληλεπιδράτε με το Solana χρησιμοποιώντας το Java SDK (sava-software/sava).
- [Mollusk](https://solana.com/docs/el/programs/testing/mollusk?utm_source=llms&utm_medium=ai&utm_campaign=txt): Ολοκληρωμένος οδηγός για τον έλεγχο προγραμμάτων Solana με χρήση του Mollusk
- [Next.js + Solana React Hooks](https://solana.com/docs/el/frontend/nextjs-solana?utm_source=llms&utm_medium=ai&utm_campaign=txt): Ρυθμίστε την ενσωμάτωση πορτοφολιού Solana στο Next.js με @solana/client και @solana/react-hooks για να στέλνετε μεταφορές SOL.
- [Next.js - Solana Kit](https://solana.com/docs/el/frontend/kit?utm_source=llms&utm_medium=ai&utm_campaign=txt): Ρυθμίστε την ενσωμάτωση πορτοφολιού Solana στο Next.js με το Solana Kit.
...
- [Python SDK](https://solana.com/docs/el/clients/community/python?utm_source=llms&utm_medium=ai&utm_campaign=txt): Μάθετε πώς να αλληλεπιδράσετε με το Solana χρησιμοποιώντας το Python SDK (michaelhly/solana-py).
...
- [Rust SDK](https://solana.com/docs/el/clients/official/rust?utm_source=llms&utm_medium=ai&utm_campaign=txt): Επίσημα crates Rust για ανάπτυξη στο Solana.
...
- [Solana Gaming SDKs](https://solana.com/docs/el/clients/community/game-sdks?utm_source=llms&utm_medium=ai&utm_campaign=txt): Μια λίστα με Solana Gaming SDKs για να ξεκινήσετε να δημιουργείτε το πρώτο σας παιχνίδι Solana
...
- [Typescript SDK](https://solana.com/docs/el/clients/official/javascript?utm_source=llms&utm_medium=ai&utm_campaign=txt): Μάθετε πώς να αλληλεπιδράτε με το Solana χρησιμοποιώντας τις βιβλιοθήκες JavaScript/TypeScript.
...
- [Έγκριση Αντιπροσώπου](https://solana.com/docs/el/tokens/basics/approve-delegate?utm_source=llms&utm_medium=ai&utm_campaign=txt): Μάθετε πώς να εγκρίνετε αντιπροσώπους για ένα token account.
...
- [Αμετάβλητος Ιδιοκτήτης](https://solana.com/docs/el/tokens/extensions/immutable-owner?utm_source=llms&utm_medium=ai&utm_campaign=txt): Μάθετε πώς να ενεργοποιήσετε την Επέκταση ImmutableOwner.
- [Ανάγνωση από το Δίκτυο](https://solana.com/docs/el/intro/quick-start/reading-from-network?utm_source=llms&utm_medium=ai&utm_campaign=txt): Μάθετε πώς να διαβάζετε δεδομένα από το δίκτυο blockchain της Solana. Αυτός ο οδηγός καλύπτει την ανάκτηση λογαριασμών πορτοφολιού, λογαριασμών προγραμμάτων και λογαριασμών νομισμάτων token χρησιμοποιώντας JavaScript/TypeScript, με πρακτικά παραδείγματα χρήσης της βιβλιοθήκης Solana web3.js.
- [Ανάκληση Εκπροσώπου](https://solana.com/docs/el/tokens/basics/revoke-delegate?utm_source=llms&utm_medium=ai&utm_campaign=txt): Μάθετε πώς να ανακαλέσετε τον εκπρόσωπο του token account.
...
- [Ανάπτυξη ενός Προγράμματος](https://solana.com/docs/el/intro/quick-start/deploying-programs?utm_source=llms&utm_medium=ai&utm_campaign=txt): Μάθετε πώς να δημιουργείτε, να αναπτύσσετε και να δοκιμάζετε το πρώτο σας πρόγραμμα Solana χρησιμοποιώντας το πλαίσιο Anchor και το Solana Playground. Αυτός ο οδηγός για αρχάριους σας καθοδηγεί στη δημιουργία ενός απλού προγράμματος, την ανάπτυξή του στο devnet, την εκτέλεση δοκιμών και το κλείσιμο του προγράμματος.
- [Ανάπτυξη προγραμμάτων](https://solana.com/docs/el/programs/deploying?utm_source=llms&utm_medium=ai&utm_campaign=txt): Πλήρης οδηγός για την ανάπτυξη, εγκατάσταση και διαχείριση προγραμμάτων Solana χρησιμοποιώντας το Solana CLI.
...
- [Βασικά στοιχεία Solana CLI](https://solana.com/docs/el/intro/installation/solana-cli-basics?utm_source=llms&utm_medium=ai&utm_campaign=txt): Αυτή η ενότητα παρουσιάζει μερικές συνηθισμένες εντολές του Solana CLI για να ξεκινήσετε.
- [Βασικά στοιχεία του Anchor CLI](https://solana.com/docs/el/intro/installation/anchor-cli-basics?utm_source=llms&utm_medium=ai&utm_campaign=txt): Αυτή η ενότητα παρουσιάζει μερικές συνηθισμένες εντολές του Anchor CLI για να ξεκινήσετε.
- [Βασικά στοιχεία του Surfpool CLI](https://solana.com/docs/el/intro/installation/surfpool-cli-basics?utm_source=llms&utm_medium=ai&utm_campaign=txt): Μάθετε βασικές εντολές του Surfpool CLI για τοπική ανάπτυξη στο Solana, συμπεριλαμβανομένης της εκκίνησης ενός validator και της χρήσης του Surfpool Studio.
- [Βασικές έννοιες](https://solana.com/docs/el/core/?utm_source=llms&utm_medium=ai&utm_campaign=txt): Μάθετε βασικές έννοιες του blockchain Solana συμπεριλαμβανομένων των λογαριασμών, συναλλαγών, προγραμμάτων, διευθύνσεων που προέρχονται από προγράμματα, διαπρογραμματικών κλήσεων και πώς λειτουργούν τα tokens στο Solana.
- [Γρήγορη εγκατάσταση](https://solana.com/docs/el/intro/installation/?utm_source=llms&utm_medium=ai&utm_campaign=txt): Ένας οδηγός γρήγορης εγκατάστασης που σας επιτρέπει να ρυθμίσετε το τοπικό περιβάλλον ανάπτυξης Solana με μία μόνο εντολή. Εγκαταστήστε Rust, Solana CLI και το πλαίσιο Anchor σε Windows (WSL), Linux και Mac.
...
- [Δημιουργία Clients](https://solana.com/docs/el/programs/codama/clients?utm_source=llms&utm_medium=ai&utm_campaign=txt): Πλήρης οδηγός για τη δημιουργία clients για προγράμματα Solana χρησιμοποιώντας το Codama CLI.
...
- [Διεύθυνση Προερχόμενη από Πρόγραμμα](https://solana.com/docs/el/core/pda?utm_source=llms&utm_medium=ai&utm_campaign=txt): Μάθετε για τις Διευθύνσεις Προερχόμενες από Πρόγραμμα (PDAs) της Solana — καθορισμένες διευθύνσεις λογαριασμών που επιτρέπουν ασφαλή υπογραφή προγράμματος. Κατανοήστε την παραγωγή PDA, τα κανονικά bumps και πώς να δημιουργήσετε λογαριασμούς PDA.
- [Δομές Δεδομένων ως JSON](https://solana.com/docs/el/rpc/json-structures?utm_source=llms&utm_medium=ai&utm_campaign=txt)
- [Δομή Προγράμματος](https://solana.com/docs/el/programs/rust/program-structure?utm_source=llms&utm_medium=ai&utm_campaign=txt): Μάθετε πώς να δομείτε προγράμματα Solana σε Rust, συμπεριλαμβανομένων των σημείων εισόδου, της διαχείρισης κατάστασης, του χειρισμού εντολών και των δοκιμών.
...
- [Εγκατάσταση Εξαρτήσεων](https://solana.com/docs/el/intro/installation/dependencies?utm_source=llms&utm_medium=ai&utm_campaign=txt): Ένας οδηγός για τη ρύθμιση του τοπικού περιβάλλοντος ανάπτυξης Solana. Μάθετε πώς να εγκαταστήσετε τη Rust, το Solana CLI και το Anchor Framework σε Windows (WSL), Linux και Mac.
...
- [Επαλήθευση προγραμμάτων](https://solana.com/docs/el/programs/verified-builds?utm_source=llms&utm_medium=ai&utm_campaign=txt): Οι επαληθευμένες κατασκευές είναι ένας τρόπος να συνδέσετε το πρόγραμμά σας με τον πηγαίο κώδικά του και να επιτρέψετε σε όλους να επαληθεύσουν ανεξάρτητα ότι το πρόγραμμα πράγματι δημιουργήθηκε από τον παρεχόμενο πηγαίο κώδικα.
- [Επεκτάσεις Metadata & Metadata Pointer](https://solana.com/docs/el/tokens/extensions/metadata?utm_source=llms&utm_medium=ai&utm_campaign=txt): Μάθετε πώς να ενεργοποιήσετε τις επεκτάσεις MetadataPointerExtension και TokenMetadata.
...
- [Καταστροφή Tokens](https://solana.com/docs/el/tokens/basics/burn-tokens?utm_source=llms&utm_medium=ai&utm_campaign=txt): Μάθετε πώς να καταστρέφετε tokens.
- [Κλείσιμο Mint](https://solana.com/docs/el/tokens/extensions/close-mint?utm_source=llms&utm_medium=ai&utm_campaign=txt): Μάθετε πώς να ενεργοποιήσετε την επέκταση MintCloseAuthority.
- [Κλείσιμο λογαριασμού token](https://solana.com/docs/el/tokens/basics/close-account?utm_source=llms&utm_medium=ai&utm_campaign=txt): Μάθετε πώς να κλείνετε λογαριασμούς token.
...
- [Μεταφορά Tokens](https://solana.com/docs/el/tokens/basics/transfer-tokens?utm_source=llms&utm_medium=ai&utm_campaign=txt): Μάθετε πώς να μεταφέρετε tokens μεταξύ λογαριασμών token.
- [Μεταφορά υπομνήματος](https://solana.com/docs/el/tokens/extensions/memo-transfer?utm_source=llms&utm_medium=ai&utm_campaign=txt): Μάθετε πώς να ενεργοποιήσετε το MemoTransferExtension.
- [Μη μεταβιβάσιμα tokens](https://solana.com/docs/el/tokens/extensions/non-transferrable-tokens?utm_source=llms&utm_medium=ai&utm_campaign=txt): Μάθετε πώς να ενεργοποιήσετε το InitializeNonTransferableMint.
- [Μόνιμος Αντιπρόσωπος](https://solana.com/docs/el/tokens/extensions/permanent-delegate?utm_source=llms&utm_medium=ai&utm_campaign=txt): Μάθετε πώς να υλοποιήσετε την επέκταση InitializePermanentDelegate.
- [Ξεπάγωμα Λογαριασμού](https://solana.com/docs/el/tokens/basics/thaw-account?utm_source=llms&utm_medium=ai&utm_campaign=txt): Μάθετε πώς να ξεπαγώσετε έναν παγωμένο token account.
- [Οδηγίες](https://solana.com/docs/el/core/instructions?utm_source=llms&utm_medium=ai&utm_campaign=txt): Μάθετε για τις οδηγίες του Solana—τα θεμελιώδη δομικά στοιχεία για την αλληλεπίδραση με το blockchain του Solana. Κατανοήστε τη σύνθεση οδηγιών με πρακτικά παραδείγματα.
...
- [Ομάδες και μέλη token](https://solana.com/docs/el/tokens/extensions/group-member?utm_source=llms&utm_medium=ai&utm_campaign=txt): Μάθετε πώς να ενεργοποιήσετε το GroupPointerExtension και το GroupMemberPointerExtension.
- [Ορισμός Εξουσιοδότησης](https://solana.com/docs/el/tokens/basics/set-authority?utm_source=llms&utm_medium=ai&utm_campaign=txt): Μάθετε πώς να ορίσετε εξουσιοδότηση για mint accounts ή token accounts.
...
- [Πάγωμα Λογαριασμού](https://solana.com/docs/el/tokens/basics/freeze-account?utm_source=llms&utm_medium=ai&utm_campaign=txt): Μάθετε πώς να παγώνετε λογαριασμούς token.
...
- [Προεπιλεγμένη κατάσταση](https://solana.com/docs/el/tokens/extensions/default-state?utm_source=llms&utm_medium=ai&utm_campaign=txt): Μάθετε πώς να ενεργοποιήσετε το DefaultAccountStateExtension.
...
- [Συγχρονισμός Native](https://solana.com/docs/el/tokens/basics/sync-native?utm_source=llms&utm_medium=ai&utm_campaign=txt): Μάθετε πώς να μετατρέψετε native SOL σε wrapped SOL.
- [Συναλλαγές](https://solana.com/docs/el/core/transactions?utm_source=llms&utm_medium=ai&utm_campaign=txt): Μάθετε για τις συναλλαγές Solana—τα θεμελιώδη δομικά στοιχεία για αλληλεπίδραση με το blockchain του Solana. Κατανοήστε τη δομή των συναλλαγών και τη σύνθεση των οδηγιών με πρακτικά παραδείγματα.
...
- [Τέλη Συναλλαγών](https://solana.com/docs/el/core/fees?utm_source=llms&utm_medium=ai&utm_campaign=txt): Μάθετε για τα τέλη συναλλαγών του Solana, συμπεριλαμβανομένων των βασικών και των τελών προτεραιότητας, πώς εφαρμόζεται το καθένα, και τις βέλτιστες πρακτικές για τη διαχείριση των υπολογιστικών μονάδων στις συναλλαγές σας.
...
- [Τελικά σημεία RPC](https://solana.com/docs/el/references/clusters?utm_source=llms&utm_medium=ai&utm_campaign=txt): Μάθετε για τα clusters δικτύου της Solana (Devnet, Testnet και Mainnet), τα δημόσια RPC endpoints τους, τους περιορισμούς ρυθμού και τις περιπτώσεις χρήσης. Μάθετε πώς να συνδεθείτε σε διαφορετικά δίκτυα Solana για ανάπτυξη, δοκιμές και παραγωγή.
- [Τόκενς που φέρουν τόκο](https://solana.com/docs/el/tokens/extensions/interest-bearing-tokens?utm_source=llms&utm_medium=ai&utm_campaign=txt): Μάθετε πώς να ενεργοποιήσετε το InterestBearingMintExtension.
- [Χρεώσεις Μεταφοράς](https://solana.com/docs/el/tokens/extensions/transfer-fees?utm_source=llms&utm_medium=ai&utm_campaign=txt): Μάθετε πώς να υλοποιήσετε το TransferFeeExtension.

## Docs - En

- [@solana/client](https://solana.com/docs/en/frontend/client?utm_source=llms&utm_medium=ai&utm_campaign=txt): Build lean Solana frontends with the headless Solana client runtime.
- [@solana/react-hooks](https://solana.com/docs/en/frontend/react-hooks?utm_source=llms&utm_medium=ai&utm_campaign=txt): Share @solana/client state across your React app with ready to use hooks.
- [@solana/web3-compat](https://solana.com/docs/en/frontend/web3-compat?utm_source=llms&utm_medium=ai&utm_campaign=txt): Drop-in compatibility layer that lets legacy @solana/web3.js code run on Kit primitives.
...
- [Anchor CLI Basics](https://solana.com/docs/en/intro/installation/anchor-cli-basics?utm_source=llms&utm_medium=ai&utm_campaign=txt): This section walks through some common Anchor CLI commands to get you started.
...
- [CPI Guard](https://solana.com/docs/en/tokens/extensions/cpi-guard?utm_source=llms&utm_medium=ai&utm_campaign=txt): Learn how to enable the CpiGuardExtension.
- [Close Mint](https://solana.com/docs/en/tokens/extensions/close-mint?utm_source=llms&utm_medium=ai&utm_campaign=txt): Learn how enable the MintCloseAuthority extension.
...
- [Default State](https://solana.com/docs/en/tokens/extensions/default-state?utm_source=llms&utm_medium=ai&utm_campaign=txt): Learn how to enable the DefaultAccountStateExtension.
- [Deploy a Program](https://solana.com/docs/en/intro/quick-start/deploying-programs?utm_source=llms&utm_medium=ai&utm_campaign=txt): Learn how to build, deploy, and test your first Solana program using the Anchor framework and Solana Playground. This beginner-friendly guide walks through creating a simple program, deploying it to devnet, running tests, and closing the program.
- [Deploying Programs](https://solana.com/docs/en/programs/deploying?utm_source=llms&utm_medium=ai&utm_campaign=txt): Complete guide to building, deploying, and managing Solana programs using the Solana CLI.
...
- [Frontend](https://solana.com/docs/en/frontend/?utm_source=llms&utm_medium=ai&utm_campaign=txt): Learn about building interfaces for Solana Programs.
- [Generating Clients](https://solana.com/docs/en/programs/codama/clients?utm_source=llms&utm_medium=ai&utm_campaign=txt): Complete guide to generating clients for Solana programs using the Codama CLI.
- [Go SDK](https://solana.com/docs/en/clients/community/go?utm_source=llms&utm_medium=ai&utm_campaign=txt): Learn how to interact with Solana using the Go SDK (gagliardetto/solana-go).
- [HTTP Methods](https://solana.com/docs/en/rpc/http/?utm_source=llms&utm_medium=ai&utm_campaign=txt)
- [Immutable Owner](https://solana.com/docs/en/tokens/extensions/immutable-owner?utm_source=llms&utm_medium=ai&utm_campaign=txt): Learn how to enable the ImmutableOwner Extension.
- [Install Dependencies](https://solana.com/docs/en/intro/installation/dependencies?utm_source=llms&utm_medium=ai&utm_campaign=txt): A guide to setting up your local Solana development environment. Learn how to install Rust, the Solana CLI, and Anchor Framework on Windows (WSL), Linux, and Mac.
- [Instructions](https://solana.com/docs/en/core/instructions?utm_source=llms&utm_medium=ai&utm_campaign=txt): Learn about Solana instructions—the fundamental building blocks for interacting with the Solana blockchain. Understand instruction composition with practical examples.
- [Interest Bearing Tokens](https://solana.com/docs/en/tokens/extensions/interest-bearing-tokens?utm_source=llms&utm_medium=ai&utm_campaign=txt): Learn how to enable the InterestBearingMintExtension.
- [Java SDK](https://solana.com/docs/en/clients/community/java?utm_source=llms&utm_medium=ai&utm_campaign=txt): Learn how to interact with Solana using the Java SDK (sava-software/sava).
- [Limitations](https://solana.com/docs/en/programs/limitations?utm_source=llms&utm_medium=ai&utm_campaign=txt)
- [Memo transfer](https://solana.com/docs/en/tokens/extensions/memo-transfer?utm_source=llms&utm_medium=ai&utm_campaign=txt): Learn how to enable the MemoTransferExtension.
- [Metadata & Metadata Pointer Extensions](https://solana.com/docs/en/tokens/extensions/metadata?utm_source=llms&utm_medium=ai&utm_campaign=txt): Learn how to enable the MetadataPointerExtension and TokenMetadata extension.
...
- [Mollusk](https://solana.com/docs/en/programs/testing/mollusk?utm_source=llms&utm_medium=ai&utm_campaign=txt): Comprehensive guide to testing Solana programs using Mollusk
- [Next.js + Solana React Hooks](https://solana.com/docs/en/frontend/nextjs-solana?utm_source=llms&utm_medium=ai&utm_campaign=txt): Set up Solana wallet integration in Next.js with @solana/client and @solana/react-hooks to send SOL transfers.
- [Non-Transferrable Tokens](https://solana.com/docs/en/tokens/extensions/non-transferrable-tokens?utm_source=llms&utm_medium=ai&utm_campaign=txt): Learn how to enable the InitializeNonTransferableMint.
- [Permanent Delegate](https://solana.com/docs/en/tokens/extensions/permanent-delegate?utm_source=llms&utm_medium=ai&utm_campaign=txt): Learn how to implement the InitializePermanentDelegate extension.
...
- [Program-Derived Address](https://solana.com/docs/en/core/pda?utm_source=llms&utm_medium=ai&utm_campaign=txt): Learn about Solana's Program-Derived Addresses (PDAs) — deterministic account addresses that enable secure program signing. Understand PDA derivation, canonical bumps, and how to create PDA accounts.
- [Programs](https://solana.com/docs/en/core/programs?utm_source=llms&utm_medium=ai&utm_campaign=txt): Learn about Solana programs (smart contracts) and how to develop them using Rust or the Anchor framework. Understand program deployment, upgrades, and verification on the Solana network.
- [Python SDK](https://solana.com/docs/en/clients/community/python?utm_source=llms&utm_medium=ai&utm_campaign=txt): Learn how to interact with Solana using the Python SDK (michaelhly/solana-py).
- [Quick Installation](https://solana.com/docs/en/intro/installation/?utm_source=llms&utm_medium=ai&utm_campaign=txt): A quick installation guide that allows you to set up your local Solana development environment with a single command. Install Rust, the Solana CLI, and Anchor Framework on Windows (WSL), Linux, and Mac.
...
- [RPC Endpoints](https://solana.com/docs/en/references/clusters?utm_source=llms&utm_medium=ai&utm_campaign=txt): Learn about Solana's network clusters (Devnet, Testnet, and Mainnet), their public RPC endpoints, rate limits, and use cases. Learn how to connect to different Solana networks for development, testing, and production.
...
- [Rust SDK](https://solana.com/docs/en/clients/official/rust?utm_source=llms&utm_medium=ai&utm_campaign=txt): Official Rust crates for building on Solana.
...
- [Solana CLI Basics](https://solana.com/docs/en/intro/installation/solana-cli-basics?utm_source=llms&utm_medium=ai&utm_campaign=txt): This section walks through some common Solana CLI commands to get you started.
...
- [Solana Gaming SDKs](https://solana.com/docs/en/clients/community/game-sdks?utm_source=llms&utm_medium=ai&utm_campaign=txt): A list of Solana Gaming SDKs to get you started creating your first Solana Game
...
- [Surfpool CLI Basics](https://solana.com/docs/en/intro/installation/surfpool-cli-basics?utm_source=llms&utm_medium=ai&utm_campaign=txt): Learn essential Surfpool CLI commands for local Solana development, including starting a validator and using Surfpool Studio.
...
- [Token Groups and Members](https://solana.com/docs/en/tokens/extensions/group-member?utm_source=llms&utm_medium=ai&utm_campaign=txt): Learn how to enable the GroupPointerExtension and GroupMemberPointerExtension.
...
- [Transactions](https://solana.com/docs/en/core/transactions?utm_source=llms&utm_medium=ai&utm_campaign=txt): Learn about Solana transactions—the fundamental building blocks for interacting with the Solana blockchain. Understand transaction structure and instruction composition with practical examples.
- [Transfer Fees](https://solana.com/docs/en/tokens/extensions/transfer-fees?utm_source=llms&utm_medium=ai&utm_campaign=txt): Learn how to implement the TransferFeeExtension.
...
- [Typescript SDK](https://solana.com/docs/en/clients/official/javascript?utm_source=llms&utm_medium=ai&utm_campaign=txt): Learn how to interact with Solana using the JavaScript/TypeScript client libraries.
- [Verifying Programs](https://solana.com/docs/en/programs/verified-builds?utm_source=llms&utm_medium=ai&utm_campaign=txt): Verified builds is a way to link your program to its source code and let everyone independently verify that the program was indeed built from that provided source code.
...
- [@solana/client](https://solana.com/docs/es/frontend/client?utm_source=llms&utm_medium=ai&utm_campaign=txt): Construye frontends ligeros de Solana con el runtime de cliente headless de Solana.
- [@solana/react-hooks](https://solana.com/docs/es/frontend/react-hooks?utm_source=llms&utm_medium=ai&utm_campaign=txt): Comparte el estado de @solana/client en tu aplicación React con hooks listos para usar.
- [@solana/web3-compat](https://solana.com/docs/es/frontend/web3-compat?utm_source=llms&utm_medium=ai&utm_campaign=txt): Capa de compatibilidad que permite que el código heredado de @solana/web3.js se ejecute sobre primitivas de Kit.
...
- [Aprobar delegado](https://solana.com/docs/es/tokens/basics/approve-delegate?utm_source=llms&utm_medium=ai&utm_campaign=txt): Aprende cómo aprobar delegados para una token account.
- [CPI Guard](https://solana.com/docs/es/tokens/extensions/cpi-guard?utm_source=llms&utm_medium=ai&utm_campaign=txt): Aprende cómo habilitar la CpiGuardExtension.
...
- [Cerrar Mint](https://solana.com/docs/es/tokens/extensions/close-mint?utm_source=llms&utm_medium=ai&utm_campaign=txt): Aprende cómo habilitar la extensión MintCloseAuthority.
- [Cerrar cuenta de token](https://solana.com/docs/es/tokens/basics/close-account?utm_source=llms&utm_medium=ai&utm_campaign=txt): Aprende cómo cerrar cuentas de token.
...
- [Conceptos básicos de Anchor CLI](https://solana.com/docs/es/intro/installation/anchor-cli-basics?utm_source=llms&utm_medium=ai&utm_campaign=txt): Esta sección explica algunos comandos comunes de Anchor CLI para ayudarte a comenzar.
...
- [Conceptos básicos de Solana CLI](https://solana.com/docs/es/intro/installation/solana-cli-basics?utm_source=llms&utm_medium=ai&utm_campaign=txt): Esta sección explica algunos comandos comunes de Solana CLI para ayudarte a comenzar.
- [Conceptos básicos de Surfpool CLI](https://solana.com/docs/es/intro/installation/surfpool-cli-basics?utm_source=llms&utm_medium=ai&utm_campaign=txt): Aprende comandos esenciales de Surfpool CLI para desarrollo local en Solana, incluyendo cómo iniciar un validator y usar Surfpool Studio.
- [Conceptos fundamentales](https://solana.com/docs/es/core/?utm_source=llms&utm_medium=ai&utm_campaign=txt): Aprende conceptos esenciales de la blockchain Solana incluyendo cuentas, transacciones, programas, direcciones derivadas de programas, invocaciones entre programas y cómo funcionan los tokens en Solana.
- [Congelar cuenta](https://solana.com/docs/es/tokens/basics/freeze-account?utm_source=llms&utm_medium=ai&utm_campaign=txt): Aprende cómo congelar token accounts.
...
- [Delegado permanente](https://solana.com/docs/es/tokens/extensions/permanent-delegate?utm_source=llms&utm_medium=ai&utm_campaign=txt): Aprende cómo implementar la extensión InitializePermanentDelegate.
...
- [Descongelar cuenta](https://solana.com/docs/es/tokens/basics/thaw-account?utm_source=llms&utm_medium=ai&utm_campaign=txt): Aprende cómo descongelar una cuenta de token congelada.
- [Desplegar un programa](https://solana.com/docs/es/intro/quick-start/deploying-programs?utm_source=llms&utm_medium=ai&utm_campaign=txt): Aprende a construir, desplegar y probar tu primer programa de Solana utilizando el framework Anchor y Solana Playground. Esta guía para principiantes te explica cómo crear un programa simple, desplegarlo en devnet, ejecutar pruebas y cerrar el programa.
- [Dirección derivada de programa](https://solana.com/docs/es/core/pda?utm_source=llms&utm_medium=ai&utm_campaign=txt): Aprende sobre las direcciones derivadas de programa (PDAs) de Solana — direcciones de cuenta deterministas que permiten la firma segura de programas. Comprende la derivación de PDA, los bumps canónicos y cómo crear cuentas PDA.
...
- [Endpoints RPC](https://solana.com/docs/es/references/clusters?utm_source=llms&utm_medium=ai&utm_campaign=txt): Aprende sobre los clústeres de red de Solana (Devnet, Testnet y Mainnet), sus endpoints RPC públicos, límites de tasa y casos de uso. Aprende cómo conectarte a diferentes redes de Solana para desarrollo, pruebas y producción.
...
- [Establecer autoridad](https://solana.com/docs/es/tokens/basics/set-authority?utm_source=llms&utm_medium=ai&utm_campaign=txt): Aprende cómo establecer autoridad para mint accounts o token accounts.
- [Estado predeterminado](https://solana.com/docs/es/tokens/extensions/default-state?utm_source=llms&utm_medium=ai&utm_campaign=txt): Aprende cómo habilitar la DefaultAccountStateExtension.
...
- [Extensiones de metadatos y puntero de metadatos](https://solana.com/docs/es/tokens/extensions/metadata?utm_source=llms&utm_medium=ai&utm_campaign=txt): Aprende cómo habilitar la extensión MetadataPointerExtension y la extensión TokenMetadata.
...
- [Frontend](https://solana.com/docs/es/frontend/?utm_source=llms&utm_medium=ai&utm_campaign=txt): Aprende sobre la construcción de interfaces para programas de Solana.
- [Generando clientes](https://solana.com/docs/es/programs/codama/clients?utm_source=llms&utm_medium=ai&utm_campaign=txt): Guía completa para generar clientes para programas de Solana utilizando Codama CLI.
- [Grupos de tokens y miembros](https://solana.com/docs/es/tokens/extensions/group-member?utm_source=llms&utm_medium=ai&utm_campaign=txt): Aprende cómo habilitar GroupPointerExtension y GroupMemberPointerExtension.
...
- [Implementación de programas](https://solana.com/docs/es/programs/deploying?utm_source=llms&utm_medium=ai&utm_campaign=txt): Guía completa para construir, implementar y gestionar programas de Solana utilizando la CLI de Solana.
...
- [Instalación rápida](https://solana.com/docs/es/intro/installation/?utm_source=llms&utm_medium=ai&utm_campaign=txt): Una guía de instalación rápida que te permite configurar tu entorno de desarrollo local de Solana con un solo comando. Instala Rust, la CLI de Solana y el Framework Anchor en Windows (WSL), Linux y Mac.
- [Instalar dependencias](https://solana.com/docs/es/intro/installation/dependencies?utm_source=llms&utm_medium=ai&utm_campaign=txt): Una guía para configurar tu entorno de desarrollo local de Solana. Aprende cómo instalar Rust, la CLI de Solana y el Framework Anchor en Windows (WSL), Linux y Mac.
- [Instrucciones](https://solana.com/docs/es/core/instructions?utm_source=llms&utm_medium=ai&utm_campaign=txt): Aprende sobre las instrucciones de Solana—los bloques fundamentales para interactuar con la blockchain de Solana. Comprende la composición de instrucciones con ejemplos prácticos.
- [Lectura desde la red](https://solana.com/docs/es/intro/quick-start/reading-from-network?utm_source=llms&utm_medium=ai&utm_campaign=txt): Aprende cómo leer datos de la red blockchain de Solana. Esta guía cubre la obtención de cuentas de billetera, cuentas de programa y cuentas de acuñación de tokens usando JavaScript/TypeScript, con ejemplos prácticos utilizando la biblioteca Solana web3.js.
...
- [Mollusk](https://solana.com/docs/es/programs/testing/mollusk?utm_source=llms&utm_medium=ai&utm_campaign=txt): Guía completa para probar programas de Solana usando Mollusk
...
- [Next.js + Solana React Hooks](https://solana.com/docs/es/frontend/nextjs-solana?utm_source=llms&utm_medium=ai&utm_campaign=txt): Configura la integración de wallet de Solana en Next.js con @solana/client y @solana/react-hooks para enviar transferencias de SOL.
- [Next.js - Solana Kit](https://solana.com/docs/es/frontend/kit?utm_source=llms&utm_medium=ai&utm_campaign=txt): Configura la integración de wallet Solana en Next.js con Solana Kit.
...
- [Propietario inmutable](https://solana.com/docs/es/tokens/extensions/immutable-owner?utm_source=llms&utm_medium=ai&utm_campaign=txt): Aprende cómo habilitar la extensión ImmutableOwner.
- [Quemar tokens](https://solana.com/docs/es/tokens/basics/burn-tokens?utm_source=llms&utm_medium=ai&utm_campaign=txt): Aprende cómo quemar tokens.
...
- [Revocar delegado](https://solana.com/docs/es/tokens/basics/revoke-delegate?utm_source=llms&utm_medium=ai&utm_campaign=txt): Aprende cómo revocar el delegado de una token account.
...
- [SDK de Go](https://solana.com/docs/es/clients/community/go?utm_source=llms&utm_medium=ai&utm_campaign=txt): Aprende cómo interactuar con Solana usando el SDK de Go (gagliardetto/solana-go).
...
- [SDK de Java](https://solana.com/docs/es/clients/community/java?utm_source=llms&utm_medium=ai&utm_campaign=txt): Aprende a interactuar con Solana usando el SDK de Java (sava-software/sava).
...
- [SDK de Python](https://solana.com/docs/es/clients/community/python?utm_source=llms&utm_medium=ai&utm_campaign=txt): Aprende cómo interactuar con Solana usando el SDK de Python (michaelhly/solana-py).
...
- [SDK de Rust](https://solana.com/docs/es/clients/official/rust?utm_source=llms&utm_medium=ai&utm_campaign=txt): Crates oficiales de Rust para construir en Solana.
...
- [SDK de Typescript](https://solana.com/docs/es/clients/official/javascript?utm_source=llms&utm_medium=ai&utm_campaign=txt): Aprende cómo interactuar con Solana usando las bibliotecas cliente de JavaScript/TypeScript.
...
- [SDKs de juegos de Solana](https://solana.com/docs/es/clients/community/game-sdks?utm_source=llms&utm_medium=ai&utm_campaign=txt): Una lista de SDKs de juegos de Solana para ayudarte a crear tu primer juego en Solana
- [Staking](https://solana.com/docs/es/references/staking/?utm_source=llms&utm_medium=ai&utm_campaign=txt)
- [Sync Native](https://solana.com/docs/es/tokens/basics/sync-native?utm_source=llms&utm_medium=ai&utm_campaign=txt): Aprende cómo convertir SOL nativo a SOL envuelto.
- [Tarifas de transacción](https://solana.com/docs/es/core/fees?utm_source=llms&utm_medium=ai&utm_campaign=txt): Aprende sobre las tarifas de transacción de Solana, incluyendo las tarifas base y de priorización, cómo se aplica cada una, y las mejores prácticas para gestionar unidades de cómputo en tus transacciones.
- [Tarifas de transferencia](https://solana.com/docs/es/tokens/extensions/transfer-fees?utm_source=llms&utm_medium=ai&utm_campaign=txt): Aprende cómo implementar la TransferFeeExtension.
...
- [Tokens con interés](https://solana.com/docs/es/tokens/extensions/interest-bearing-tokens?utm_source=llms&utm_medium=ai&utm_campaign=txt): Aprende cómo habilitar la InterestBearingMintExtension.
...
- [Tokens no transferibles](https://solana.com/docs/es/tokens/extensions/non-transferrable-tokens?utm_source=llms&utm_medium=ai&utm_campaign=txt): Aprende cómo habilitar el InitializeNonTransferableMint.
- [Transacciones](https://solana.com/docs/es/core/transactions?utm_source=llms&utm_medium=ai&utm_campaign=txt): Aprende sobre las transacciones de Solana—los bloques fundamentales para interactuar con la blockchain de Solana. Comprende la estructura de las transacciones y la composición de instrucciones con ejemplos prácticos.
- [Transferencia con memo](https://solana.com/docs/es/tokens/extensions/memo-transfer?utm_source=llms&utm_medium=ai&utm_campaign=txt): Aprende cómo habilitar la MemoTransferExtension.
...
- [Transferir tokens](https://solana.com/docs/es/tokens/basics/transfer-tokens?utm_source=llms&utm_medium=ai&utm_campaign=txt): Aprende cómo transferir tokens entre cuentas de tokens.
- [Verificación de programas](https://solana.com/docs/es/programs/verified-builds?utm_source=llms&utm_medium=ai&utm_campaign=txt): Las compilaciones verificadas son una forma de vincular tu programa con su código fuente y permitir que todos verifiquen independientemente que el programa fue efectivamente construido a partir del código fuente proporcionado.
...
- [@solana/client](https://solana.com/docs/fi/frontend/client?utm_source=llms&utm_medium=ai&utm_campaign=txt): Rakenna kevyitä Solana-käyttöliittymiä headless Solana client -ajonaikaisympäristöllä.
- [@solana/react-hooks](https://solana.com/docs/fi/frontend/react-hooks?utm_source=llms&utm_medium=ai&utm_campaign=txt): Jaa @solana/client-tila React-sovelluksessasi valmiiden hookien avulla.
- [@solana/web3-compat](https://solana.com/docs/fi/frontend/web3-compat?utm_source=llms&utm_medium=ai&utm_campaign=txt): Yhteensopivuuskerros, joka mahdollistaa vanhan @solana/web3.js-koodin ajamisen Kit-primitiiveillä.
- [Anchor CLI perusteet](https://solana.com/docs/fi/intro/installation/anchor-cli-basics?utm_source=llms&utm_medium=ai&utm_campaign=txt): Tämä osio käy läpi yleisiä Anchor CLI -komentoja, joilla pääset alkuun.
- [Asenna riippuvuudet](https://solana.com/docs/fi/intro/installation/dependencies?utm_source=llms&utm_medium=ai&utm_campaign=txt): Opas paikallisen Solana-kehitysympäristön asentamiseen. Opi asentamaan Rust, Solana CLI ja Anchor Framework Windowsille (WSL), Linuxille ja Macille.
- [Aseta valtuus](https://solana.com/docs/fi/tokens/basics/set-authority?utm_source=llms&utm_medium=ai&utm_campaign=txt): Opi asettamaan valtuus mint- tai token-tileille.
- [Asiakkaiden generointi](https://solana.com/docs/fi/programs/codama/clients?utm_source=llms&utm_medium=ai&utm_campaign=txt): Täydellinen opas asiakkaiden generointiin Solana-ohjelmille Codama CLI:n avulla.
- [CPI Guard](https://solana.com/docs/fi/tokens/extensions/cpi-guard?utm_source=llms&utm_medium=ai&utm_campaign=txt): Opi miten CpiGuardExtension otetaan käyttöön.
- [Cross Program Invocation](https://solana.com/docs/fi/core/cpi?utm_source=llms&utm_medium=ai&utm_campaign=txt): Opi Cross Program Invocation (CPI) -toiminnosta Solanassa — miten ohjelmat voivat kutsua toisten ohjelmien käskyjä, käsitellä PDA-allekirjoittajia ja yhdistää toiminnallisuutta Solana-verkossa.
- [Delegoinnin peruuttaminen](https://solana.com/docs/fi/tokens/basics/revoke-delegate?utm_source=llms&utm_medium=ai&utm_campaign=txt): Opi kuinka token account -delegointi peruutetaan.
...
- [Ei-siirrettävät tokenit](https://solana.com/docs/fi/tokens/extensions/non-transferrable-tokens?utm_source=llms&utm_medium=ai&utm_campaign=txt): Opi miten ottaa käyttöön InitializeNonTransferableMint.
...
- [Frontend](https://solana.com/docs/fi/frontend/?utm_source=llms&utm_medium=ai&utm_campaign=txt): Opi rakentamaan käyttöliittymiä Solana-ohjelmille.
...
- [Go SDK](https://solana.com/docs/fi/clients/community/go?utm_source=llms&utm_medium=ai&utm_campaign=txt): Opi miten Solanan kanssa voi toimia Go SDK:n avulla (gagliardetto/solana-go).
- [HTTP-metodit](https://solana.com/docs/fi/rpc/http/?utm_source=llms&utm_medium=ai&utm_campaign=txt)
- [Hyväksy valtuutettu](https://solana.com/docs/fi/tokens/basics/approve-delegate?utm_source=llms&utm_medium=ai&utm_campaign=txt): Opi miten hyväksyt valtuutetut token account -tilille.
...
- [Java SDK](https://solana.com/docs/fi/clients/community/java?utm_source=llms&utm_medium=ai&utm_campaign=txt): Opi vuorovaikuttamaan Solanan kanssa Java SDK:n avulla (sava-software/sava).
- [Jäädytä tili](https://solana.com/docs/fi/tokens/basics/freeze-account?utm_source=llms&utm_medium=ai&utm_campaign=txt): Opi miten token-tilejä jäädytetään.
- [Korkoa tuottavat tokenit](https://solana.com/docs/fi/tokens/extensions/interest-bearing-tokens?utm_source=llms&utm_medium=ai&utm_campaign=txt): Opi miten InterestBearingMintExtension otetaan käyttöön.
...
- [Metadata & Metadata Pointer -laajennukset](https://solana.com/docs/fi/tokens/extensions/metadata?utm_source=llms&utm_medium=ai&utm_campaign=txt): Opi miten otetaan käyttöön MetadataPointerExtension ja TokenMetadata -laajennus.
- [Mollusk](https://solana.com/docs/fi/programs/testing/mollusk?utm_source=llms&utm_medium=ai&utm_campaign=txt): Kattava opas Solana-ohjelmien testaamiseen Molluskin avulla
- [Muistion siirto](https://solana.com/docs/fi/tokens/extensions/memo-transfer?utm_source=llms&utm_medium=ai&utm_campaign=txt): Opi miten MemoTransferExtension otetaan käyttöön.
- [Muuttumaton omistaja](https://solana.com/docs/fi/tokens/extensions/immutable-owner?utm_source=llms&utm_medium=ai&utm_campaign=txt): Opi miten ImmutableOwner-laajennus otetaan käyttöön.
- [Next.js + Solana React Hooks](https://solana.com/docs/fi/frontend/nextjs-solana?utm_source=llms&utm_medium=ai&utm_campaign=txt): Määritä Solana-lompakon integrointi Next.js:ssä @solana/clientin ja @solana/react-hooksin avulla SOL-siirtojen lähettämiseksi.
- [Next.js - Solana Kit](https://solana.com/docs/fi/frontend/kit?utm_source=llms&utm_medium=ai&utm_campaign=txt): Määritä Solana-lompakon integrointi Next.js:ssä Solana Kitin avulla.
- [Nopea asennus](https://solana.com/docs/fi/intro/installation/?utm_source=llms&utm_medium=ai&utm_campaign=txt): Nopea asennusopas, jonka avulla voit määrittää paikallisen Solana-kehitysympäristösi yhdellä komennolla. Asenna Rust, Solana CLI ja Anchor Framework Windowsissa (WSL), Linuxissa ja Macissa.
- [Ohjeet](https://solana.com/docs/fi/core/instructions?utm_source=llms&utm_medium=ai&utm_campaign=txt): Opi Solanan ohjeista—perustavanlaatuisista rakennuspalikoista Solana-lohkoketjun kanssa vuorovaikuttamiseen. Ymmärrä ohjeiden koostaminen käytännön esimerkkien avulla.
...
- [Ohjelman käyttöönotto](https://solana.com/docs/fi/intro/quick-start/deploying-programs?utm_source=llms&utm_medium=ai&utm_campaign=txt): Opi rakentamaan, ottamaan käyttöön ja testaamaan ensimmäinen Solana-ohjelmasi käyttäen Anchor-kehystä ja Solana Playgroundia. Tämä aloittelijaystävällinen opas käy läpi yksinkertaisen ohjelman luomisen, sen käyttöönoton devnetissä, testien suorittamisen ja ohjelman sulkemisen.
- [Ohjelman rakenne](https://solana.com/docs/fi/programs/rust/program-structure?utm_source=llms&utm_medium=ai&utm_campaign=txt): Opi kuinka Solana-ohjelmat rakennetaan Rustilla, mukaan lukien sisääntulopisteet, tilan hallinta, käskyjen käsittely ja testaus.
- [Ohjelmasta johdettu osoite](https://solana.com/docs/fi/core/pda?utm_source=llms&utm_medium=ai&utm_campaign=txt): Opi Solanan ohjelmasta johdetuista osoitteista (PDA) — deterministiset tiliosoitteet, jotka mahdollistavat turvallisen ohjelman allekirjoittamisen. Ymmärrä PDA:n johtaminen, kanoninen bump-arvo ja miten luoda PDA-tilejä.
- [Ohjelmat](https://solana.com/docs/fi/core/programs?utm_source=llms&utm_medium=ai&utm_campaign=txt): Opi Solanan ohjelmista (älysopimuksista) ja niiden kehittämisestä Rustilla tai Anchor-kehyksellä. Ymmärrä ohjelmien käyttöönotto, päivitykset ja varmennus Solana-verkossa.
- [Ohjelmien käyttöönotto](https://solana.com/docs/fi/programs/deploying?utm_source=llms&utm_medium=ai&utm_campaign=txt): Täydellinen opas Solana-ohjelmien rakentamiseen, käyttöönottoon ja hallintaan Solana CLI:n avulla.
- [Ohjelmien varmentaminen](https://solana.com/docs/fi/programs/verified-builds?utm_source=llms&utm_medium=ai&utm_campaign=txt): Varmennetut käännökset ovat tapa linkittää ohjelmasi lähdekoodiin ja antaa kaikkien itsenäisesti varmistaa, että ohjelma on todella rakennettu kyseisestä lähdekoodista.
- [Oletustila](https://solana.com/docs/fi/tokens/extensions/default-state?utm_source=llms&utm_medium=ai&utm_campaign=txt): Opi miten DefaultAccountStateExtension otetaan käyttöön.
...
- [Polta tokeneita](https://solana.com/docs/fi/tokens/basics/burn-tokens?utm_source=llms&utm_medium=ai&utm_campaign=txt): Opi polttamaan tokeneita.
- [Pysyvä valtuutettu](https://solana.com/docs/fi/tokens/extensions/permanent-delegate?utm_source=llms&utm_medium=ai&utm_campaign=txt): Opi miten toteuttaa InitializePermanentDelegate-laajennus.
...
- [Python SDK](https://solana.com/docs/fi/clients/community/python?utm_source=llms&utm_medium=ai&utm_campaign=txt): Opi miten olla vuorovaikutuksessa Solanan kanssa käyttäen Python SDK:ta (michaelhly/solana-py).
- [RPC-päätepisteet](https://solana.com/docs/fi/references/clusters?utm_source=llms&utm_medium=ai&utm_campaign=txt): Tutustu Solanan verkkoklusteri-ympäristöihin (Devnet, Testnet ja Mainnet), niiden julkisiin RPC-päätepisteihin, nopeusrajoituksiin ja käyttötapauksiin. Opi yhdistämään eri Solana-verkkoihin kehitystä, testausta ja tuotantoa varten.
...
- [Rust SDK](https://solana.com/docs/fi/clients/official/rust?utm_source=llms&utm_medium=ai&utm_campaign=txt): Viralliset Rust-paketit Solana-kehitykseen.
...
- [Siirtomaksut](https://solana.com/docs/fi/tokens/extensions/transfer-fees?utm_source=llms&utm_medium=ai&utm_campaign=txt): Opi miten TransferFeeExtension toteutetaan.
...
- [Solana CLI perusteet](https://solana.com/docs/fi/intro/installation/solana-cli-basics?utm_source=llms&utm_medium=ai&utm_campaign=txt): Tämä osio käy läpi yleisiä Solana CLI -komentoja, joiden avulla pääset alkuun.
...
- [Solana-pelien SDK:t](https://solana.com/docs/fi/clients/community/game-sdks?utm_source=llms&utm_medium=ai&utm_campaign=txt): Lista Solana-pelien SDK:ista, joiden avulla voit aloittaa ensimmäisen Solana-pelisi luomisen
...
- [Sulauta tili](https://solana.com/docs/fi/tokens/basics/thaw-account?utm_source=llms&utm_medium=ai&utm_campaign=txt): Opi miten sulautetaan jäädytetty token-tili.
- [Sulje Mint](https://solana.com/docs/fi/tokens/extensions/close-mint?utm_source=llms&utm_medium=ai&utm_campaign=txt): Opi miten MintCloseAuthority-laajennus otetaan käyttöön.
- [Sulje token-tili](https://solana.com/docs/fi/tokens/basics/close-account?utm_source=llms&utm_medium=ai&utm_campaign=txt): Opi sulkemaan token-tilejä.
...
- [Surfpool CLI perusteet](https://solana.com/docs/fi/intro/installation/surfpool-cli-basics?utm_source=llms&utm_medium=ai&utm_campaign=txt): Opi olennaiset Surfpool CLI -komennot paikalliseen Solana-kehitykseen, mukaan lukien validatorin käynnistäminen ja Surfpool Studion käyttö.
- [Sync Native](https://solana.com/docs/fi/tokens/basics/sync-native?utm_source=llms&utm_medium=ai&utm_campaign=txt): Opi kuinka muuntaa natiivi SOL käärityksi SOL:ksi.
...
- [Tokenien siirtäminen](https://solana.com/docs/fi/tokens/basics/transfer-tokens?utm_source=llms&utm_medium=ai&utm_campaign=txt): Opi siirtämään tokeneita token-tilien välillä.
...
- [Transaktiomaksut](https://solana.com/docs/fi/core/fees?utm_source=llms&utm_medium=ai&utm_campaign=txt): Opi Solanan transaktiomaksuista, mukaan lukien perus- ja priorisointimaksut, miten kutakin sovelletaan ja parhaat käytännöt laskentayksiköiden hallintaan transaktioissasi.
- [Transaktiot](https://solana.com/docs/fi/core/transactions?utm_source=llms&utm_medium=ai&utm_campaign=txt): Opi Solanan transaktioista—perustavanlaatuisista rakennuspalikoista Solana-lohkoketjun kanssa vuorovaikuttamiseen. Ymmärrä transaktioiden rakenne ja ohjeiden koostaminen käytännön esimerkkien avulla.
...
- [Typescript SDK](https://solana.com/docs/fi/clients/official/javascript?utm_source=llms&utm_medium=ai&utm_campaign=txt): Opi miten Solanaa käytetään JavaScript/TypeScript-asiakaskirjastojen avulla.
...
- [Ydinkäsitteet](https://solana.com/docs/fi/core/?utm_source=llms&utm_medium=ai&utm_campaign=txt): Opi keskeiset Solana-lohkoketjun käsitteet, mukaan lukien tilit, transaktiot, ohjelmat, ohjelmista johdetut osoitteet, ohjelmien väliset kutsut ja kuinka tokenit toimivat Solanassa.
...
- [@solana/client](https://solana.com/docs/fr/frontend/client?utm_source=llms&utm_medium=ai&utm_campaign=txt): Créez des interfaces Solana légères avec le runtime client Solana headless.
- [@solana/react-hooks](https://solana.com/docs/fr/frontend/react-hooks?utm_source=llms&utm_medium=ai&utm_campaign=txt): Partagez l'état de @solana/client dans votre application React avec des hooks prêts à l'emploi.
- [@solana/web3-compat](https://solana.com/docs/fr/frontend/web3-compat?utm_source=llms&utm_medium=ai&utm_campaign=txt): Couche de compatibilité transparente qui permet au code legacy @solana/web3.js de fonctionner sur les primitives Kit.
- [Adresse dérivée de programme](https://solana.com/docs/fr/core/pda?utm_source=llms&utm_medium=ai&utm_campaign=txt): Découvrez les adresses dérivées de programme (PDAs) de Solana — des adresses de compte déterministes qui permettent une signature sécurisée par programme. Comprenez la dérivation des PDAs, les bumps canoniques et comment créer des comptes PDA.
...
- [Approuver un délégué](https://solana.com/docs/fr/tokens/basics/approve-delegate?utm_source=llms&utm_medium=ai&utm_campaign=txt): Apprenez comment approuver des délégués pour un token account.
- [Bases de la CLI Anchor](https://solana.com/docs/fr/intro/installation/anchor-cli-basics?utm_source=llms&utm_medium=ai&utm_campaign=txt): Cette section présente quelques commandes courantes de la CLI Anchor pour vous aider à démarrer.
- [Bases de la CLI Solana](https://solana.com/docs/fr/intro/installation/solana-cli-basics?utm_source=llms&utm_medium=ai&utm_campaign=txt): Cette section présente quelques commandes courantes de la CLI Solana pour vous aider à démarrer.
- [Bases de la CLI Surfpool](https://solana.com/docs/fr/intro/installation/surfpool-cli-basics?utm_source=llms&utm_medium=ai&utm_campaign=txt): Apprenez les commandes essentielles de la CLI Surfpool pour le développement local sur Solana, y compris le démarrage d'un validator et l'utilisation de Surfpool Studio.
- [Brûler des tokens](https://solana.com/docs/fr/tokens/basics/burn-tokens?utm_source=llms&utm_medium=ai&utm_campaign=txt): Apprenez comment brûler des tokens.
- [CPI Guard](https://solana.com/docs/fr/tokens/extensions/cpi-guard?utm_source=llms&utm_medium=ai&utm_campaign=txt): Apprenez comment activer l'extension CpiGuardExtension.
...
- [Concepts fondamentaux](https://solana.com/docs/fr/core/?utm_source=llms&utm_medium=ai&utm_campaign=txt): Découvrez les concepts essentiels de la blockchain Solana, notamment les comptes, les transactions, les programmes, les adresses dérivées de programmes, les invocations entre programmes, et le fonctionnement des tokens sur Solana.
...
- [Créer un compte de jetons](https://solana.com/docs/fr/tokens/basics/create-token-account?utm_source=llms&utm_medium=ai&utm_campaign=txt): Apprenez à créer des comptes de jetons SPL.
...
- [Définir l'autorité](https://solana.com/docs/fr/tokens/basics/set-authority?utm_source=llms&utm_medium=ai&utm_campaign=txt): Apprenez à définir l'autorité pour les mint accounts ou les token accounts.
- [Dégeler un compte](https://solana.com/docs/fr/tokens/basics/thaw-account?utm_source=llms&utm_medium=ai&utm_campaign=txt): Apprenez comment dégeler un token account gelé.
- [Délégué permanent](https://solana.com/docs/fr/tokens/extensions/permanent-delegate?utm_source=llms&utm_medium=ai&utm_campaign=txt): Apprenez à implémenter l'extension InitializePermanentDelegate.
...
- [Extensions de métadonnées et pointeur de métadonnées](https://solana.com/docs/fr/tokens/extensions/metadata?utm_source=llms&utm_medium=ai&utm_campaign=txt): Apprenez à activer l'extension MetadataPointerExtension et l'extension TokenMetadata.
- [FAQ](https://solana.com/docs/fr/programs/faq?utm_source=llms&utm_medium=ai&utm_campaign=txt)
- [Fermer un compte de token](https://solana.com/docs/fr/tokens/basics/close-account?utm_source=llms&utm_medium=ai&utm_campaign=txt): Apprenez comment fermer des comptes de token.
- [Fermeture de mint](https://solana.com/docs/fr/tokens/extensions/close-mint?utm_source=llms&utm_medium=ai&utm_campaign=txt): Apprenez comment activer l'extension MintCloseAuthority.
- [Frais de transaction](https://solana.com/docs/fr/core/fees?utm_source=llms&utm_medium=ai&utm_campaign=txt): Découvrez les frais de transaction de Solana, y compris les frais de base et les frais de priorisation, comment chacun est appliqué, et les meilleures pratiques pour gérer les unités de calcul dans vos transactions.
- [Frais de transfert](https://solana.com/docs/fr/tokens/extensions/transfer-fees?utm_source=llms&utm_medium=ai&utm_campaign=txt): Apprenez à implémenter l'extension TransferFeeExtension.
- [Frontend](https://solana.com/docs/fr/frontend/?utm_source=llms&utm_medium=ai&utm_campaign=txt): Apprenez à créer des interfaces pour les programmes Solana.
- [Geler un compte](https://solana.com/docs/fr/tokens/basics/freeze-account?utm_source=llms&utm_medium=ai&utm_campaign=txt): Apprenez comment geler des token accounts.
- [Groupes de tokens et membres](https://solana.com/docs/fr/tokens/extensions/group-member?utm_source=llms&utm_medium=ai&utm_campaign=txt): Apprenez comment activer GroupPointerExtension et GroupMemberPointerExtension.
...
- [Génération de clients](https://solana.com/docs/fr/programs/codama/clients?utm_source=llms&utm_medium=ai&utm_campaign=txt): Guide complet pour générer des clients pour les programmes Solana à l'aide de Codama CLI.
- [Installation rapide](https://solana.com/docs/fr/intro/installation/?utm_source=llms&utm_medium=ai&utm_campaign=txt): Un guide d'installation rapide qui vous permet de configurer votre environnement de développement Solana local avec une seule commande. Installez Rust, la CLI Solana et le framework Anchor sur Windows (WSL), Linux et Mac.
- [Installer les dépendances](https://solana.com/docs/fr/intro/installation/dependencies?utm_source=llms&utm_medium=ai&utm_campaign=txt): Un guide pour configurer votre environnement de développement Solana local. Apprenez à installer Rust, la CLI Solana et le framework Anchor sur Windows (WSL), Linux et Mac.
- [Instructions](https://solana.com/docs/fr/core/instructions?utm_source=llms&utm_medium=ai&utm_campaign=txt): Découvrez les instructions Solana—les éléments fondamentaux pour interagir avec la blockchain Solana. Comprenez la composition des instructions avec des exemples pratiques.
- [Jetons non transférables](https://solana.com/docs/fr/tokens/extensions/non-transferrable-tokens?utm_source=llms&utm_medium=ai&utm_campaign=txt): Apprenez comment activer l'extension InitializeNonTransferableMint.
- [Jetons porteurs d'intérêts](https://solana.com/docs/fr/tokens/extensions/interest-bearing-tokens?utm_source=llms&utm_medium=ai&utm_campaign=txt): Apprenez comment activer l'InterestBearingMintExtension.
...
- [Minter des tokens](https://solana.com/docs/fr/tokens/basics/mint-tokens?utm_source=llms&utm_medium=ai&utm_campaign=txt): Apprenez comment minter de nouvelles unités d'un token.
- [Mollusk](https://solana.com/docs/fr/programs/testing/mollusk?utm_source=llms&utm_medium=ai&utm_campaign=txt): Guide complet pour tester les programmes Solana en utilisant Mollusk
...
- [Next.js + Solana React Hooks](https://solana.com/docs/fr/frontend/nextjs-solana?utm_source=llms&utm_medium=ai&utm_campaign=txt): Configurez l'intégration de portefeuille Solana dans Next.js avec @solana/client et @solana/react-hooks pour envoyer des transferts SOL.
- [Next.js - Solana Kit](https://solana.com/docs/fr/frontend/kit?utm_source=llms&utm_medium=ai&utm_campaign=txt): Configurez l'intégration d'un portefeuille Solana dans Next.js avec Solana Kit.
...
- [Points de terminaison RPC](https://solana.com/docs/fr/references/clusters?utm_source=llms&utm_medium=ai&utm_campaign=txt): Découvrez les clusters réseau de Solana (Devnet, Testnet et Mainnet), leurs points de terminaison RPC publics, les limites de débit et les cas d'usage. Apprenez à vous connecter aux différents réseaux Solana pour le développement, les tests et la production.
...
- [Propriétaire immuable](https://solana.com/docs/fr/tokens/extensions/immutable-owner?utm_source=llms&utm_medium=ai&utm_campaign=txt): Apprenez comment activer l'extension ImmutableOwner.
...
- [Révoquer un délégué](https://solana.com/docs/fr/tokens/basics/revoke-delegate?utm_source=llms&utm_medium=ai&utm_campaign=txt): Apprenez comment révoquer le délégué d'un token account.
...
- [SDK Go](https://solana.com/docs/fr/clients/community/go?utm_source=llms&utm_medium=ai&utm_campaign=txt): Apprenez à interagir avec Solana en utilisant le SDK Go (gagliardetto/solana-go).
...
- [SDK Java](https://solana.com/docs/fr/clients/community/java?utm_source=llms&utm_medium=ai&utm_campaign=txt): Apprenez à interagir avec Solana en utilisant le SDK Java (sava-software/sava).
...
- [SDK Python](https://solana.com/docs/fr/clients/community/python?utm_source=llms&utm_medium=ai&utm_campaign=txt): Apprenez à interagir avec Solana en utilisant le SDK Python (michaelhly/solana-py).
...
- [SDK Rust](https://solana.com/docs/fr/clients/official/rust?utm_source=llms&utm_medium=ai&utm_campaign=txt): Crates Rust officiels pour développer sur Solana.
...
- [SDK Typescript](https://solana.com/docs/fr/clients/official/javascript?utm_source=llms&utm_medium=ai&utm_campaign=txt): Apprenez à interagir avec Solana en utilisant les bibliothèques client JavaScript/TypeScript.
...
- [SDKs de jeu Solana](https://solana.com/docs/fr/clients/community/game-sdks?utm_source=llms&utm_medium=ai&utm_campaign=txt): Une liste des SDKs de jeu Solana pour vous aider à créer votre premier jeu Solana
...
- [Sync Native](https://solana.com/docs/fr/tokens/basics/sync-native?utm_source=llms&utm_medium=ai&utm_campaign=txt): Apprenez comment convertir du SOL natif en SOL encapsulé.
...
- [Transactions](https://solana.com/docs/fr/core/transactions?utm_source=llms&utm_medium=ai&utm_campaign=txt): Découvrez les transactions Solana—les éléments fondamentaux pour interagir avec la blockchain Solana. Comprenez la structure des transactions et la composition des instructions avec des exemples pratiques.
- [Transfert avec mémo](https://solana.com/docs/fr/tokens/extensions/memo-transfer?utm_source=llms&utm_medium=ai&utm_campaign=txt): Apprenez comment activer l'extension MemoTransferExtension.
...
- [Transférer des jetons](https://solana.com/docs/fr/tokens/basics/transfer-tokens?utm_source=llms&utm_medium=ai&utm_campaign=txt): Apprenez comment transférer des jetons entre comptes de jetons.
- [Vérification des programmes](https://solana.com/docs/fr/programs/verified-builds?utm_source=llms&utm_medium=ai&utm_campaign=txt): Les builds vérifiés sont un moyen de lier votre programme à son code source et de permettre à chacun de vérifier indépendamment que le programme a bien été construit à partir de ce code source fourni.
...
- [État par défaut](https://solana.com/docs/fr/tokens/extensions/default-state?utm_source=llms&utm_medium=ai&utm_campaign=txt): Apprenez comment activer l'extension DefaultAccountStateExtension.

## Docs - Id

- [@solana/client](https://solana.com/docs/id/frontend/client?utm_source=llms&utm_medium=ai&utm_campaign=txt): Bangun frontend Solana yang ramping dengan runtime klien Solana headless.
- [@solana/react-hooks](https://solana.com/docs/id/frontend/react-hooks?utm_source=llms&utm_medium=ai&utm_campaign=txt): Bagikan state @solana/client di seluruh aplikasi React Anda dengan hooks yang siap pakai.
- [@solana/web3-compat](https://solana.com/docs/id/frontend/web3-compat?utm_source=llms&utm_medium=ai&utm_campaign=txt): Lapisan kompatibilitas drop-in yang memungkinkan kode legacy @solana/web3.js berjalan pada primitif Kit.
- [Akun](https://solana.com/docs/id/core/accounts?utm_source=llms&utm_medium=ai&utm_campaign=txt): Pelajari tentang model akun Solana, termasuk bagaimana akun menyimpan data dan program, mekanisme rent, kepemilikan akun, dan hubungan antara program dan akun data. Pahami konsep inti dari sistem penyimpanan key-value Solana.
- [Akun Stake](https://solana.com/docs/id/references/staking/stake-accounts?utm_source=llms&utm_medium=ai&utm_campaign=txt)
- [Alamat Turunan Program](https://solana.com/docs/id/core/pda?utm_source=llms&utm_medium=ai&utm_campaign=txt): Pelajari tentang Alamat Turunan Program (PDA) Solana — alamat akun deterministik yang memungkinkan penandatanganan program yang aman. Pahami derivasi PDA, bump kanonik, dan cara membuat akun PDA.
- [Bakar Token](https://solana.com/docs/id/tokens/basics/burn-tokens?utm_source=llms&utm_medium=ai&utm_campaign=txt): Pelajari cara membakar token.
- [Batasan](https://solana.com/docs/id/programs/limitations?utm_source=llms&utm_medium=ai&utm_campaign=txt)
- [Biaya Transfer](https://solana.com/docs/id/tokens/extensions/transfer-fees?utm_source=llms&utm_medium=ai&utm_campaign=txt): Pelajari cara mengimplementasikan TransferFeeExtension.
...
- [CPI Guard](https://solana.com/docs/id/tokens/extensions/cpi-guard?utm_source=llms&utm_medium=ai&utm_campaign=txt): Pelajari cara mengaktifkan CpiGuardExtension.
...
- [Dasar-Dasar CLI Anchor](https://solana.com/docs/id/intro/installation/anchor-cli-basics?utm_source=llms&utm_medium=ai&utm_campaign=txt): Bagian ini membahas beberapa perintah CLI Anchor umum untuk membantu Anda memulai.
- [Dasar-dasar CLI Solana](https://solana.com/docs/id/intro/installation/solana-cli-basics?utm_source=llms&utm_medium=ai&utm_campaign=txt): Bagian ini membahas beberapa perintah CLI Solana umum untuk membantu Anda memulai.
...
- [Dasar-dasar Surfpool CLI](https://solana.com/docs/id/intro/installation/surfpool-cli-basics?utm_source=llms&utm_medium=ai&utm_campaign=txt): Pelajari perintah penting Surfpool CLI untuk pengembangan Solana lokal, termasuk memulai validator dan menggunakan Surfpool Studio.
...
- [Delegasi Permanen](https://solana.com/docs/id/tokens/extensions/permanent-delegate?utm_source=llms&utm_medium=ai&utm_campaign=txt): Pelajari cara mengimplementasikan ekstensi InitializePermanentDelegate.
- [Deploy Program](https://solana.com/docs/id/intro/quick-start/deploying-programs?utm_source=llms&utm_medium=ai&utm_campaign=txt): Pelajari cara membangun, men-deploy, dan menguji program Solana pertama Anda menggunakan framework Anchor dan Solana Playground. Panduan ramah pemula ini memandu Anda dalam membuat program sederhana, men-deploy-nya ke devnet, menjalankan pengujian, dan menutup program.
...
- [Ekstensi Metadata & Pointer Metadata](https://solana.com/docs/id/tokens/extensions/metadata?utm_source=llms&utm_medium=ai&utm_campaign=txt): Pelajari cara mengaktifkan ekstensi MetadataPointerExtension dan TokenMetadata.
- [Endpoint RPC](https://solana.com/docs/id/references/clusters?utm_source=llms&utm_medium=ai&utm_campaign=txt): Pelajari tentang cluster jaringan Solana (Devnet, Testnet, dan Mainnet), endpoint RPC publik, batasan rate, dan kasus penggunaan. Pelajari cara terhubung ke berbagai jaringan Solana untuk pengembangan, pengujian, dan produksi.
...
- [Frontend](https://solana.com/docs/id/frontend/?utm_source=llms&utm_medium=ai&utm_campaign=txt): Pelajari tentang membangun antarmuka untuk program Solana.
...
- [Grup Token dan Anggota](https://solana.com/docs/id/tokens/extensions/group-member?utm_source=llms&utm_medium=ai&utm_campaign=txt): Pelajari cara mengaktifkan GroupPointerExtension dan GroupMemberPointerExtension.
- [Instal Dependensi](https://solana.com/docs/id/intro/installation/dependencies?utm_source=llms&utm_medium=ai&utm_campaign=txt): Panduan untuk menyiapkan lingkungan pengembangan Solana lokal Anda. Pelajari cara menginstal Rust, Solana CLI, dan Anchor Framework di Windows (WSL), Linux, dan Mac.
- [Instalasi Cepat](https://solana.com/docs/id/intro/installation/?utm_source=llms&utm_medium=ai&utm_campaign=txt): Panduan instalasi cepat yang memungkinkan Anda menyiapkan lingkungan pengembangan Solana lokal dengan satu perintah. Instal Rust, Solana CLI, dan Anchor Framework di Windows (WSL), Linux, dan Mac.
- [Instruksi](https://solana.com/docs/id/core/instructions?utm_source=llms&utm_medium=ai&utm_campaign=txt): Pelajari tentang instruksi Solana—blok bangunan fundamental untuk berinteraksi dengan blockchain Solana. Pahami komposisi instruksi dengan contoh praktis.
...
- [Java SDK](https://solana.com/docs/id/clients/community/java?utm_source=llms&utm_medium=ai&utm_campaign=txt): Pelajari cara berinteraksi dengan Solana menggunakan Java SDK (sava-software/sava).
...
- [Konsep Inti](https://solana.com/docs/id/core/?utm_source=llms&utm_medium=ai&utm_campaign=txt): Pelajari konsep-konsep penting blockchain Solana termasuk akun, transaksi, program, alamat turunan program, pemanggilan lintas program, dan bagaimana token bekerja di Solana.
...
- [Membekukan Akun](https://solana.com/docs/id/tokens/basics/freeze-account?utm_source=llms&utm_medium=ai&utm_campaign=txt): Pelajari cara membekukan token account.
...
- [Memverifikasi Program](https://solana.com/docs/id/programs/verified-builds?utm_source=llms&utm_medium=ai&utm_campaign=txt): Build terverifikasi adalah cara untuk menghubungkan program Anda dengan kode sumbernya dan memungkinkan semua orang secara independen memverifikasi bahwa program tersebut memang dibangun dari kode sumber yang disediakan.
...
- [Mencabut Delegasi](https://solana.com/docs/id/tokens/basics/revoke-delegate?utm_source=llms&utm_medium=ai&utm_campaign=txt): Pelajari cara mencabut delegasi token account.
- [Mencairkan Akun](https://solana.com/docs/id/tokens/basics/thaw-account?utm_source=llms&utm_medium=ai&utm_campaign=txt): Pelajari cara mencairkan token account yang dibekukan.
- [Menerapkan Program](https://solana.com/docs/id/programs/deploying?utm_source=llms&utm_medium=ai&utm_campaign=txt): Panduan lengkap untuk membangun, men-deploy, dan mengelola program Solana menggunakan Solana CLI.
- [Mengatur Authority](https://solana.com/docs/id/tokens/basics/set-authority?utm_source=llms&utm_medium=ai&utm_campaign=txt): Pelajari cara mengatur authority untuk mint atau token account.
- [Menghasilkan Klien](https://solana.com/docs/id/programs/codama/clients?utm_source=llms&utm_medium=ai&utm_campaign=txt): Panduan lengkap untuk menghasilkan klien untuk program Solana menggunakan Codama CLI.
...
- [Menutup Token Account](https://solana.com/docs/id/tokens/basics/close-account?utm_source=llms&utm_medium=ai&utm_campaign=txt): Pelajari cara menutup token account.
- [Menyetujui Delegasi](https://solana.com/docs/id/tokens/basics/approve-delegate?utm_source=llms&utm_medium=ai&utm_campaign=txt): Pelajari cara menyetujui delegasi untuk token account.
...
- [Mollusk](https://solana.com/docs/id/programs/testing/mollusk?utm_source=llms&utm_medium=ai&utm_campaign=txt): Panduan komprehensif untuk menguji program Solana menggunakan Mollusk
...
- [Next.js + Solana React Hooks](https://solana.com/docs/id/frontend/nextjs-solana?utm_source=llms&utm_medium=ai&utm_campaign=txt): Siapkan integrasi dompet Solana di Next.js dengan @solana/client dan @solana/react-hooks untuk mengirim transfer SOL.
- [Next.js - Solana Kit](https://solana.com/docs/id/frontend/kit?utm_source=llms&utm_medium=ai&utm_campaign=txt): Siapkan integrasi dompet Solana di Next.js dengan Solana Kit.
...
- [Pemilik Tidak Dapat Diubah](https://solana.com/docs/id/tokens/extensions/immutable-owner?utm_source=llms&utm_medium=ai&utm_campaign=txt): Pelajari cara mengaktifkan Ekstensi ImmutableOwner.
...
- [Program](https://solana.com/docs/id/core/programs?utm_source=llms&utm_medium=ai&utm_campaign=txt): Pelajari tentang program Solana (smart contract) dan cara mengembangkannya menggunakan Rust atau framework Anchor. Pahami deployment program, upgrade, dan verifikasi di jaringan Solana.
...
- [Python SDK](https://solana.com/docs/id/clients/community/python?utm_source=llms&utm_medium=ai&utm_campaign=txt): Pelajari cara berinteraksi dengan Solana menggunakan Python SDK (michaelhly/solana-py).
...
- [Rust SDK](https://solana.com/docs/id/clients/official/rust?utm_source=llms&utm_medium=ai&utm_campaign=txt): Crates Rust resmi untuk membangun di Solana.
...
- [SDK Gaming Solana](https://solana.com/docs/id/clients/community/game-sdks?utm_source=llms&utm_medium=ai&utm_campaign=txt): Daftar SDK Gaming Solana untuk membantu Anda memulai membuat Game Solana pertama Anda
- [SDK Go](https://solana.com/docs/id/clients/community/go?utm_source=llms&utm_medium=ai&utm_campaign=txt): Pelajari cara berinteraksi dengan Solana menggunakan SDK Go (gagliardetto/solana-go).
- [Staking](https://solana.com/docs/id/references/staking/?utm_source=llms&utm_medium=ai&utm_campaign=txt)
- [Status Default](https://solana.com/docs/id/tokens/extensions/default-state?utm_source=llms&utm_medium=ai&utm_campaign=txt): Pelajari cara mengaktifkan DefaultAccountStateExtension.
- [Struktur Data sebagai JSON](https://solana.com/docs/id/rpc/json-structures?utm_source=llms&utm_medium=ai&utm_campaign=txt)
- [Struktur Program](https://solana.com/docs/id/programs/rust/program-structure?utm_source=llms&utm_medium=ai&utm_campaign=txt): Pelajari cara menyusun program Solana dalam Rust, termasuk entrypoint, manajemen state, penanganan instruksi, dan pengujian.
- [Sync Native](https://solana.com/docs/id/tokens/basics/sync-native?utm_source=llms&utm_medium=ai&utm_campaign=txt): Pelajari cara mengkonversi SOL native menjadi wrapped SOL.
...
- [Token Berbunga](https://solana.com/docs/id/tokens/extensions/interest-bearing-tokens?utm_source=llms&utm_medium=ai&utm_campaign=txt): Pelajari cara mengaktifkan InterestBearingMintExtension.
- [Token Non-Transferable](https://solana.com/docs/id/tokens/extensions/non-transferrable-tokens?utm_source=llms&utm_medium=ai&utm_campaign=txt): Pelajari cara mengaktifkan InitializeNonTransferableMint.
...
- [Transaksi](https://solana.com/docs/id/core/transactions?utm_source=llms&utm_medium=ai&utm_campaign=txt): Pelajari tentang transaksi Solana—blok bangunan fundamental untuk berinteraksi dengan blockchain Solana. Pahami struktur transaksi dan komposisi instruksi dengan contoh praktis.
...
- [Transfer Token](https://solana.com/docs/id/tokens/basics/transfer-tokens?utm_source=llms&utm_medium=ai&utm_campaign=txt): Pelajari cara mentransfer token antar akun token.
- [Transfer memo](https://solana.com/docs/id/tokens/extensions/memo-transfer?utm_source=llms&utm_medium=ai&utm_campaign=txt): Pelajari cara mengaktifkan MemoTransferExtension.
- [Tutup Mint](https://solana.com/docs/id/tokens/extensions/close-mint?utm_source=llms&utm_medium=ai&utm_campaign=txt): Pelajari cara mengaktifkan ekstensi MintCloseAuthority.
...
- [Typescript SDK](https://solana.com/docs/id/clients/official/javascript?utm_source=llms&utm_medium=ai&utm_campaign=txt): Pelajari cara berinteraksi dengan Solana menggunakan pustaka klien JavaScript/TypeScript.
...
- [@solana/client](https://solana.com/docs/it/frontend/client?utm_source=llms&utm_medium=ai&utm_campaign=txt): Costruisci frontend Solana leggeri con il runtime client Solana headless.
- [@solana/react-hooks](https://solana.com/docs/it/frontend/react-hooks?utm_source=llms&utm_medium=ai&utm_campaign=txt): Condividi lo stato di @solana/client nella tua app React con hook pronti all'uso.
- [@solana/web3-compat](https://solana.com/docs/it/frontend/web3-compat?utm_source=llms&utm_medium=ai&utm_campaign=txt): Livello di compatibilità drop-in che consente al codice legacy di @solana/web3.js di funzionare con le primitive di Kit.
- [Account](https://solana.com/docs/it/core/accounts?utm_source=llms&utm_medium=ai&utm_campaign=txt): Scopri il modello di account di Solana, incluso come gli account memorizzano dati e programmi, i meccanismi di rent, la proprietà degli account e la relazione tra programmi e account di dati. Comprendi i concetti fondamentali del sistema di archiviazione chiave-valore di Solana.
...
- [Approva delegato](https://solana.com/docs/it/tokens/basics/approve-delegate?utm_source=llms&utm_medium=ai&utm_campaign=txt): Impara come approvare i delegati per un token account.
- [Brucia Token](https://solana.com/docs/it/tokens/basics/burn-tokens?utm_source=llms&utm_medium=ai&utm_campaign=txt): Impara come bruciare i token.
- [CPI Guard](https://solana.com/docs/it/tokens/extensions/cpi-guard?utm_source=llms&utm_medium=ai&utm_campaign=txt): Scopri come abilitare il CpiGuardExtension.
- [Chiudi un token account](https://solana.com/docs/it/tokens/basics/close-account?utm_source=llms&utm_medium=ai&utm_campaign=txt): Impara come chiudere i token account.
- [Chiusura Mint](https://solana.com/docs/it/tokens/extensions/close-mint?utm_source=llms&utm_medium=ai&utm_campaign=txt): Scopri come abilitare l'estensione MintCloseAuthority.
...
- [Commissioni di trasferimento](https://solana.com/docs/it/tokens/extensions/transfer-fees?utm_source=llms&utm_medium=ai&utm_campaign=txt): Impara come implementare la TransferFeeExtension.
...
- [Concetti fondamentali](https://solana.com/docs/it/core/?utm_source=llms&utm_medium=ai&utm_campaign=txt): Impara i concetti essenziali della blockchain Solana inclusi account, transazioni, programmi, indirizzi derivati dai programmi, invocazioni tra programmi e come funzionano i token su Solana.
- [Congela account](https://solana.com/docs/it/tokens/basics/freeze-account?utm_source=llms&utm_medium=ai&utm_campaign=txt): Impara come congelare i token account.
...
- [Cross Program Invocation](https://solana.com/docs/it/core/cpi?utm_source=llms&utm_medium=ai&utm_campaign=txt): Scopri le Cross Program Invocation (CPI) su Solana — come i programmi possono chiamare istruzioni su altri programmi, gestire firmatari PDA e comporre funzionalità attraverso la rete Solana.
- [Delegato permanente](https://solana.com/docs/it/tokens/extensions/permanent-delegate?utm_source=llms&utm_medium=ai&utm_campaign=txt): Scopri come implementare l'estensione InitializePermanentDelegate.
...
- [Distribuisci un programma](https://solana.com/docs/it/intro/quick-start/deploying-programs?utm_source=llms&utm_medium=ai&utm_campaign=txt): Impara come costruire, distribuire e testare il tuo primo programma Solana utilizzando il framework Anchor e Solana Playground. Questa guida per principianti ti accompagna nella creazione di un programma semplice, nella distribuzione su devnet, nell'esecuzione dei test e nella chiusura del programma.
- [Distribuzione dei programmi](https://solana.com/docs/it/programs/deploying?utm_source=llms&utm_medium=ai&utm_campaign=txt): Guida completa per costruire, distribuire e gestire programmi Solana utilizzando la CLI di Solana.
...
- [Endpoint RPC](https://solana.com/docs/it/references/clusters?utm_source=llms&utm_medium=ai&utm_campaign=txt): Scopri i cluster di rete di Solana (Devnet, Testnet e Mainnet), i loro endpoint RPC pubblici, i limiti di frequenza e i casi d'uso. Impara a connetterti alle diverse reti Solana per sviluppo, test e produzione.
...
- [Estensioni Metadata & Metadata Pointer](https://solana.com/docs/it/tokens/extensions/metadata?utm_source=llms&utm_medium=ai&utm_campaign=txt): Scopri come abilitare l'estensione MetadataPointerExtension e TokenMetadata.
...
- [Frontend](https://solana.com/docs/it/frontend/?utm_source=llms&utm_medium=ai&utm_campaign=txt): Scopri come costruire interfacce per i programmi Solana.
- [Generazione di client](https://solana.com/docs/it/programs/codama/clients?utm_source=llms&utm_medium=ai&utm_campaign=txt): Guida completa alla generazione di client per i programmi Solana utilizzando la CLI Codama.
- [Gruppi di token e membri](https://solana.com/docs/it/tokens/extensions/group-member?utm_source=llms&utm_medium=ai&utm_campaign=txt): Scopri come abilitare GroupPointerExtension e GroupMemberPointerExtension.
...
- [Imposta autorità](https://solana.com/docs/it/tokens/basics/set-authority?utm_source=llms&utm_medium=ai&utm_campaign=txt): Impara come impostare l'autorità per i mint account o i token account.
- [Indirizzo derivato dal programma](https://solana.com/docs/it/core/pda?utm_source=llms&utm_medium=ai&utm_campaign=txt): Scopri gli indirizzi derivati dal programma (PDA) di Solana — indirizzi di account deterministici che consentono una firma sicura del programma. Comprendi la derivazione PDA, i bump canonici e come creare account PDA.
- [Installare le dipendenze](https://solana.com/docs/it/intro/installation/dependencies?utm_source=llms&utm_medium=ai&utm_campaign=txt): Una guida per configurare il tuo ambiente di sviluppo locale Solana. Impara come installare Rust, la CLI di Solana e il framework Anchor su Windows (WSL), Linux e Mac.
- [Installazione rapida](https://solana.com/docs/it/intro/installation/?utm_source=llms&utm_medium=ai&utm_campaign=txt): Una guida di installazione rapida che ti permette di configurare il tuo ambiente di sviluppo locale Solana con un singolo comando. Installa Rust, la CLI di Solana e il Framework Anchor su Windows (WSL), Linux e Mac.
- [Istruzioni](https://solana.com/docs/it/core/instructions?utm_source=llms&utm_medium=ai&utm_campaign=txt): Scopri le istruzioni di Solana—i blocchi fondamentali per interagire con la blockchain Solana. Comprendi la composizione delle istruzioni con esempi pratici.
...
- [Java SDK](https://solana.com/docs/it/clients/community/java?utm_source=llms&utm_medium=ai&utm_campaign=txt): Scopri come interagire con Solana utilizzando l'SDK Java (sava-software/sava).
- [Lettura dalla rete](https://solana.com/docs/it/intro/quick-start/reading-from-network?utm_source=llms&utm_medium=ai&utm_campaign=txt): Impara come leggere dati dalla rete blockchain di Solana. Questa guida copre il recupero di account wallet, account di programma e account di token mint utilizzando JavaScript/TypeScript, con esempi pratici che utilizzano la libreria Solana web3.js.
...
- [Mollusk](https://solana.com/docs/it/programs/testing/mollusk?utm_source=llms&utm_medium=ai&utm_campaign=txt): Guida completa per testare i programmi Solana utilizzando Mollusk
- [Next.js + Solana React Hooks](https://solana.com/docs/it/frontend/nextjs-solana?utm_source=llms&utm_medium=ai&utm_campaign=txt): Configura l'integrazione del wallet Solana in Next.js con @solana/client e @solana/react-hooks per inviare trasferimenti SOL.
- [Next.js - Solana Kit](https://solana.com/docs/it/frontend/kit?utm_source=llms&utm_medium=ai&utm_campaign=txt): Configura l'integrazione del wallet Solana in Next.js con Solana Kit.
- [Nozioni di base della CLI di Anchor](https://solana.com/docs/it/intro/installation/anchor-cli-basics?utm_source=llms&utm_medium=ai&utm_campaign=txt): Questa sezione illustra alcuni comandi comuni della CLI di Anchor per aiutarti a iniziare.
...
- [Nozioni di base sulla CLI di Solana](https://solana.com/docs/it/intro/installation/solana-cli-basics?utm_source=llms&utm_medium=ai&utm_campaign=txt): Questa sezione illustra alcuni comandi comuni della CLI di Solana per aiutarti a iniziare.
- [Nozioni di base sulla CLI di Surfpool](https://solana.com/docs/it/intro/installation/surfpool-cli-basics?utm_source=llms&utm_medium=ai&utm_campaign=txt): Impara i comandi essenziali della CLI di Surfpool per lo sviluppo locale su Solana, incluso l'avvio di un validator e l'utilizzo di Surfpool Studio.
...
- [Programmi](https://solana.com/docs/it/core/programs?utm_source=llms&utm_medium=ai&utm_campaign=txt): Scopri i programmi Solana (smart contract) e come svilupparli utilizzando Rust o il framework Anchor. Comprendi il deployment, gli aggiornamenti e la verifica dei programmi sulla rete Solana.
...
- [Proprietario immutabile](https://solana.com/docs/it/tokens/extensions/immutable-owner?utm_source=llms&utm_medium=ai&utm_campaign=txt): Scopri come abilitare l'estensione ImmutableOwner.
- [Python SDK](https://solana.com/docs/it/clients/community/python?utm_source=llms&utm_medium=ai&utm_campaign=txt): Scopri come interagire con Solana utilizzando il Python SDK (michaelhly/solana-py).
- [Revoca del delegato](https://solana.com/docs/it/tokens/basics/revoke-delegate?utm_source=llms&utm_medium=ai&utm_campaign=txt): Scopri come revocare il delegato di un token account.
...
- [Rust SDK](https://solana.com/docs/it/clients/official/rust?utm_source=llms&utm_medium=ai&utm_campaign=txt): Crate Rust ufficiali per sviluppare su Solana.
...
- [SDK Go](https://solana.com/docs/it/clients/community/go?utm_source=llms&utm_medium=ai&utm_campaign=txt): Scopri come interagire con Solana utilizzando l'SDK Go (gagliardetto/solana-go).
...
- [SDK per gaming su Solana](https://solana.com/docs/it/clients/community/game-sdks?utm_source=llms&utm_medium=ai&utm_campaign=txt): Un elenco di SDK per gaming su Solana per iniziare a creare il tuo primo gioco su Solana
- [Sblocca account](https://solana.com/docs/it/tokens/basics/thaw-account?utm_source=llms&utm_medium=ai&utm_campaign=txt): Scopri come sbloccare un token account congelato.
...
- [Stato predefinito](https://solana.com/docs/it/tokens/extensions/default-state?utm_source=llms&utm_medium=ai&utm_campaign=txt): Scopri come abilitare DefaultAccountStateExtension.
- [Struttura del programma](https://solana.com/docs/it/programs/rust/program-structure?utm_source=llms&utm_medium=ai&utm_campaign=txt): Impara come strutturare i programmi Solana in Rust, inclusi entrypoint, gestione dello stato, gestione delle istruzioni e testing.
- [Strutture di dati come JSON](https://solana.com/docs/it/rpc/json-structures?utm_source=llms&utm_medium=ai&utm_campaign=txt)
- [Sync Native](https://solana.com/docs/it/tokens/basics/sync-native?utm_source=llms&utm_medium=ai&utm_campaign=txt): Impara come convertire SOL nativo in wrapped SOL.
...
- [Token con interessi](https://solana.com/docs/it/tokens/extensions/interest-bearing-tokens?utm_source=llms&utm_medium=ai&utm_campaign=txt): Scopri come abilitare l'InterestBearingMintExtension.
- [Token non trasferibili](https://solana.com/docs/it/tokens/extensions/non-transferrable-tokens?utm_source=llms&utm_medium=ai&utm_campaign=txt): Impara come abilitare l'InitializeNonTransferableMint.
...
- [Transazioni](https://solana.com/docs/it/core/transactions?utm_source=llms&utm_medium=ai&utm_campaign=txt): Scopri le transazioni di Solana—i blocchi fondamentali per interagire con la blockchain Solana. Comprendi la struttura delle transazioni e la composizione delle istruzioni con esempi pratici.
- [Trasferimento con memo](https://solana.com/docs/it/tokens/extensions/memo-transfer?utm_source=llms&utm_medium=ai&utm_campaign=txt): Impara come abilitare MemoTransferExtension.
...
- [Typescript SDK](https://solana.com/docs/it/clients/official/javascript?utm_source=llms&utm_medium=ai&utm_campaign=txt): Scopri come interagire con Solana utilizzando le librerie client JavaScript/TypeScript.
- [Verifica dei programmi](https://solana.com/docs/it/programs/verified-builds?utm_source=llms&utm_medium=ai&utm_campaign=txt): Le build verificate sono un modo per collegare il tuo programma al suo codice sorgente e permettere a tutti di verificare in modo indipendente che il programma sia stato effettivamente costruito dal codice sorgente fornito.
...
- [@solana/client](https://solana.com/docs/ja/frontend/client?utm_source=llms&utm_medium=ai&utm_campaign=txt): ヘッドレスSolanaクライアントランタイムで軽量なSolanaフロントエンドを構築します。
- [@solana/react-hooks](https://solana.com/docs/ja/frontend/react-hooks?utm_source=llms&utm_medium=ai&utm_campaign=txt): すぐに使えるフックでReactアプリ全体に@solana/clientの状態を共有します。
- [@solana/web3-compat](https://solana.com/docs/ja/frontend/web3-compat?utm_source=llms&utm_medium=ai&utm_campaign=txt): レガシーの@solana/web3.jsコードをKit primitivesで実行できるドロップイン互換性レイヤー。
- [Anchor CLIの基本](https://solana.com/docs/ja/intro/installation/anchor-cli-basics?utm_source=llms&utm_medium=ai&utm_campaign=txt): このセクションでは、Anchor CLIの一般的なコマンドについて説明します。
- [CPI ガード](https://solana.com/docs/ja/tokens/extensions/cpi-guard?utm_source=llms&utm_medium=ai&utm_campaign=txt): CpiGuardExtensionの有効化方法について学びます。
...
- [Cross Program Invocation](https://solana.com/docs/ja/core/cpi?utm_source=llms&utm_medium=ai&utm_campaign=txt): Solanaのクロスプログラム呼び出し（CPI）について学びましょう — プログラムが他のプログラムのinstructionsを呼び出す方法、PDA署名者の扱い方、そしてSolanaネットワーク全体での機能の組み合わせ方について。
...
- [Go SDK](https://solana.com/docs/ja/clients/community/go?utm_source=llms&utm_medium=ai&utm_campaign=txt): Go SDK（gagliardetto/solana-go）を使用してSolanaとやり取りする方法を学びましょう。
...
- [Java SDK](https://solana.com/docs/ja/clients/community/java?utm_source=llms&utm_medium=ai&utm_campaign=txt): Java SDK（sava-software/sava）を使用してSolanaとやり取りする方法を学びましょう。
- [Mollusk](https://solana.com/docs/ja/programs/testing/mollusk?utm_source=llms&utm_medium=ai&utm_campaign=txt): Molluskを使用したSolanaプログラムのテストに関する包括的ガイド
- [Next.js + Solana React Hooks](https://solana.com/docs/ja/frontend/nextjs-solana?utm_source=llms&utm_medium=ai&utm_campaign=txt): @solana/clientと@solana/react-hooksを使用してNext.jsでSolanaウォレット統合を設定し、SOL転送を送信します。
- [Next.js - Solana Kit](https://solana.com/docs/ja/frontend/kit?utm_source=llms&utm_medium=ai&utm_campaign=txt): Next.jsでSolana Kitを使用してSolanaウォレット連携を設定します。
...
- [Python SDK](https://solana.com/docs/ja/clients/community/python?utm_source=llms&utm_medium=ai&utm_campaign=txt): Python SDK（michaelhly/solana-py）を使用してSolanaとやり取りする方法を学びましょう。
- [RPCエンドポイント](https://solana.com/docs/ja/references/clusters?utm_source=llms&utm_medium=ai&utm_campaign=txt): Solanaのネットワーククラスター（Devnet、Testnet、Mainnet）、パブリックRPCエンドポイント、レート制限、ユースケースについて学びます。開発、テスト、本番環境向けに異なるSolanaネットワークへの接続方法を学びます。
...
- [Rust SDK](https://solana.com/docs/ja/clients/official/rust?utm_source=llms&utm_medium=ai&utm_campaign=txt): Solana上で構築するための公式Rustクレート。
...
- [Solana CLIの基本](https://solana.com/docs/ja/intro/installation/solana-cli-basics?utm_source=llms&utm_medium=ai&utm_campaign=txt): このセクションでは、Solana CLIを使い始めるための一般的なコマンドについて説明します。
...
- [Solana ゲーミングSDK](https://solana.com/docs/ja/clients/community/game-sdks?utm_source=llms&utm_medium=ai&utm_campaign=txt): 初めてのSolanaゲーム作成を始めるためのSolana ゲーミングSDKのリスト
...
- [Surfpool CLI の基本](https://solana.com/docs/ja/intro/installation/surfpool-cli-basics?utm_source=llms&utm_medium=ai&utm_campaign=txt): validator の起動や Surfpool Studio の使用など、ローカル Solana 開発に必要な Surfpool CLI の基本コマンドを学びましょう。
...
- [Typescript SDK](https://solana.com/docs/ja/clients/official/javascript?utm_source=llms&utm_medium=ai&utm_campaign=txt): JavaScript/TypeScriptクライアントライブラリを使用してSolanaとやり取りする方法を学びましょう。
...
- [instructions](https://solana.com/docs/ja/core/instructions?utm_source=llms&utm_medium=ai&utm_campaign=txt): Solana instructionsについて学びましょう—Solanaブロックチェーンとやり取りするための基本的な構成要素です。実践的な例を通じてinstruction構成を理解しましょう。
...
- [アカウント](https://solana.com/docs/ja/core/accounts?utm_source=llms&utm_medium=ai&utm_campaign=txt): Solanaのアカウントモデルについて学び、アカウントがデータとプログラムを格納する方法、rentのメカニズム、アカウントの所有権、プログラムとデータアカウントの関係を理解しましょう。Solanaのキーバリューストレージシステムの中核概念を把握しましょう。
- [アカウントのフリーズ](https://solana.com/docs/ja/tokens/basics/freeze-account?utm_source=llms&utm_medium=ai&utm_campaign=txt): トークンアカウントをフリーズする方法を学びましょう。
- [アカウントの解凍](https://solana.com/docs/ja/tokens/basics/thaw-account?utm_source=llms&utm_medium=ai&utm_campaign=txt): 凍結されたトークンアカウントを解凍する方法を学びましょう。
- [イミュータブルオーナー](https://solana.com/docs/ja/tokens/extensions/immutable-owner?utm_source=llms&utm_medium=ai&utm_campaign=txt): ImmutableOwner拡張機能の有効化方法について学びます。
- [クイックインストール](https://solana.com/docs/ja/intro/installation/?utm_source=llms&utm_medium=ai&utm_campaign=txt): 1つのコマンドで、ローカルのSolana開発環境をセットアップするクイックインストールガイド。Windows（WSL）、Linux、Macで、Rust、Solana CLI、Anchorフレームワークをインストールします。
...
- [クライアントの生成](https://solana.com/docs/ja/programs/codama/clients?utm_source=llms&utm_medium=ai&utm_campaign=txt): Codama CLIを使用してSolanaプログラム用のクライアントを生成するための完全ガイド。
- [コアコンセプト](https://solana.com/docs/ja/core/?utm_source=llms&utm_medium=ai&utm_campaign=txt): アカウント、トランザクション、プログラム、プログラム派生アドレス、クロスプログラム呼び出し、およびSolanaでのトークンの仕組みなど、Solanaブロックチェーンの重要な概念を学びましょう。
...
- [デフォルト状態](https://solana.com/docs/ja/tokens/extensions/default-state?utm_source=llms&utm_medium=ai&utm_campaign=txt): DefaultAccountStateExtensionの有効化方法を学びます。
- [トランザクション](https://solana.com/docs/ja/core/transactions?utm_source=llms&utm_medium=ai&utm_campaign=txt): Solanaトランザクションについて学びましょう—Solanaブロックチェーンと対話するための基本的な構成要素です。実用的な例を通じてトランザクション構造とinstruction構成を理解しましょう。
- [トランザクション手数料](https://solana.com/docs/ja/core/fees?utm_source=llms&utm_medium=ai&utm_campaign=txt): Solanaのトランザクション手数料について学びましょう。基本手数料と優先手数料、それぞれの適用方法、およびトランザクションでのコンピュートユニット管理のベストプラクティスを解説します。
...
- [トークンを焼却する](https://solana.com/docs/ja/tokens/basics/burn-tokens?utm_source=llms&utm_medium=ai&utm_campaign=txt): トークンの焼却方法を学びましょう。
...
- [トークンアカウントを閉じる](https://solana.com/docs/ja/tokens/basics/close-account?utm_source=llms&utm_medium=ai&utm_campaign=txt): トークンアカウントの閉じ方を学びましょう。
- [トークングループとメンバー](https://solana.com/docs/ja/tokens/extensions/group-member?utm_source=llms&utm_medium=ai&utm_campaign=txt): GroupPointerExtensionとGroupMemberPointerExtensionを有効にする方法を学びましょう。
...
- [トークンミントの作成](https://solana.com/docs/ja/tokens/basics/create-mint?utm_source=llms&utm_medium=ai&utm_campaign=txt): SPLトークンミントの作成方法を学びましょう。
- [ネイティブの同期](https://solana.com/docs/ja/tokens/basics/sync-native?utm_source=llms&utm_medium=ai&utm_campaign=txt): ネイティブSOLをラップドSOLに変換する方法を学びましょう。
...
- [フロントエンド](https://solana.com/docs/ja/frontend/?utm_source=llms&utm_medium=ai&utm_campaign=txt): Solanaプログラムのインターフェース構築について学びます。
- [プログラム](https://solana.com/docs/ja/core/programs?utm_source=llms&utm_medium=ai&utm_campaign=txt): Solanaプログラム（スマートコントラクト）について学び、RustまたはAnchorフレームワークを使用して開発する方法を理解しましょう。Solanaネットワーク上でのプログラムのデプロイ、アップグレード、検証について理解します。
- [プログラムのデプロイ](https://solana.com/docs/ja/programs/deploying?utm_source=llms&utm_medium=ai&utm_campaign=txt): Solana CLIを使用したSolanaプログラムの構築、デプロイ、管理の完全ガイド。
- [プログラムの検証](https://solana.com/docs/ja/programs/verified-builds?utm_source=llms&utm_medium=ai&utm_campaign=txt): 検証済みビルドは、プログラムをそのソースコードにリンクし、提供されたソースコードからプログラムが確かに構築されたことを誰もが独自に検証できるようにする方法です。
- [プログラムをデプロイする](https://solana.com/docs/ja/intro/quick-start/deploying-programs?utm_source=llms&utm_medium=ai&utm_campaign=txt): Anchorフレームワークとソラナプレイグラウンドを使用して、最初のソラナプログラムを構築、デプロイ、テストする方法を学びましょう。この初心者向けガイドでは、シンプルなプログラムの作成、devnetへのデプロイ、テストの実行、プログラムの終了までの手順を説明します。
...
- [プログラム派生アドレス](https://solana.com/docs/ja/core/pda?utm_source=llms&utm_medium=ai&utm_campaign=txt): Solanaのプログラム派生アドレス（PDA）について学びましょう — 安全なプログラム署名を可能にする決定論的なアカウントアドレスです。PDAの導出、正規バンプ、およびPDAアカウントの作成方法を理解しましょう。
- [ミントのクローズ](https://solana.com/docs/ja/tokens/extensions/close-mint?utm_source=llms&utm_medium=ai&utm_campaign=txt): MintCloseAuthority拡張機能を有効にする方法を学びます。
- [メタデータとメタデータポインタ拡張機能](https://solana.com/docs/ja/tokens/extensions/metadata?utm_source=llms&utm_medium=ai&utm_campaign=txt): MetadataPointerExtensionとTokenMetadata拡張機能の有効化方法を学びましょう。
- [メモ転送](https://solana.com/docs/ja/tokens/extensions/memo-transfer?utm_source=llms&utm_medium=ai&utm_campaign=txt): MemoTransferExtensionを有効にする方法を学びます。
- [依存関係のインストール](https://solana.com/docs/ja/intro/installation/dependencies?utm_source=llms&utm_medium=ai&utm_campaign=txt): ローカルのSolana開発環境をセットアップするためのガイド。Windows（WSL）、Linux、およびMacでRust、Solana CLI、およびAnchorフレームワークをインストールする方法を学びましょう。
...
- [利子付きトークン](https://solana.com/docs/ja/tokens/extensions/interest-bearing-tokens?utm_source=llms&utm_medium=ai&utm_campaign=txt): InterestBearingMintExtensionの有効化方法について学びます。
- [制限事項](https://solana.com/docs/ja/programs/limitations?utm_source=llms&utm_medium=ai&utm_campaign=txt)
- [委任の取り消し](https://solana.com/docs/ja/tokens/basics/revoke-delegate?utm_source=llms&utm_medium=ai&utm_campaign=txt): トークンアカウントの委任を取り消す方法を学びましょう。
- [委任の承認](https://solana.com/docs/ja/tokens/basics/approve-delegate?utm_source=llms&utm_medium=ai&utm_campaign=txt): トークンアカウントの委任を承認する方法を学びましょう。
...
- [権限の設定](https://solana.com/docs/ja/tokens/basics/set-authority?utm_source=llms&utm_medium=ai&utm_campaign=txt): ミントアカウントやトークンアカウントの権限を設定する方法を学びましょう。
- [永久的な委任者](https://solana.com/docs/ja/tokens/extensions/permanent-delegate?utm_source=llms&utm_medium=ai&utm_campaign=txt): InitializePermanentDelegate拡張機能の実装方法を学びます。
...
- [譲渡不可トークン](https://solana.com/docs/ja/tokens/extensions/non-transferrable-tokens?utm_source=llms&utm_medium=ai&utm_campaign=txt): InitializeNonTransferableMintの有効化方法を学びます。
- [転送手数料](https://solana.com/docs/ja/tokens/extensions/transfer-fees?utm_source=llms&utm_medium=ai&utm_campaign=txt): TransferFeeExtensionの実装方法を学びます。

## Docs - Ko

- [@solana/client](https://solana.com/docs/ko/frontend/client?utm_source=llms&utm_medium=ai&utm_campaign=txt): 헤드리스 Solana 클라이언트 런타임으로 가벼운 Solana 프론트엔드를 구축하세요.
- [@solana/react-hooks](https://solana.com/docs/ko/frontend/react-hooks?utm_source=llms&utm_medium=ai&utm_campaign=txt): 즉시 사용 가능한 훅으로 React 앱 전체에서 @solana/client 상태를 공유하세요.
- [@solana/web3-compat](https://solana.com/docs/ko/frontend/web3-compat?utm_source=llms&utm_medium=ai&utm_campaign=txt): 레거시 @solana/web3.js 코드가 Kit 프리미티브에서 실행될 수 있도록 하는 드롭인 호환성 레이어입니다.
- [Anchor CLI 기초](https://solana.com/docs/ko/intro/installation/anchor-cli-basics?utm_source=llms&utm_medium=ai&utm_campaign=txt): 이 섹션에서는 시작하는 데 도움이 되는 일반적인 Anchor CLI 명령어를 안내합니다.
- [CPI 가드](https://solana.com/docs/ko/tokens/extensions/cpi-guard?utm_source=llms&utm_medium=ai&utm_campaign=txt): CpiGuardExtension을 활성화하는 방법을 알아보세요.
- [Cross Program Invocation](https://solana.com/docs/ko/core/cpi?utm_source=llms&utm_medium=ai&utm_campaign=txt): 솔라나에서의 Cross Program Invocation(CPI)에 대해 알아보세요 — 프로그램이 다른 프로그램의 명령어를 호출하고, PDA 서명자를 처리하며, 솔라나 네트워크 전체에서 기능을 구성하는 방법을 배웁니다.
...
- [Go SDK](https://solana.com/docs/ko/clients/community/go?utm_source=llms&utm_medium=ai&utm_campaign=txt): Go SDK(gagliardetto/solana-go)를 사용하여 Solana와 상호작용하는 방법을 알아보세요.
...
- [Java SDK](https://solana.com/docs/ko/clients/community/java?utm_source=llms&utm_medium=ai&utm_campaign=txt): Java SDK(sava-software/sava)를 사용하여 Solana와 상호작용하는 방법을 알아보세요.
- [Mollusk](https://solana.com/docs/ko/programs/testing/mollusk?utm_source=llms&utm_medium=ai&utm_campaign=txt): Mollusk를 사용한 Solana 프로그램 테스팅 종합 가이드
- [Next.js + Solana React Hooks](https://solana.com/docs/ko/frontend/nextjs-solana?utm_source=llms&utm_medium=ai&utm_campaign=txt): @solana/client와 @solana/react-hooks를 사용하여 Next.js에서 Solana 지갑  통합을 설정하고 SOL 전송을 수행하세요.
- [Next.js - Solana Kit](https://solana.com/docs/ko/frontend/kit?utm_source=llms&utm_medium=ai&utm_campaign=txt): Solana Kit을 사용하여 Next.js에서 Solana 지갑 통합을 설정하세요.
...
- [Python SDK](https://solana.com/docs/ko/clients/community/python?utm_source=llms&utm_medium=ai&utm_campaign=txt): Python SDK(michaelhly/solana-py)를 사용하여 Solana와 상호작용하는 방법을 알아보세요.
- [RPC 엔드포인트](https://solana.com/docs/ko/references/clusters?utm_source=llms&utm_medium=ai&utm_campaign=txt): Solana의 네트워크 클러스터(Devnet, Testnet, Mainnet)와 공개 RPC 엔드포인트, 속도 제한 및 사용 사례에 대해 알아보세요. 개발, 테스트 및 프로덕션을 위해 다양한 Solana 네트워크에 연결하는 방법을 배워보세요.
...
- [Rust SDK](https://solana.com/docs/ko/clients/official/rust?utm_source=llms&utm_medium=ai&utm_campaign=txt): Solana에서 개발하기 위한 공식 Rust 크레이트.
...
- [Solana CLI 기초](https://solana.com/docs/ko/intro/installation/solana-cli-basics?utm_source=llms&utm_medium=ai&utm_campaign=txt): 이 섹션에서는 Solana CLI를 시작하기 위한 몇 가지 일반적인 명령어를 안내합니다.
- [Solana RPC 메소드](https://solana.com/docs/ko/rpc/?utm_source=llms&utm_medium=ai&utm_campaign=txt)
- [Solana 게임 SDK](https://solana.com/docs/ko/clients/community/game-sdks?utm_source=llms&utm_medium=ai&utm_campaign=txt): 첫 Solana 게임 개발을 시작하는 데 도움이 되는 Solana 게임 SDK 목록
...
- [Surfpool CLI 기본 사항](https://solana.com/docs/ko/intro/installation/surfpool-cli-basics?utm_source=llms&utm_medium=ai&utm_campaign=txt): 로컬 Solana 개발을 위한 필수 Surfpool CLI 명령어를 배우고, validator 시작 및 Surfpool Studio 사용 방법을 알아보세요.
...
- [Typescript SDK](https://solana.com/docs/ko/clients/official/javascript?utm_source=llms&utm_medium=ai&utm_campaign=txt): JavaScript/TypeScript 클라이언트 라이브러리를 사용하여 Solana와 상호작용하는 방법을 알아보세요.
...
- [계정](https://solana.com/docs/ko/core/accounts?utm_source=llms&utm_medium=ai&utm_campaign=txt): Solana의 계정 모델에 대해 알아보세요. 계정이 데이터와 프로그램을 저장하는 방법, 렌트 메커니즘, 계정 소유권, 그리고 프로그램과 데이터 계정 간의 관계를 포함합니다. Solana의 키-값 저장 시스템의 핵심 개념을 이해해 보세요.
- [계정 동결](https://solana.com/docs/ko/tokens/basics/freeze-account?utm_source=llms&utm_medium=ai&utm_campaign=txt): 토큰 계정을 동결하는 방법을 알아보세요.
- [계정 해제](https://solana.com/docs/ko/tokens/basics/thaw-account?utm_source=llms&utm_medium=ai&utm_campaign=txt): 동결된 토큰 계정을 해제하는 방법을 알아보세요.
- [권한 설정](https://solana.com/docs/ko/tokens/basics/set-authority?utm_source=llms&utm_medium=ai&utm_campaign=txt): 민트 또는 토큰 계정에 대한 권한을 설정하는 방법을 알아보세요.
...
- [기본 상태](https://solana.com/docs/ko/tokens/extensions/default-state?utm_source=llms&utm_medium=ai&utm_campaign=txt): DefaultAccountStateExtension을 활성화하는 방법을 알아보세요.
- [네이티브 동기화](https://solana.com/docs/ko/tokens/basics/sync-native?utm_source=llms&utm_medium=ai&utm_campaign=txt): 네이티브 SOL을 래핑된 SOL로 변환하는 방법을 알아보세요.
...
- [네트워크에서 읽기](https://solana.com/docs/ko/intro/quick-start/reading-from-network?utm_source=llms&utm_medium=ai&utm_campaign=txt): Solana 블록체인 네트워크에서 데이터를 읽는 방법을 알아보세요. 이 가이드는 JavaScript/TypeScript를 사용하여 지갑 계정, 프로그램 계정 및 토큰 민트 계정을 가져오는 방법을 다루며, Solana web3.js 라이브러리를 사용한 실용적인 예제를 제공합니다.
...
- [대리인 승인하기](https://solana.com/docs/ko/tokens/basics/approve-delegate?utm_source=llms&utm_medium=ai&utm_campaign=txt): 토큰 계정에 대한 대리인을 승인하는 방법을 알아보세요.
- [메모 전송](https://solana.com/docs/ko/tokens/extensions/memo-transfer?utm_source=llms&utm_medium=ai&utm_campaign=txt): MemoTransferExtension을 활성화하는 방법을 알아보세요.
- [메타데이터 및 메타데이터 포인터 확장](https://solana.com/docs/ko/tokens/extensions/metadata?utm_source=llms&utm_medium=ai&utm_campaign=txt): MetadataPointerExtension과 TokenMetadata 확장을 활성화하는 방법을 알아보세요.
- [명령어](https://solana.com/docs/ko/core/instructions?utm_source=llms&utm_medium=ai&utm_campaign=txt): 솔라나 블록체인과 상호작용하기 위한 기본 구성 요소인 솔라나 명령어에 대해 알아보세요. 실용적인 예제를 통해 명령어 구성을 이해하세요.
- [민트 닫기](https://solana.com/docs/ko/tokens/extensions/close-mint?utm_source=llms&utm_medium=ai&utm_campaign=txt): MintCloseAuthority 확장 기능을 활성화하는 방법을 알아보세요.
- [변경 불가능한 소유자](https://solana.com/docs/ko/tokens/extensions/immutable-owner?utm_source=llms&utm_medium=ai&utm_campaign=txt): ImmutableOwner 확장 기능을 활성화하는 방법을 알아보세요.
...
- [빠른 설치](https://solana.com/docs/ko/intro/installation/?utm_source=llms&utm_medium=ai&utm_campaign=txt): 단일 명령어로 로컬 Solana 개발 환경을 설정할 수 있는 빠른 설치 가이드입니다. Windows(WSL), Linux 및 Mac에서 Rust, Solana CLI 및 Anchor 프레임워크를 설치하세요.
...
- [양도 불가능 토큰](https://solana.com/docs/ko/tokens/extensions/non-transferrable-tokens?utm_source=llms&utm_medium=ai&utm_campaign=txt): InitializeNonTransferableMint를 활성화하는 방법을 알아보세요.
...
- [영구 위임자](https://solana.com/docs/ko/tokens/extensions/permanent-delegate?utm_source=llms&utm_medium=ai&utm_campaign=txt): InitializePermanentDelegate 확장을 구현하는 방법을 알아보세요.
...
- [위임자 취소하기](https://solana.com/docs/ko/tokens/basics/revoke-delegate?utm_source=llms&utm_medium=ai&utm_campaign=txt): 토큰 계정 위임자를 취소하는 방법을 알아보세요.
- [의존성 설치하기](https://solana.com/docs/ko/intro/installation/dependencies?utm_source=llms&utm_medium=ai&utm_campaign=txt): 로컬 Solana 개발 환경 설정 가이드입니다. Windows(WSL), Linux 및 Mac에서 Rust, Solana CLI 및 Anchor 프레임워크를 설치하는 방법을 알아보세요.
- [이자 발생 토큰](https://solana.com/docs/ko/tokens/extensions/interest-bearing-tokens?utm_source=llms&utm_medium=ai&utm_campaign=txt): InterestBearingMintExtension을 활성화하는 방법을 알아보세요.
- [전송 수수료](https://solana.com/docs/ko/tokens/extensions/transfer-fees?utm_source=llms&utm_medium=ai&utm_campaign=txt): TransferFeeExtension을 구현하는 방법을 알아보세요.
...
- [클라이언트 생성하기](https://solana.com/docs/ko/programs/codama/clients?utm_source=llms&utm_medium=ai&utm_campaign=txt): Codama CLI를 사용하여 Solana 프로그램용 클라이언트를 생성하는 완전한 가이드입니다.
- [토큰 계정 닫기](https://solana.com/docs/ko/tokens/basics/close-account?utm_source=llms&utm_medium=ai&utm_campaign=txt): 토큰 계정을 닫는 방법을 알아보세요.
...
- [토큰 그룹 및 멤버](https://solana.com/docs/ko/tokens/extensions/group-member?utm_source=llms&utm_medium=ai&utm_campaign=txt): GroupPointerExtension 및 GroupMemberPointerExtension을 활성화하는 방법을 알아보세요.
...
- [토큰 소각하기](https://solana.com/docs/ko/tokens/basics/burn-tokens?utm_source=llms&utm_medium=ai&utm_campaign=txt): 토큰을 소각하는 방법을 알아보세요.
...
- [토큰 전송](https://solana.com/docs/ko/tokens/basics/transfer-tokens?utm_source=llms&utm_medium=ai&utm_campaign=txt): 토큰 계정 간에 토큰을 전송하는 방법을 알아보세요.
...
- [트랜잭션](https://solana.com/docs/ko/core/transactions?utm_source=llms&utm_medium=ai&utm_campaign=txt): 솔라나 블록체인과 상호작용하기 위한 기본 구성 요소인 솔라나 트랜잭션에 대해 알아보세요. 실용적인 예시를 통해 트랜잭션 구조와 명령어 구성을 이해하세요.
- [트랜잭션 수수료](https://solana.com/docs/ko/core/fees?utm_source=llms&utm_medium=ai&utm_campaign=txt): Solana의 트랜잭션 수수료에 대해 알아보세요. 기본 수수료와 우선순위 수수료, 각각의 적용 방법, 그리고 트랜잭션에서 컴퓨트 유닛을 관리하는 모범 사례를 포함합니다.
- [프로그램](https://solana.com/docs/ko/core/programs?utm_source=llms&utm_medium=ai&utm_campaign=txt): Solana 프로그램(스마트 컨트랙트)에 대해 알아보고 Rust 또는 Anchor 프레임워크를 사용하여 개발하는 방법을 배우세요. Solana 네트워크에서 프로그램 배포, 업그레이드 및 검증에 대해 이해하세요.
- [프로그램 검증하기](https://solana.com/docs/ko/programs/verified-builds?utm_source=llms&utm_medium=ai&utm_campaign=txt): 검증된 빌드는 프로그램을 소스 코드에 연결하고 모든 사람이 제공된 소스 코드에서 실제로 프로그램이 빌드되었는지 독립적으로 확인할 수 있게 해주는 방법입니다.
...
- [프로그램 배포하기](https://solana.com/docs/ko/programs/deploying?utm_source=llms&utm_medium=ai&utm_campaign=txt): Solana CLI를 사용하여 Solana 프로그램을 구축, 배포 및 관리하는 완전한 가이드입니다.
- [프로그램 배포하기](https://solana.com/docs/ko/intro/quick-start/deploying-programs?utm_source=llms&utm_medium=ai&utm_campaign=txt): Anchor 프레임워크와 Solana Playground를 사용하여 첫 번째 Solana 프로그램을 빌드, 배포 및 테스트하는 방법을 배워보세요. 이 초보자 친화적인 가이드는 간단한 프로그램 생성, devnet에 배포, 테스트 실행 및 프로그램 종료 과정을 안내합니다.
...
- [프로그램 파생 주소](https://solana.com/docs/ko/core/pda?utm_source=llms&utm_medium=ai&utm_campaign=txt): 솔라나의 프로그램 파생 주소(PDA)에 대해 알아보세요 — 안전한 프로그램 서명을 가능하게 하는 결정론적 계정 주소입니다. PDA 파생, 표준 범프, PDA 계정 생성 방법을 이해하세요.
- [프론트엔드](https://solana.com/docs/ko/frontend/?utm_source=llms&utm_medium=ai&utm_campaign=txt): Solana 프로그램을 위한 인터페이스 구축에 대해 알아보세요.
- [핵심 개념](https://solana.com/docs/ko/core/?utm_source=llms&utm_medium=ai&utm_campaign=txt): 계정, 트랜잭션, 프로그램, 프로그램 파생 주소, 크로스 프로그램 호출 및 Solana에서 토큰이 작동하는 방식을 포함한 필수 Solana 블록체인 개념을 알아보세요.
...
- [@solana/client](https://solana.com/docs/nl/frontend/client?utm_source=llms&utm_medium=ai&utm_campaign=txt): Bouw slanke Solana frontends met de headless Solana client runtime.
- [@solana/react-hooks](https://solana.com/docs/nl/frontend/react-hooks?utm_source=llms&utm_medium=ai&utm_campaign=txt): Deel @solana/client state door je React-app met kant-en-klare hooks.
- [@solana/web3-compat](https://solana.com/docs/nl/frontend/web3-compat?utm_source=llms&utm_medium=ai&utm_campaign=txt): Drop-in compatibiliteitslaag waarmee legacy @solana/web3.js code kan draaien op Kit primitives.
- [Account bevriezen](https://solana.com/docs/nl/tokens/basics/freeze-account?utm_source=llms&utm_medium=ai&utm_campaign=txt): Leer hoe je token accounts kunt bevriezen.
- [Account ontdooien](https://solana.com/docs/nl/tokens/basics/thaw-account?utm_source=llms&utm_medium=ai&utm_campaign=txt): Leer hoe je een bevroren token account kunt ontdooien.
...
- [Afhankelijkheden installeren](https://solana.com/docs/nl/intro/installation/dependencies?utm_source=llms&utm_medium=ai&utm_campaign=txt): Een handleiding voor het opzetten van je lokale Solana-ontwikkelomgeving. Leer hoe je Rust, de Solana CLI en het Anchor Framework installeert op Windows (WSL), Linux en Mac.
- [Anchor CLI Basisprincipes](https://solana.com/docs/nl/intro/installation/anchor-cli-basics?utm_source=llms&utm_medium=ai&utm_campaign=txt): Dit gedeelte behandelt enkele veelgebruikte Anchor CLI-commando's om je op weg te helpen.
- [Autoriteit instellen](https://solana.com/docs/nl/tokens/basics/set-authority?utm_source=llms&utm_medium=ai&utm_campaign=txt): Leer hoe je autoriteit instelt voor mint accounts of token accounts.
- [Beperkingen](https://solana.com/docs/nl/programs/limitations?utm_source=llms&utm_medium=ai&utm_campaign=txt)
- [CPI Guard](https://solana.com/docs/nl/tokens/extensions/cpi-guard?utm_source=llms&utm_medium=ai&utm_campaign=txt): Leer hoe je de CpiGuardExtension kunt inschakelen.
- [Clients genereren](https://solana.com/docs/nl/programs/codama/clients?utm_source=llms&utm_medium=ai&utm_campaign=txt): Complete gids voor het genereren van clients voor Solana-programma's met behulp van de Codama CLI.
...
- [Delegate goedkeuren](https://solana.com/docs/nl/tokens/basics/approve-delegate?utm_source=llms&utm_medium=ai&utm_campaign=txt): Leer hoe je delegates kunt goedkeuren voor een token account.
- [Delegate intrekken](https://solana.com/docs/nl/tokens/basics/revoke-delegate?utm_source=llms&utm_medium=ai&utm_campaign=txt): Leer hoe je de token account delegate kunt intrekken.
...
- [Een programma implementeren](https://solana.com/docs/nl/intro/quick-start/deploying-programs?utm_source=llms&utm_medium=ai&utm_campaign=txt): Leer hoe je je eerste Solana-programma bouwt, implementeert en test met behulp van het Anchor-framework en Solana Playground. Deze gebruiksvriendelijke gids behandelt het maken van een eenvoudig programma, het implementeren op devnet, het uitvoeren van tests en het afsluiten van het programma.
...
- [Een token account aanmaken](https://solana.com/docs/nl/tokens/basics/create-token-account?utm_source=llms&utm_medium=ai&utm_campaign=txt): Leer hoe je SPL Token Accounts kunt aanmaken.
...
- [Frontend](https://solana.com/docs/nl/frontend/?utm_source=llms&utm_medium=ai&utm_campaign=txt): Leer over het bouwen van interfaces voor Solana-programma's.
...
- [Go SDK](https://solana.com/docs/nl/clients/community/go?utm_source=llms&utm_medium=ai&utm_campaign=txt): Leer hoe je met Solana kunt werken via de Go SDK (gagliardetto/solana-go).
- [HTTP-methoden](https://solana.com/docs/nl/rpc/http/?utm_source=llms&utm_medium=ai&utm_campaign=txt)
- [Immutable Owner](https://solana.com/docs/nl/tokens/extensions/immutable-owner?utm_source=llms&utm_medium=ai&utm_campaign=txt): Leer hoe je de ImmutableOwner Extension kunt inschakelen.
- [Instructies](https://solana.com/docs/nl/core/instructions?utm_source=llms&utm_medium=ai&utm_campaign=txt): Leer over Solana instructies—de fundamentele bouwstenen voor interactie met de Solana blockchain. Begrijp instructiesamenstelling met praktische voorbeelden.
...
- [Java SDK](https://solana.com/docs/nl/clients/community/java?utm_source=llms&utm_medium=ai&utm_campaign=txt): Leer hoe je met Solana kunt werken via de Java SDK (sava-software/sava).
- [Kernconcepten](https://solana.com/docs/nl/core/?utm_source=llms&utm_medium=ai&utm_campaign=txt): Leer essentiële Solana blockchain-concepten waaronder accounts, transacties, programma's, program-derived addresses, cross program invocations, en hoe tokens werken op Solana.
- [Lezen van het netwerk](https://solana.com/docs/nl/intro/quick-start/reading-from-network?utm_source=llms&utm_medium=ai&utm_campaign=txt): Leer hoe je gegevens kunt lezen van het Solana blockchain-netwerk. Deze gids behandelt het ophalen van wallet-accounts, programma-accounts en token mint-accounts met JavaScript/TypeScript, met praktische voorbeelden die gebruikmaken van de Solana web3.js bibliotheek.
...
- [Memo-overdracht](https://solana.com/docs/nl/tokens/extensions/memo-transfer?utm_source=llms&utm_medium=ai&utm_campaign=txt): Leer hoe je de MemoTransferExtension kunt inschakelen.
- [Metadata & Metadata Pointer Extensions](https://solana.com/docs/nl/tokens/extensions/metadata?utm_source=llms&utm_medium=ai&utm_campaign=txt): Leer hoe je de MetadataPointerExtension en TokenMetadata extensie kunt inschakelen.
- [Mint sluiten](https://solana.com/docs/nl/tokens/extensions/close-mint?utm_source=llms&utm_medium=ai&utm_campaign=txt): Leer hoe je de MintCloseAuthority-extensie inschakelt.
- [Mollusk](https://solana.com/docs/nl/programs/testing/mollusk?utm_source=llms&utm_medium=ai&utm_campaign=txt): Uitgebreide gids voor het testen van Solana-programma's met Mollusk
- [Next.js + Solana React Hooks](https://solana.com/docs/nl/frontend/nextjs-solana?utm_source=llms&utm_medium=ai&utm_campaign=txt): Stel Solana wallet-integratie in Next.js in met @solana/client en @solana/react-hooks om SOL-overdrachten te verzenden.
- [Next.js - Solana Kit](https://solana.com/docs/nl/frontend/kit?utm_source=llms&utm_medium=ai&utm_campaign=txt): Stel Solana wallet-integratie in Next.js op met Solana Kit.
- [Niet-overdraagbare tokens](https://solana.com/docs/nl/tokens/extensions/non-transferrable-tokens?utm_source=llms&utm_medium=ai&utm_campaign=txt): Leer hoe je de InitializeNonTransferableMint kunt inschakelen.
...
- [Permanente gedelegeerde](https://solana.com/docs/nl/tokens/extensions/permanent-delegate?utm_source=llms&utm_medium=ai&utm_campaign=txt): Leer hoe je de InitializePermanentDelegate extensie implementeert.
- [Programma's](https://solana.com/docs/nl/core/programs?utm_source=llms&utm_medium=ai&utm_campaign=txt): Leer over Solana programma's (smart contracts) en hoe je ze kunt ontwikkelen met Rust of het Anchor framework. Begrijp programma-implementatie, upgrades en verificatie op het Solana-netwerk.
...
- [Programma's verifiëren](https://solana.com/docs/nl/programs/verified-builds?utm_source=llms&utm_medium=ai&utm_campaign=txt): Geverifieerde builds zijn een manier om je programma te koppelen aan de broncode en iedereen in staat te stellen onafhankelijk te verifiëren dat het programma inderdaad is gebouwd op basis van die broncode.
- [Programma-afgeleide adres](https://solana.com/docs/nl/core/pda?utm_source=llms&utm_medium=ai&utm_campaign=txt): Leer over Solana's programma-afgeleide adressen (PDA's) — deterministische accountadressen die veilige programmaondertekening mogelijk maken. Begrijp PDA-afleiding, canonieke bumps en hoe je PDA-accounts kunt aanmaken.
...
- [Python SDK](https://solana.com/docs/nl/clients/community/python?utm_source=llms&utm_medium=ai&utm_campaign=txt): Leer hoe je met Solana kunt werken via de Python SDK (michaelhly/solana-py).
- [RPC-eindpunten](https://solana.com/docs/nl/references/clusters?utm_source=llms&utm_medium=ai&utm_campaign=txt): Leer over Solana's netwerkclusters (Devnet, Testnet en Mainnet), hun publieke RPC-endpoints, rate limits en use cases. Leer hoe je verbinding maakt met verschillende Solana-netwerken voor ontwikkeling, testen en productie.
- [Rentedragende tokens](https://solana.com/docs/nl/tokens/extensions/interest-bearing-tokens?utm_source=llms&utm_medium=ai&utm_campaign=txt): Leer hoe je de InterestBearingMintExtension kunt inschakelen.
...
- [Rust SDK](https://solana.com/docs/nl/clients/official/rust?utm_source=llms&utm_medium=ai&utm_campaign=txt): Officiële Rust crates voor het bouwen op Solana.
...
- [Snelle installatie](https://solana.com/docs/nl/intro/installation/?utm_source=llms&utm_medium=ai&utm_campaign=txt): Een snelle installatiegids waarmee je je lokale Solana-ontwikkelomgeving kunt opzetten met één enkel commando. Installeer Rust, de Solana CLI en Anchor Framework op Windows (WSL), Linux en Mac.
...
- [Solana CLI basisprincipes](https://solana.com/docs/nl/intro/installation/solana-cli-basics?utm_source=llms&utm_medium=ai&utm_campaign=txt): Dit gedeelte behandelt enkele veelgebruikte Solana CLI-commando's om je op weg te helpen.
...
- [Solana Gaming SDKs](https://solana.com/docs/nl/clients/community/game-sdks?utm_source=llms&utm_medium=ai&utm_campaign=txt): Een lijst van Solana Gaming SDKs om je op weg te helpen met het maken van je eerste Solana Game
...
- [Standaardstatus](https://solana.com/docs/nl/tokens/extensions/default-state?utm_source=llms&utm_medium=ai&utm_campaign=txt): Leer hoe je de DefaultAccountStateExtension kunt inschakelen.
- [Surfpool CLI basisprincipes](https://solana.com/docs/nl/intro/installation/surfpool-cli-basics?utm_source=llms&utm_medium=ai&utm_campaign=txt): Leer essentiële Surfpool CLI-commando's voor lokale Solana-ontwikkeling, inclusief het starten van een validator en het gebruik van Surfpool Studio.
- [Sync Native](https://solana.com/docs/nl/tokens/basics/sync-native?utm_source=llms&utm_medium=ai&utm_campaign=txt): Leer hoe je native SOL naar wrapped SOL kunt converteren.
...
- [Token-account sluiten](https://solana.com/docs/nl/tokens/basics/close-account?utm_source=llms&utm_medium=ai&utm_campaign=txt): Leer hoe je token-accounts kunt sluiten.
- [Tokengroepen en leden](https://solana.com/docs/nl/tokens/extensions/group-member?utm_source=llms&utm_medium=ai&utm_campaign=txt): Leer hoe je de GroupPointerExtension en GroupMemberPointerExtension kunt inschakelen.
...
- [Tokens verbranden](https://solana.com/docs/nl/tokens/basics/burn-tokens?utm_source=llms&utm_medium=ai&utm_campaign=txt): Leer hoe je tokens kunt verbranden.
...
- [Transacties](https://solana.com/docs/nl/core/transactions?utm_source=llms&utm_medium=ai&utm_campaign=txt): Leer over Solana-transacties—de fundamentele bouwstenen voor interactie met de Solana-blockchain. Begrijp de transactiestructuur en instructiesamenstelling met praktische voorbeelden.
- [Transferkosten](https://solana.com/docs/nl/tokens/extensions/transfer-fees?utm_source=llms&utm_medium=ai&utm_campaign=txt): Leer hoe je de TransferFeeExtension implementeert.
...
- [Typescript SDK](https://solana.com/docs/nl/clients/official/javascript?utm_source=llms&utm_medium=ai&utm_campaign=txt): Leer hoe je met Solana kunt werken via de JavaScript/TypeScript client bibliotheken.
...
- [@solana/client](https://solana.com/docs/pl/frontend/client?utm_source=llms&utm_medium=ai&utm_campaign=txt): Twórz lekkie frontendowe aplikacje Solana z użyciem bezgłowego runtime'u klienta Solana.
- [@solana/react-hooks](https://solana.com/docs/pl/frontend/react-hooks?utm_source=llms&utm_medium=ai&utm_campaign=txt): Udostępniaj stan @solana/client w całej aplikacji React za pomocą gotowych hooków.
- [@solana/web3-compat](https://solana.com/docs/pl/frontend/web3-compat?utm_source=llms&utm_medium=ai&utm_campaign=txt): Warstwa kompatybilności typu drop-in, która pozwala uruchamiać starszy kod @solana/web3.js na prymitywach Kit.
- [Adres pochodny programu](https://solana.com/docs/pl/core/pda?utm_source=llms&utm_medium=ai&utm_campaign=txt): Dowiedz się więcej o adresach pochodnych programu (PDA) w Solanie — deterministycznych adresach kont, które umożliwiają bezpieczne podpisywanie przez programy. Zrozum, jak działa pochodzenie PDA, kanoniczne przesunięcia i jak tworzyć konta PDA.
...
- [CPI Guard](https://solana.com/docs/pl/tokens/extensions/cpi-guard?utm_source=llms&utm_medium=ai&utm_campaign=txt): Dowiedz się, jak włączyć CpiGuardExtension.
- [Cofnij delegowanie](https://solana.com/docs/pl/tokens/basics/revoke-delegate?utm_source=llms&utm_medium=ai&utm_campaign=txt): Dowiedz się, jak cofnąć delegowanie konta tokenów.
- [Cross Program Invocation](https://solana.com/docs/pl/core/cpi?utm_source=llms&utm_medium=ai&utm_campaign=txt): Dowiedz się więcej o Cross Program Invocation (CPI) na Solanie — jak programy mogą wywoływać instrukcje innych programów, obsługiwać podpisujących PDA i komponować funkcjonalności w sieci Solana.
...
- [Domyślny stan](https://solana.com/docs/pl/tokens/extensions/default-state?utm_source=llms&utm_medium=ai&utm_campaign=txt): Dowiedz się, jak włączyć DefaultAccountStateExtension.
- [FAQ](https://solana.com/docs/pl/programs/faq?utm_source=llms&utm_medium=ai&utm_campaign=txt)
- [Frontend](https://solana.com/docs/pl/frontend/?utm_source=llms&utm_medium=ai&utm_campaign=txt): Dowiedz się, jak budować interfejsy dla programów Solana.
- [Generowanie klientów](https://solana.com/docs/pl/programs/codama/clients?utm_source=llms&utm_medium=ai&utm_campaign=txt): Kompletny przewodnik po generowaniu klientów dla programów Solana za pomocą narzędzia Codama CLI.
...
- [Go SDK](https://solana.com/docs/pl/clients/community/go?utm_source=llms&utm_medium=ai&utm_campaign=txt): Dowiedz się, jak korzystać z Solana za pomocą Go SDK (gagliardetto/solana-go).
- [Grupy tokenów i członkowie](https://solana.com/docs/pl/tokens/extensions/group-member?utm_source=llms&utm_medium=ai&utm_campaign=txt): Dowiedz się, jak włączyć GroupPointerExtension i GroupMemberPointerExtension.
- [Instalacja zależności](https://solana.com/docs/pl/intro/installation/dependencies?utm_source=llms&utm_medium=ai&utm_campaign=txt): Przewodnik po konfiguracji lokalnego środowiska programistycznego Solana. Dowiedz się, jak zainstalować Rust, Solana CLI i Anchor Framework na Windows (WSL), Linuxie i Macu.
- [Instrukcje](https://solana.com/docs/pl/core/instructions?utm_source=llms&utm_medium=ai&utm_campaign=txt): Dowiedz się o instrukcjach Solana — podstawowych elementach interakcji z blockchainem Solana. Zrozum składanie instrukcji na praktycznych przykładach.
...
- [Mollusk](https://solana.com/docs/pl/programs/testing/mollusk?utm_source=llms&utm_medium=ai&utm_campaign=txt): Kompleksowy przewodnik po testowaniu programów Solana za pomocą Mollusk
- [Next.js + Solana React Hooks](https://solana.com/docs/pl/frontend/nextjs-solana?utm_source=llms&utm_medium=ai&utm_campaign=txt): Skonfiguruj integrację portfela Solana w Next.js za pomocą @solana/client i @solana/react-hooks, aby wysyłać transfery SOL.
- [Next.js - Solana Kit](https://solana.com/docs/pl/frontend/kit?utm_source=llms&utm_medium=ai&utm_campaign=txt): Skonfiguruj integrację portfela Solana w Next.js za pomocą Solana Kit.
- [Niezmienny właściciel](https://solana.com/docs/pl/tokens/extensions/immutable-owner?utm_source=llms&utm_medium=ai&utm_campaign=txt): Dowiedz się, jak włączyć rozszerzenie ImmutableOwner.
- [Odczyt z sieci](https://solana.com/docs/pl/intro/quick-start/reading-from-network?utm_source=llms&utm_medium=ai&utm_campaign=txt): Dowiedz się, jak odczytywać dane z sieci blockchain Solana. Ten przewodnik obejmuje pobieranie kont portfeli, kont programów i kont tokenów za pomocą JavaScript/TypeScript, z praktycznymi przykładami wykorzystującymi bibliotekę Solana web3.js.
- [Odmrożenie konta](https://solana.com/docs/pl/tokens/basics/thaw-account?utm_source=llms&utm_medium=ai&utm_campaign=txt): Dowiedz się, jak odmrozić zamrożone konto tokena.
- [Ograniczenia](https://solana.com/docs/pl/programs/limitations?utm_source=llms&utm_medium=ai&utm_campaign=txt)
- [Opłaty transakcyjne](https://solana.com/docs/pl/core/fees?utm_source=llms&utm_medium=ai&utm_campaign=txt): Dowiedz się więcej o opłatach transakcyjnych w Solana, w tym o opłatach podstawowych i priorytetowych, sposobie ich stosowania oraz najlepszych praktykach zarządzania jednostkami obliczeniowymi w transakcjach.
- [Opłaty za transfer](https://solana.com/docs/pl/tokens/extensions/transfer-fees?utm_source=llms&utm_medium=ai&utm_campaign=txt): Dowiedz się, jak zaimplementować TransferFeeExtension.
- [Podstawowe pojęcia](https://solana.com/docs/pl/core/?utm_source=llms&utm_medium=ai&utm_campaign=txt): Poznaj kluczowe pojęcia związane z blockchainem Solana, w tym konta, transakcje, programy, adresy pochodne programów, wywołania międzyprogramowe oraz sposób działania tokenów na Solanie.
- [Podstawy Anchor CLI](https://solana.com/docs/pl/intro/installation/anchor-cli-basics?utm_source=llms&utm_medium=ai&utm_campaign=txt): Ta sekcja omawia kilka typowych poleceń Anchor CLI, aby pomóc Ci rozpocząć.
- [Podstawy Solana CLI](https://solana.com/docs/pl/intro/installation/solana-cli-basics?utm_source=llms&utm_medium=ai&utm_campaign=txt): Ta sekcja przeprowadza przez kilka podstawowych poleceń Solana CLI, aby pomóc Ci zacząć.
- [Podstawy Surfpool CLI](https://solana.com/docs/pl/intro/installation/surfpool-cli-basics?utm_source=llms&utm_medium=ai&utm_campaign=txt): Poznaj podstawowe polecenia Surfpool CLI do lokalnego rozwoju na Solanie, w tym uruchamianie validatora i korzystanie z Surfpool Studio.
...
- [Programy](https://solana.com/docs/pl/core/programs?utm_source=llms&utm_medium=ai&utm_campaign=txt): Dowiedz się więcej o programach (smart kontraktach) na Solanie i jak je rozwijać za pomocą języka Rust lub frameworka Anchor. Zrozum wdrażanie, aktualizacje i weryfikację programów w sieci Solana.
...
- [Przesyłanie z memo](https://solana.com/docs/pl/tokens/extensions/memo-transfer?utm_source=llms&utm_medium=ai&utm_campaign=txt): Dowiedz się, jak włączyć MemoTransferExtension.
...
- [Punkty końcowe RPC](https://solana.com/docs/pl/references/clusters?utm_source=llms&utm_medium=ai&utm_campaign=txt): Dowiedz się więcej o klastrach sieci Solana (Devnet, Testnet i Mainnet), ich publicznych punktach końcowych RPC, limitach szybkości oraz zastosowaniach. Poznaj sposoby łączenia się z różnymi sieciami Solana do celów deweloperskich, testowych i produkcyjnych.
...
- [Python SDK](https://solana.com/docs/pl/clients/community/python?utm_source=llms&utm_medium=ai&utm_campaign=txt): Dowiedz się, jak korzystać z Solana za pomocą Python SDK (michaelhly/solana-py).
...
- [Rozszerzenia Metadata i Metadata Pointer](https://solana.com/docs/pl/tokens/extensions/metadata?utm_source=llms&utm_medium=ai&utm_campaign=txt): Dowiedz się, jak włączyć rozszerzenia MetadataPointerExtension i TokenMetadata.
...
- [Rust SDK](https://solana.com/docs/pl/clients/official/rust?utm_source=llms&utm_medium=ai&utm_campaign=txt): Oficjalne pakiety Rust do budowania na platformie Solana.
...
- [Solana Gaming SDKs](https://solana.com/docs/pl/clients/community/game-sdks?utm_source=llms&utm_medium=ai&utm_campaign=txt): Lista Solana Gaming SDKs, które pomogą Ci rozpocząć tworzenie Twojej pierwszej gry na Solanie
- [Spalanie tokenów](https://solana.com/docs/pl/tokens/basics/burn-tokens?utm_source=llms&utm_medium=ai&utm_campaign=txt): Dowiedz się, jak spalać tokeny.
- [Staking](https://solana.com/docs/pl/references/staking/?utm_source=llms&utm_medium=ai&utm_campaign=txt)
- [Stały delegat](https://solana.com/docs/pl/tokens/extensions/permanent-delegate?utm_source=llms&utm_medium=ai&utm_campaign=txt): Dowiedz się, jak zaimplementować rozszerzenie InitializePermanentDelegate.
...
- [Synchronizacja Native](https://solana.com/docs/pl/tokens/basics/sync-native?utm_source=llms&utm_medium=ai&utm_campaign=txt): Dowiedz się, jak zamienić natywny SOL na opakowany SOL.
- [Szybka instalacja](https://solana.com/docs/pl/intro/installation/?utm_source=llms&utm_medium=ai&utm_campaign=txt): Przewodnik szybkiej instalacji, który pozwala skonfigurować lokalne środowisko programistyczne Solana za pomocą jednego polecenia. Zainstaluj Rust, Solana CLI i Anchor Framework na Windows (WSL), Linux i Mac.
...
- [Tokeny nieprzenoszalne](https://solana.com/docs/pl/tokens/extensions/non-transferrable-tokens?utm_source=llms&utm_medium=ai&utm_campaign=txt): Dowiedz się, jak włączyć InitializeNonTransferableMint.
- [Tokeny z oprocentowaniem](https://solana.com/docs/pl/tokens/extensions/interest-bearing-tokens?utm_source=llms&utm_medium=ai&utm_campaign=txt): Dowiedz się, jak włączyć InterestBearingMintExtension.
- [Transakcje](https://solana.com/docs/pl/core/transactions?utm_source=llms&utm_medium=ai&utm_campaign=txt): Dowiedz się więcej o transakcjach Solana — podstawowych elementach interakcji z blockchainem Solana. Zrozum strukturę transakcji i skład instrukcji dzięki praktycznym przykładom.
...
- [TypeScript SDK](https://solana.com/docs/pl/clients/official/javascript?utm_source=llms&utm_medium=ai&utm_campaign=txt): Dowiedz się, jak korzystać z bibliotek klienckich JavaScript/TypeScript do interakcji z Solaną.
- [Ustawianie autorytetu](https://solana.com/docs/pl/tokens/basics/set-authority?utm_source=llms&utm_medium=ai&utm_campaign=txt): Dowiedz się, jak ustawić autorytet dla mintów lub kont tokenów.
- [Utwórz Token Mint](https://solana.com/docs/pl/tokens/basics/create-mint?utm_source=llms&utm_medium=ai&utm_campaign=txt): Dowiedz się, jak utworzyć mint tokena SPL.
...
- [Wdrażanie programu](https://solana.com/docs/pl/intro/quick-start/deploying-programs?utm_source=llms&utm_medium=ai&utm_campaign=txt): Dowiedz się, jak zbudować, wdrożyć i przetestować swój pierwszy program Solana, korzystając z frameworka Anchor i Solana Playground. Ten przyjazny dla początkujących przewodnik przeprowadzi Cię przez tworzenie prostego programu, wdrażanie go na devnet, uruchamianie testów i zamykanie programu.
...
- [Weryfikacja programów](https://solana.com/docs/pl/programs/verified-builds?utm_source=llms&utm_medium=ai&utm_campaign=txt): Zweryfikowane kompilacje to sposób na powiązanie programu z jego kodem źródłowym, umożliwiający każdemu niezależne zweryfikowanie, że program został faktycznie zbudowany z dostarczonego kodu źródłowego.
...
- [Zamknij Mint](https://solana.com/docs/pl/tokens/extensions/close-mint?utm_source=llms&utm_medium=ai&utm_campaign=txt): Dowiedz się, jak włączyć rozszerzenie MintCloseAuthority.
- [Zamknij konto tokena](https://solana.com/docs/pl/tokens/basics/close-account?utm_source=llms&utm_medium=ai&utm_campaign=txt): Dowiedz się, jak zamknąć konta tokenów.
- [Zamrożenie konta](https://solana.com/docs/pl/tokens/basics/freeze-account?utm_source=llms&utm_medium=ai&utm_campaign=txt): Dowiedz się, jak zamrozić konta tokenów.
...
- [Zatwierdź delegata](https://solana.com/docs/pl/tokens/basics/approve-delegate?utm_source=llms&utm_medium=ai&utm_campaign=txt): Dowiedz się, jak zatwierdzić delegatów dla konta tokena.
...
- [@solana/client](https://solana.com/docs/pt/frontend/client?utm_source=llms&utm_medium=ai&utm_campaign=txt): Construa frontends Solana enxutos com o runtime de cliente Solana headless.
- [@solana/react-hooks](https://solana.com/docs/pt/frontend/react-hooks?utm_source=llms&utm_medium=ai&utm_campaign=txt): Compartilhe o estado do @solana/client em toda a sua aplicação React com hooks prontos para uso.
- [@solana/web3-compat](https://solana.com/docs/pt/frontend/web3-compat?utm_source=llms&utm_medium=ai&utm_campaign=txt): Camada de compatibilidade drop-in que permite que código legado do @solana/web3.js seja executado em primitivas do Kit.
...
- [Aprovar Delegado](https://solana.com/docs/pt/tokens/basics/approve-delegate?utm_source=llms&utm_medium=ai&utm_campaign=txt): Aprenda como aprovar delegados para uma token account.
- [CPI Guard](https://solana.com/docs/pt/tokens/extensions/cpi-guard?utm_source=llms&utm_medium=ai&utm_campaign=txt): Aprenda como habilitar a CpiGuardExtension.
...
- [Conceitos fundamentais](https://solana.com/docs/pt/core/?utm_source=llms&utm_medium=ai&utm_campaign=txt): Aprenda conceitos essenciais da blockchain Solana, incluindo contas, transações, programas, endereços derivados de programas, invocações entre programas e como os tokens funcionam na Solana.
- [Congelar Conta](https://solana.com/docs/pt/tokens/basics/freeze-account?utm_source=llms&utm_medium=ai&utm_campaign=txt): Aprenda como congelar token accounts.
...
- [Cross Program Invocation](https://solana.com/docs/pt/core/cpi?utm_source=llms&utm_medium=ai&utm_campaign=txt): Aprenda sobre Cross Program Invocation (CPI) na Solana — como programas podem chamar instruções em outros programas, lidar com assinantes PDA e compor funcionalidades através da rede Solana.
...
- [Definir Autoridade](https://solana.com/docs/pt/tokens/basics/set-authority?utm_source=llms&utm_medium=ai&utm_campaign=txt): Aprenda como definir autoridade para mint accounts ou token accounts.
- [Delegado Permanente](https://solana.com/docs/pt/tokens/extensions/permanent-delegate?utm_source=llms&utm_medium=ai&utm_campaign=txt): Aprenda como implementar a extensão InitializePermanentDelegate.
...
- [Descongelar conta](https://solana.com/docs/pt/tokens/basics/thaw-account?utm_source=llms&utm_medium=ai&utm_campaign=txt): Aprenda como descongelar uma conta de token congelada.
...
- [Endereço Derivado de Programa](https://solana.com/docs/pt/core/pda?utm_source=llms&utm_medium=ai&utm_campaign=txt): Aprenda sobre os Endereços Derivados de Programa (PDAs) da Solana — endereços de conta determinísticos que permitem assinatura segura de programas. Entenda a derivação de PDAs, bumps canônicos e como criar contas PDA.
- [Endpoints RPC](https://solana.com/docs/pt/references/clusters?utm_source=llms&utm_medium=ai&utm_campaign=txt): Aprenda sobre os clusters de rede da Solana (Devnet, Testnet e Mainnet), seus endpoints RPC públicos, limites de taxa e casos de uso. Aprenda como conectar a diferentes redes Solana para desenvolvimento, testes e produção.
...
- [Estado padrão](https://solana.com/docs/pt/tokens/extensions/default-state?utm_source=llms&utm_medium=ai&utm_campaign=txt): Aprenda como habilitar o DefaultAccountStateExtension.
...
- [Extensões de metadados e ponteiro de metadados](https://solana.com/docs/pt/tokens/extensions/metadata?utm_source=llms&utm_medium=ai&utm_campaign=txt): Aprenda como habilitar a MetadataPointerExtension e a extensão TokenMetadata.
- [FAQ](https://solana.com/docs/pt/programs/faq?utm_source=llms&utm_medium=ai&utm_campaign=txt)
- [Fechar Mint](https://solana.com/docs/pt/tokens/extensions/close-mint?utm_source=llms&utm_medium=ai&utm_campaign=txt): Aprenda como habilitar a extensão MintCloseAuthority.
- [Fechar conta de token](https://solana.com/docs/pt/tokens/basics/close-account?utm_source=llms&utm_medium=ai&utm_campaign=txt): Aprenda como fechar contas de token.
- [Frontend](https://solana.com/docs/pt/frontend/?utm_source=llms&utm_medium=ai&utm_campaign=txt): Aprenda sobre a construção de interfaces para programas Solana.
...
- [Gerando Clientes](https://solana.com/docs/pt/programs/codama/clients?utm_source=llms&utm_medium=ai&utm_campaign=txt): Guia completo para gerar clientes para programas Solana usando o CLI Codama.
- [Grupos de Tokens e Membros](https://solana.com/docs/pt/tokens/extensions/group-member?utm_source=llms&utm_medium=ai&utm_campaign=txt): Aprenda como habilitar o GroupPointerExtension e GroupMemberPointerExtension.
...
- [Implantar um programa](https://solana.com/docs/pt/intro/quick-start/deploying-programs?utm_source=llms&utm_medium=ai&utm_campaign=txt): Aprenda a construir, implantar e testar seu primeiro programa Solana usando o framework Anchor e o Solana Playground. Este guia para iniciantes orienta na criação de um programa simples, implantação na devnet, execução de testes e encerramento do programa.
- [Instalar Dependências](https://solana.com/docs/pt/intro/installation/dependencies?utm_source=llms&utm_medium=ai&utm_campaign=txt): Um guia para configurar seu ambiente de desenvolvimento local Solana. Aprenda como instalar Rust, a CLI do Solana e o Framework Anchor no Windows (WSL), Linux e Mac.
- [Instalação rápida](https://solana.com/docs/pt/intro/installation/?utm_source=llms&utm_medium=ai&utm_campaign=txt): Um guia de instalação rápida que permite configurar seu ambiente de desenvolvimento local da Solana com um único comando. Instale Rust, a CLI da Solana e o Framework Anchor no Windows (WSL), Linux e Mac.
- [Instruções](https://solana.com/docs/pt/core/instructions?utm_source=llms&utm_medium=ai&utm_campaign=txt): Aprenda sobre as instruções Solana—os blocos fundamentais para interagir com a blockchain Solana. Entenda a composição de instruções com exemplos práticos.
...
- [Mollusk](https://solana.com/docs/pt/programs/testing/mollusk?utm_source=llms&utm_medium=ai&utm_campaign=txt): Guia completo para testar programas Solana usando Mollusk
...
- [Next.js + Solana React Hooks](https://solana.com/docs/pt/frontend/nextjs-solana?utm_source=llms&utm_medium=ai&utm_campaign=txt): Configure a integração de carteira Solana no Next.js com @solana/client e @solana/react-hooks para enviar transferências de SOL.
- [Next.js - Solana Kit](https://solana.com/docs/pt/frontend/kit?utm_source=llms&utm_medium=ai&utm_campaign=txt): Configure a integração de carteira Solana no Next.js com o Solana Kit.
...
- [Noções básicas da CLI Solana](https://solana.com/docs/pt/intro/installation/solana-cli-basics?utm_source=llms&utm_medium=ai&utm_campaign=txt): Esta seção apresenta alguns comandos comuns da CLI Solana para ajudar você a começar.
- [Noções básicas da CLI do Anchor](https://solana.com/docs/pt/intro/installation/anchor-cli-basics?utm_source=llms&utm_medium=ai&utm_campaign=txt): Esta seção apresenta alguns comandos comuns da CLI do Anchor para ajudar você a começar.
- [Noções básicas do Surfpool CLI](https://solana.com/docs/pt/intro/installation/surfpool-cli-basics?utm_source=llms&utm_medium=ai&utm_campaign=txt): Aprenda comandos essenciais do Surfpool CLI para desenvolvimento local em Solana, incluindo como iniciar um validator e usar o Surfpool Studio.
- [Programas](https://solana.com/docs/pt/core/programs?utm_source=llms&utm_medium=ai&utm_campaign=txt): Aprenda sobre os programas Solana (contratos inteligentes) e como desenvolvê-los usando Rust ou o framework Anchor. Entenda a implantação, atualizações e verificação de programas na rede Solana.
...
- [Proprietário Imutável](https://solana.com/docs/pt/tokens/extensions/immutable-owner?utm_source=llms&utm_medium=ai&utm_campaign=txt): Aprenda como habilitar a Extensão ImmutableOwner.
- [Queimar Tokens](https://solana.com/docs/pt/tokens/basics/burn-tokens?utm_source=llms&utm_medium=ai&utm_campaign=txt): Aprenda como queimar tokens.
...
- [Revogar Delegado](https://solana.com/docs/pt/tokens/basics/revoke-delegate?utm_source=llms&utm_medium=ai&utm_campaign=txt): Aprenda como revogar o delegado da token account.
...
- [Rust SDK](https://solana.com/docs/pt/clients/official/rust?utm_source=llms&utm_medium=ai&utm_campaign=txt): Crates oficiais de Rust para construir na Solana.
...
- [SDK Go](https://solana.com/docs/pt/clients/community/go?utm_source=llms&utm_medium=ai&utm_campaign=txt): Aprenda como interagir com Solana usando o SDK Go (gagliardetto/solana-go).
...
- [SDK Java](https://solana.com/docs/pt/clients/community/java?utm_source=llms&utm_medium=ai&utm_campaign=txt): Aprenda como interagir com Solana usando o SDK Java (sava-software/sava).
...
- [SDK Python](https://solana.com/docs/pt/clients/community/python?utm_source=llms&utm_medium=ai&utm_campaign=txt): Aprenda como interagir com a Solana usando o SDK Python (michaelhly/solana-py).
...
- [SDKs de jogos Solana](https://solana.com/docs/pt/clients/community/game-sdks?utm_source=llms&utm_medium=ai&utm_campaign=txt): Uma lista de SDKs de jogos Solana para ajudar você a começar a criar seu primeiro jogo Solana
- [Staking](https://solana.com/docs/pt/references/staking/?utm_source=llms&utm_medium=ai&utm_campaign=txt)
- [Sync Native](https://solana.com/docs/pt/tokens/basics/sync-native?utm_source=llms&utm_medium=ai&utm_campaign=txt): Aprenda como converter SOL nativo para SOL empacotado.
- [Taxas de transação](https://solana.com/docs/pt/core/fees?utm_source=llms&utm_medium=ai&utm_campaign=txt): Aprenda sobre as taxas de transação da Solana, incluindo as taxas base e de prioridade, como cada uma é aplicada e as melhores práticas para gerenciar unidades de computação em suas transações.
- [Taxas de transferência](https://solana.com/docs/pt/tokens/extensions/transfer-fees?utm_source=llms&utm_medium=ai&utm_campaign=txt): Aprenda como implementar o TransferFeeExtension.
...
- [Tokens com rendimento de juros](https://solana.com/docs/pt/tokens/extensions/interest-bearing-tokens?utm_source=llms&utm_medium=ai&utm_campaign=txt): Aprenda como habilitar o InterestBearingMintExtension.
...
- [Tokens não transferíveis](https://solana.com/docs/pt/tokens/extensions/non-transferrable-tokens?utm_source=llms&utm_medium=ai&utm_campaign=txt): Aprenda como habilitar o InitializeNonTransferableMint.
- [Transações](https://solana.com/docs/pt/core/transactions?utm_source=llms&utm_medium=ai&utm_campaign=txt): Aprenda sobre as transações da Solana—os blocos fundamentais para interagir com a blockchain Solana. Entenda a estrutura das transações e a composição de instruções com exemplos práticos.
...
- [Transferir tokens](https://solana.com/docs/pt/tokens/basics/transfer-tokens?utm_source=llms&utm_medium=ai&utm_campaign=txt): Aprenda como transferir tokens entre contas de tokens.
...
- [Transferência com memo](https://solana.com/docs/pt/tokens/extensions/memo-transfer?utm_source=llms&utm_medium=ai&utm_campaign=txt): Aprenda como habilitar a MemoTransferExtension.
...
- [Typescript SDK](https://solana.com/docs/pt/clients/official/javascript?utm_source=llms&utm_medium=ai&utm_campaign=txt): Aprenda como interagir com a Solana usando as bibliotecas cliente JavaScript/TypeScript.
...
- [Verificando programas](https://solana.com/docs/pt/programs/verified-builds?utm_source=llms&utm_medium=ai&utm_campaign=txt): Builds verificados são uma forma de vincular seu programa ao seu código-fonte e permitir que todos verifiquem independentemente que o programa foi realmente construído a partir desse código-fonte fornecido.
...
- [@solana/client](https://solana.com/docs/ru/frontend/client?utm_source=llms&utm_medium=ai&utm_campaign=txt): Создавайте легковесные фронтенды Solana с помощью headless-рантайма Solana client.
- [@solana/react-hooks](https://solana.com/docs/ru/frontend/react-hooks?utm_source=llms&utm_medium=ai&utm_campaign=txt): Делитесь состоянием @solana/client по всему вашему React-приложению с помощью готовых к использованию хуков.
- [@solana/web3-compat](https://solana.com/docs/ru/frontend/web3-compat?utm_source=llms&utm_medium=ai&utm_campaign=txt): Совместимый слой, который позволяет устаревшему коду @solana/web3.js работать на примитивах Kit без изменений.
- [CPI Guard](https://solana.com/docs/ru/tokens/extensions/cpi-guard?utm_source=llms&utm_medium=ai&utm_campaign=txt): Узнайте, как включить CpiGuardExtension.
- [Cross Program Invocation](https://solana.com/docs/ru/core/cpi?utm_source=llms&utm_medium=ai&utm_campaign=txt): Узнайте о Cross Program Invocation (CPI) в Solana — как программы могут вызывать инструкции других программ, работать с подписантами PDA и составлять функциональность в сети Solana.
...
- [Go SDK](https://solana.com/docs/ru/clients/community/go?utm_source=llms&utm_medium=ai&utm_campaign=txt): Узнайте, как взаимодействовать с Solana, используя Go SDK (gagliardetto/solana-go).
...
- [Java SDK](https://solana.com/docs/ru/clients/community/java?utm_source=llms&utm_medium=ai&utm_campaign=txt): Узнайте, как взаимодействовать с Solana с помощью Java SDK (sava-software/sava).
- [Mollusk](https://solana.com/docs/ru/programs/testing/mollusk?utm_source=llms&utm_medium=ai&utm_campaign=txt): Полное руководство по тестированию программ Solana с использованием Mollusk
- [Next.js + Solana React Hooks](https://solana.com/docs/ru/frontend/nextjs-solana?utm_source=llms&utm_medium=ai&utm_campaign=txt): Настройте интеграцию кошелька Solana в Next.js с помощью @solana/client и @solana/react-hooks для отправки переводов SOL.
- [Next.js - Solana Kit](https://solana.com/docs/ru/frontend/kit?utm_source=llms&utm_medium=ai&utm_campaign=txt): Настройте интеграцию кошелька Solana в Next.js с помощью Solana Kit.
...
- [Python SDK](https://solana.com/docs/ru/clients/community/python?utm_source=llms&utm_medium=ai&utm_campaign=txt): Узнайте, как взаимодействовать с Solana, используя Python SDK (michaelhly/solana-py).
- [RPC-эндпоинты](https://solana.com/docs/ru/references/clusters?utm_source=llms&utm_medium=ai&utm_campaign=txt): Узнайте о кластерах сети Solana (Devnet, Testnet и Mainnet), их публичных RPC-эндпоинтах, лимитах запросов и вариантах использования. Узнайте, как подключаться к различным сетям Solana для разработки, тестирования и продакшена.
...
- [Rust SDK](https://solana.com/docs/ru/clients/official/rust?utm_source=llms&utm_medium=ai&utm_campaign=txt): Официальные библиотеки Rust для разработки на Solana.
- [TypeScript SDK](https://solana.com/docs/ru/clients/official/javascript?utm_source=llms&utm_medium=ai&utm_campaign=txt): Узнайте, как взаимодействовать с Solana, используя клиентские библиотеки JavaScript/TypeScript.
...
- [Быстрая установка](https://solana.com/docs/ru/intro/installation/?utm_source=llms&utm_medium=ai&utm_campaign=txt): Краткое руководство по установке, которое позволяет настроить локальную среду разработки Solana с помощью одной команды. Установите Rust, Solana CLI и Anchor Framework на Windows (WSL), Linux и Mac.
...
- [Генерация клиентов](https://solana.com/docs/ru/programs/codama/clients?utm_source=llms&utm_medium=ai&utm_campaign=txt): Полное руководство по генерации клиентов для программ Solana с использованием Codama CLI.
- [Группы токенов и участники](https://solana.com/docs/ru/tokens/extensions/group-member?utm_source=llms&utm_medium=ai&utm_campaign=txt): Узнайте, как включить GroupPointerExtension и GroupMemberPointerExtension.
...
- [Закрытие Mint](https://solana.com/docs/ru/tokens/extensions/close-mint?utm_source=llms&utm_medium=ai&utm_campaign=txt): Узнайте, как включить расширение MintCloseAuthority.
- [Закрытие аккаунта токена](https://solana.com/docs/ru/tokens/basics/close-account?utm_source=llms&utm_medium=ai&utm_campaign=txt): Узнайте, как закрывать аккаунты токенов.
- [Заморозить аккаунт](https://solana.com/docs/ru/tokens/basics/freeze-account?utm_source=llms&utm_medium=ai&utm_campaign=txt): Узнайте, как заморозить токен-аккаунты.
...
- [Игровые SDK для Solana](https://solana.com/docs/ru/clients/community/game-sdks?utm_source=llms&utm_medium=ai&utm_campaign=txt): Список игровых SDK для Solana, которые помогут вам начать создавать вашу первую игру на Solana
- [Инструкции](https://solana.com/docs/ru/core/instructions?utm_source=llms&utm_medium=ai&utm_campaign=txt): Узнайте об инструкциях Solana — основных строительных блоках для взаимодействия с блокчейном Solana. Поймите составление инструкций на практических примерах.
- [Комиссии за перевод](https://solana.com/docs/ru/tokens/extensions/transfer-fees?utm_source=llms&utm_medium=ai&utm_campaign=txt): Узнайте, как реализовать TransferFeeExtension.
...
- [Неизменяемый владелец](https://solana.com/docs/ru/tokens/extensions/immutable-owner?utm_source=llms&utm_medium=ai&utm_campaign=txt): Узнайте, как включить расширение ImmutableOwner.
- [Непередаваемые токены](https://solana.com/docs/ru/tokens/extensions/non-transferrable-tokens?utm_source=llms&utm_medium=ai&utm_campaign=txt): Узнайте, как включить InitializeNonTransferableMint.
...
- [Основные концепции](https://solana.com/docs/ru/core/?utm_source=llms&utm_medium=ai&utm_campaign=txt): Изучите основные концепции блокчейна Solana, включая аккаунты, транзакции, программы, адреса, производные от программ, вызовы между программами и работу токенов в Solana.
- [Основы Anchor CLI](https://solana.com/docs/ru/intro/installation/anchor-cli-basics?utm_source=llms&utm_medium=ai&utm_campaign=txt): В этом разделе рассматриваются некоторые распространенные команды Anchor CLI, которые помогут вам начать работу.
...
- [Основы Solana CLI](https://solana.com/docs/ru/intro/installation/solana-cli-basics?utm_source=llms&utm_medium=ai&utm_campaign=txt): В этом разделе рассматриваются некоторые распространенные команды Solana CLI, чтобы помочь вам начать работу.
- [Основы Surfpool CLI](https://solana.com/docs/ru/intro/installation/surfpool-cli-basics?utm_source=llms&utm_medium=ai&utm_campaign=txt): Изучите основные команды Surfpool CLI для локальной разработки на Solana, включая запуск валидатора и использование Surfpool Studio.
- [Отозвать делегата](https://solana.com/docs/ru/tokens/basics/revoke-delegate?utm_source=llms&utm_medium=ai&utm_campaign=txt): Узнайте, как отозвать делегата токенного аккаунта.
...
- [Перевод токенов](https://solana.com/docs/ru/tokens/basics/transfer-tokens?utm_source=llms&utm_medium=ai&utm_campaign=txt): Узнайте, как переводить токены между токен-аккаунтами.
- [Передача с заметкой](https://solana.com/docs/ru/tokens/extensions/memo-transfer?utm_source=llms&utm_medium=ai&utm_campaign=txt): Узнайте, как включить MemoTransferExtension.
- [Постоянный делегат](https://solana.com/docs/ru/tokens/extensions/permanent-delegate?utm_source=llms&utm_medium=ai&utm_campaign=txt): Узнайте, как реализовать расширение InitializePermanentDelegate.
...
- [Проверка программ](https://solana.com/docs/ru/programs/verified-builds?utm_source=llms&utm_medium=ai&utm_campaign=txt): Проверенные сборки — это способ связать вашу программу с её исходным кодом и позволить всем независимо убедиться, что программа действительно была собрана из предоставленного исходного кода.
...
- [Программы](https://solana.com/docs/ru/core/programs?utm_source=llms&utm_medium=ai&utm_campaign=txt): Узнайте о программах (смарт-контрактах) на Solana и о том, как разрабатывать их с использованием Rust или фреймворка Anchor. Поймите процесс развертывания, обновления и проверки программ в сети Solana.
...
- [Разморозить аккаунт](https://solana.com/docs/ru/tokens/basics/thaw-account?utm_source=llms&utm_medium=ai&utm_campaign=txt): Узнайте, как разморозить замороженный токен аккаунт.
...
- [Расширения Metadata и Metadata Pointer](https://solana.com/docs/ru/tokens/extensions/metadata?utm_source=llms&utm_medium=ai&utm_campaign=txt): Узнайте, как включить расширения MetadataPointerExtension и TokenMetadata.
...
- [Сжечь токены](https://solana.com/docs/ru/tokens/basics/burn-tokens?utm_source=llms&utm_medium=ai&utm_campaign=txt): Узнайте, как сжигать токены.
- [Синхронизация Native](https://solana.com/docs/ru/tokens/basics/sync-native?utm_source=llms&utm_medium=ai&utm_campaign=txt): Узнайте, как конвертировать native SOL в wrapped SOL.
...
- [Создание токенового минта](https://solana.com/docs/ru/tokens/basics/create-mint?utm_source=llms&utm_medium=ai&utm_campaign=txt): Узнайте, как создать SPL токеновый минт.
- [Состояние по умолчанию](https://solana.com/docs/ru/tokens/extensions/default-state?utm_source=llms&utm_medium=ai&utm_campaign=txt): Узнайте, как включить DefaultAccountStateExtension.
...
- [Токены с начислением процентов](https://solana.com/docs/ru/tokens/extensions/interest-bearing-tokens?utm_source=llms&utm_medium=ai&utm_campaign=txt): Узнайте, как включить InterestBearingMintExtension.
- [Транзакции](https://solana.com/docs/ru/core/transactions?utm_source=llms&utm_medium=ai&utm_campaign=txt): Узнайте о транзакциях Solana — фундаментальных строительных блоках для взаимодействия с блокчейном Solana. Поймите структуру транзакций и составление инструкций с практическими примерами.
- [Установить полномочия](https://solana.com/docs/ru/tokens/basics/set-authority?utm_source=llms&utm_medium=ai&utm_campaign=txt): Узнайте, как установить полномочия для mint аккаунтов или token аккаунтов.
- [Установка зависимостей](https://solana.com/docs/ru/intro/installation/dependencies?utm_source=llms&utm_medium=ai&utm_campaign=txt): Руководство по настройке локальной среды разработки Solana. Узнайте, как установить Rust, Solana CLI и Anchor Framework на Windows (WSL), Linux и Mac.
- [Утвердить делегата](https://solana.com/docs/ru/tokens/basics/approve-delegate?utm_source=llms&utm_medium=ai&utm_campaign=txt): Узнайте, как утвердить делегатов для токен-аккаунта.
- [Фронтенд](https://solana.com/docs/ru/frontend/?utm_source=llms&utm_medium=ai&utm_campaign=txt): Узнайте, как создавать интерфейсы для программ Solana.
- [Часто задаваемые вопросы](https://solana.com/docs/ru/programs/faq?utm_source=llms&utm_medium=ai&utm_campaign=txt)
- [Чтение из сети](https://solana.com/docs/ru/intro/quick-start/reading-from-network?utm_source=llms&utm_medium=ai&utm_campaign=txt): Узнайте, как считывать данные из сети блокчейна Solana. В этом руководстве рассматривается получение данных аккаунтов кошельков, программных аккаунтов и аккаунтов токенов с использованием JavaScript/TypeScript, с практическими примерами на библиотеке Solana web3.js.

## Docs - Tr

- [@solana/client](https://solana.com/docs/tr/frontend/client?utm_source=llms&utm_medium=ai&utm_campaign=txt): Headless Solana istemci çalışma zamanı ile yalın Solana ön yüzleri oluşturun.
- [@solana/react-hooks](https://solana.com/docs/tr/frontend/react-hooks?utm_source=llms&utm_medium=ai&utm_campaign=txt): @solana/client durumunu kullanıma hazır hook
- [@solana/web3-compat](https://solana.com/docs/tr/frontend/web3-compat?utm_source=llms&utm_medium=ai&utm_campaign=txt): Eski @solana/web3.js kodunun Kit primitifleri üzerinde çalışmasını sağlayan doğrudan uyumluluk katmanı.
- [Aktarılamaz Tokenlar](https://solana.com/docs/tr/tokens/extensions/non-transferrable-tokens?utm_source=llms&utm_medium=ai&utm_campaign=txt): InitializeNonTransferableMint'i nasıl etkinleştireceğinizi öğrenin.
- [Anchor CLI Temelleri](https://solana.com/docs/tr/intro/installation/anchor-cli-basics?utm_source=llms&utm_medium=ai&utm_campaign=txt): Bu bölüm, başlamanız için bazı yaygın Anchor CLI komutlarını açıklar.
...
- [Ağdan Okuma](https://solana.com/docs/tr/intro/quick-start/reading-from-network?utm_source=llms&utm_medium=ai&utm_campaign=txt): Solana blok zinciri ağından veri okumayı öğrenin. Bu rehber, JavaScript/TypeScript kullanarak cüzdan hesaplarını, program hesaplarını ve token mint hesaplarını çekmeyi kapsar ve Solana web3.js kütüphanesi ile pratik örnekler sunar.
- [Bağımlılıkları Yükle](https://solana.com/docs/tr/intro/installation/dependencies?utm_source=llms&utm_medium=ai&utm_campaign=txt): Yerel Solana geliştirme ortamınızı kurma rehberi. Windows (WSL), Linux ve Mac üzerinde Rust, Solana CLI ve Anchor Framework'ü nasıl yükleyeceğinizi öğrenin.
...
- [CPI Guard](https://solana.com/docs/tr/tokens/extensions/cpi-guard?utm_source=llms&utm_medium=ai&utm_campaign=txt): CpiGuardExtension'ı nasıl etkinleştireceğinizi öğrenin.
- [Cross Program Invocation](https://solana.com/docs/tr/core/cpi?utm_source=llms&utm_medium=ai&utm_campaign=txt): Solana'da Cross Program Invocation (CPI) hakkında bilgi edinin — programların diğer programlardaki talimatları nasıl çağırabileceğini, PDA imzalayıcılarını nasıl yöneteceğini ve Solana ağı genelinde işlevselliği nasıl birleştirebileceğini öğrenin.
- [Delegeyi İptal Et](https://solana.com/docs/tr/tokens/basics/revoke-delegate?utm_source=llms&utm_medium=ai&utm_campaign=txt): Token hesabı delegesini nasıl iptal edeceğinizi öğrenin.
...
- [Değiştirilemez Sahip](https://solana.com/docs/tr/tokens/extensions/immutable-owner?utm_source=llms&utm_medium=ai&utm_campaign=txt): ImmutableOwner Uzantısını nasıl etkinleştireceğinizi öğrenin.
...
- [Faiz Getiren Tokenler](https://solana.com/docs/tr/tokens/extensions/interest-bearing-tokens?utm_source=llms&utm_medium=ai&utm_campaign=txt): InterestBearingMintExtension'ı nasıl etkinleştireceğinizi öğrenin.
- [Frontend](https://solana.com/docs/tr/frontend/?utm_source=llms&utm_medium=ai&utm_campaign=txt): Solana programları için arayüz oluşturma hakkında bilgi edinin.
...
- [Go SDK](https://solana.com/docs/tr/clients/community/go?utm_source=llms&utm_medium=ai&utm_campaign=txt): Go SDK'sını (gagliardetto/solana-go) kullanarak Solana ile nasıl etkileşime geçeceğinizi öğrenin.
- [HTTP Metodları](https://solana.com/docs/tr/rpc/http/?utm_source=llms&utm_medium=ai&utm_campaign=txt)
- [Hesabı Dondur](https://solana.com/docs/tr/tokens/basics/freeze-account?utm_source=llms&utm_medium=ai&utm_campaign=txt): Token hesaplarını nasıl donduracağınızı öğrenin.
- [Hesabı Çöz](https://solana.com/docs/tr/tokens/basics/thaw-account?utm_source=llms&utm_medium=ai&utm_campaign=txt): Dondurulmuş bir token hesabını çözmeyi öğrenin.
- [Hesaplar](https://solana.com/docs/tr/core/accounts?utm_source=llms&utm_medium=ai&utm_campaign=txt): Solana'nın hesap modelini, hesapların verileri ve programları nasıl depoladığını, rent mekanizmalarını, hesap sahipliğini ve programlar ile veri hesapları arasındaki ilişkiyi öğrenin. Solana'nın anahtar-değer depolama sisteminin temel kavramlarını anlayın.
...
- [Hızlı Kurulum](https://solana.com/docs/tr/intro/installation/?utm_source=llms&utm_medium=ai&utm_campaign=txt): Tek bir komutla yerel Solana geliştirme ortamınızı kurmanızı sağlayan hızlı kurulum kılavuzu. Windows (WSL), Linux ve Mac üzerinde Rust, Solana CLI ve Anchor Framework'ü kurun.
...
- [Java SDK](https://solana.com/docs/tr/clients/community/java?utm_source=llms&utm_medium=ai&utm_campaign=txt): Solana ile Java SDK (sava-software/sava) kullanarak nasıl etkileşim kuracağınızı öğrenin.
- [Kalıcı temsilci](https://solana.com/docs/tr/tokens/extensions/permanent-delegate?utm_source=llms&utm_medium=ai&utm_campaign=txt): InitializePermanentDelegate uzantısını nasıl uygulayacağınızı öğrenin.
- [Kısıtlamalar](https://solana.com/docs/tr/programs/limitations?utm_source=llms&utm_medium=ai&utm_campaign=txt)
- [Memo transferi](https://solana.com/docs/tr/tokens/extensions/memo-transfer?utm_source=llms&utm_medium=ai&utm_campaign=txt): MemoTransferExtension'ı nasıl etkinleştireceğinizi öğrenin.
- [Metadata ve Metadata İşaretçi Uzantıları](https://solana.com/docs/tr/tokens/extensions/metadata?utm_source=llms&utm_medium=ai&utm_campaign=txt): MetadataPointerExtension ve TokenMetadata uzantısını nasıl etkinleştireceğinizi öğrenin.
- [Mint'i Kapat](https://solana.com/docs/tr/tokens/extensions/close-mint?utm_source=llms&utm_medium=ai&utm_campaign=txt): MintCloseAuthority uzantısını nasıl etkinleştireceğinizi öğrenin.
- [Mollusk](https://solana.com/docs/tr/programs/testing/mollusk?utm_source=llms&utm_medium=ai&utm_campaign=txt): Mollusk kullanarak Solana programlarını test etmek için kapsamlı rehber
- [Next.js + Solana React Hooks](https://solana.com/docs/tr/frontend/nextjs-solana?utm_source=llms&utm_medium=ai&utm_campaign=txt): SOL transferleri göndermek için @solana/client ve @solana/react-hooks kullanarak Next.js'te Solana cüzdan entegrasyonunu kurun.
- [Next.js - Solana Kit](https://solana.com/docs/tr/frontend/kit?utm_source=llms&utm_medium=ai&utm_campaign=txt): Next.js'de Solana Kit ile Solana cüzdan entegrasyonunu kurun.
- [Program Dağıtma](https://solana.com/docs/tr/intro/quick-start/deploying-programs?utm_source=llms&utm_medium=ai&utm_campaign=txt): Anchor framework ve Solana Playground kullanarak ilk Solana programınızı nasıl oluşturacağınızı, dağıtacağınızı ve test edeceğinizi öğrenin. Bu başlangıç seviyesindeki rehber, basit bir program oluşturma, devnet'e dağıtma, testleri çalıştırma ve programı kapatma adımlarını anlatır.
- [Program Yapısı](https://solana.com/docs/tr/programs/rust/program-structure?utm_source=llms&utm_medium=ai&utm_campaign=txt): Giriş noktaları, durum yönetimi, talimat işleme ve test dahil olmak üzere Rust'ta Solana programlarının nasıl yapılandırılacağını öğrenin.
...
- [Programları Doğrulama](https://solana.com/docs/tr/programs/verified-builds?utm_source=llms&utm_medium=ai&utm_campaign=txt): Doğrulanmış derlemeler, programınızı kaynak koduyla ilişkilendirmenin ve herkesin bağımsız olarak programın gerçekten sağlanan kaynak kodundan derlendiğini doğrulamasının bir yoludur.
...
- [Python SDK](https://solana.com/docs/tr/clients/community/python?utm_source=llms&utm_medium=ai&utm_campaign=txt): Python SDK (michaelhly/solana-py) kullanarak Solana ile nasıl etkileşim kuracağınızı öğrenin.
- [RPC Uç Noktaları](https://solana.com/docs/tr/references/clusters?utm_source=llms&utm_medium=ai&utm_campaign=txt): Solana'nın ağ kümeleri (Devnet, Testnet ve Mainnet), genel RPC uç noktaları, hız limitleri ve kullanım durumları hakkında bilgi edinin. Geliştirme, test ve üretim için farklı Solana ağlarına nasıl bağlanacağınızı öğrenin.
...
- [Rust SDK](https://solana.com/docs/tr/clients/official/rust?utm_source=llms&utm_medium=ai&utm_campaign=txt): Solana üzerinde geliştirme yapmak için resmi Rust paketleri.
...
- [Solana CLI Temelleri](https://solana.com/docs/tr/intro/installation/solana-cli-basics?utm_source=llms&utm_medium=ai&utm_campaign=txt): Bu bölüm, başlamanız için bazı yaygın Solana CLI komutlarını adım adım açıklar.
...
- [Solana Oyun SDK'ları](https://solana.com/docs/tr/clients/community/game-sdks?utm_source=llms&utm_medium=ai&utm_campaign=txt): İlk Solana Oyununuzu oluşturmaya başlamanız için Solana Oyun SDK'larının listesi
...
- [Surfpool CLI Temelleri](https://solana.com/docs/tr/intro/installation/surfpool-cli-basics?utm_source=llms&utm_medium=ai&utm_campaign=txt): Validator başlatma ve Surfpool Studio kullanımı dahil olmak üzere yerel Solana geliştirme için temel Surfpool CLI komutlarını öğrenin.
- [Sync Native](https://solana.com/docs/tr/tokens/basics/sync-native?utm_source=llms&utm_medium=ai&utm_campaign=txt): Yerel SOL'u sarılmış SOL'a dönüştürmeyi öğrenin.
- [Talimatlar](https://solana.com/docs/tr/core/instructions?utm_source=llms&utm_medium=ai&utm_campaign=txt): Solana talimatları hakkında bilgi edinin—Solana blok zinciriyle etkileşim kurmanın temel yapı taşları. Pratik örneklerle talimat kompozisyonunu anlayın.
- [Temel Kavramlar](https://solana.com/docs/tr/core/?utm_source=llms&utm_medium=ai&utm_campaign=txt): Hesaplar, işlemler, programlar, program-türetilmiş adresler, program arası çağrılar ve token'ların Solana üzerinde nasıl çalıştığı dahil olmak üzere temel Solana blokzincir kavramlarını öğrenin.
- [Temsilci Onaylama](https://solana.com/docs/tr/tokens/basics/approve-delegate?utm_source=llms&utm_medium=ai&utm_campaign=txt): Bir token hesabı için temsilcileri nasıl onaylayacağınızı öğrenin.
...
- [Token Grupları ve Üyeleri](https://solana.com/docs/tr/tokens/extensions/group-member?utm_source=llms&utm_medium=ai&utm_campaign=txt): GroupPointerExtension ve GroupMemberPointerExtension'ı nasıl etkinleştireceğinizi öğrenin.
...
- [Token Hesabı Oluşturma](https://solana.com/docs/tr/tokens/basics/create-token-account?utm_source=llms&utm_medium=ai&utm_campaign=txt): SPL Token Hesaplarının nasıl oluşturulacağını öğrenin.
- [Token Hesabını Kapat](https://solana.com/docs/tr/tokens/basics/close-account?utm_source=llms&utm_medium=ai&utm_campaign=txt): Token hesaplarını nasıl kapatacağınızı öğrenin.
...
- [Token Yakma](https://solana.com/docs/tr/tokens/basics/burn-tokens?utm_source=llms&utm_medium=ai&utm_campaign=txt): Token yakma işlemini nasıl yapacağınızı öğrenin.
...
- [Token basma](https://solana.com/docs/tr/tokens/basics/mint-tokens?utm_source=llms&utm_medium=ai&utm_campaign=txt): Bir tokenin yeni birimlerini nasıl basacağınızı öğrenin.
...
- [Transfer ücretleri](https://solana.com/docs/tr/tokens/extensions/transfer-fees?utm_source=llms&utm_medium=ai&utm_campaign=txt): TransferFeeExtension'ı nasıl uygulayacağınızı öğrenin.
...
- [Typescript SDK](https://solana.com/docs/tr/clients/official/javascript?utm_source=llms&utm_medium=ai&utm_campaign=txt): JavaScript/TypeScript istemci kütüphanelerini kullanarak Solana ile nasıl etkileşime geçileceğini öğrenin.
- [Varsayılan Durum](https://solana.com/docs/tr/tokens/extensions/default-state?utm_source=llms&utm_medium=ai&utm_campaign=txt): DefaultAccountStateExtension'ı nasıl etkinleştireceğinizi öğrenin.
...
- [Yetki Ayarla](https://solana.com/docs/tr/tokens/basics/set-authority?utm_source=llms&utm_medium=ai&utm_campaign=txt): Mint veya token hesapları için yetki ayarlamayı öğrenin.
...
- [İstemci Oluşturma](https://solana.com/docs/tr/programs/codama/clients?utm_source=llms&utm_medium=ai&utm_campaign=txt): Codama CLI kullanarak Solana programları için istemci oluşturmanın tam kılavuzu.
- [İşlem ücretleri](https://solana.com/docs/tr/core/fees?utm_source=llms&utm_medium=ai&utm_campaign=txt): Solana'nın işlem ücretleri hakkında bilgi edinin; temel ve öncelik ücretleri, her birinin nasıl uygulandığı ve işlemlerinizdeki hesaplama birimlerini yönetmek için en iyi uygulamalar dahil.
- [İşlemler](https://solana.com/docs/tr/core/transactions?utm_source=llms&utm_medium=ai&utm_campaign=txt): Solana işlemleri hakkında bilgi edinin—Solana blok zinciriyle etkileşim kurmanın temel yapı taşları. Pratik örneklerle işlem yapısını ve talimat kompozisyonunu anlayın.

## Docs - Uk

- [@solana/client](https://solana.com/docs/uk/frontend/client?utm_source=llms&utm_medium=ai&utm_campaign=txt): Створюйте легкі Solana-фронтенди з headless-рантаймом клієнта Solana.
- [@solana/react-hooks](https://solana.com/docs/uk/frontend/react-hooks?utm_source=llms&utm_medium=ai&utm_campaign=txt): Діліться станом @solana/client у вашому React-додатку за допомогою готових хуків.
- [@solana/web3-compat](https://solana.com/docs/uk/frontend/web3-compat?utm_source=llms&utm_medium=ai&utm_campaign=txt): Рівень сумісності, який дозволяє застарілому коду @solana/web3.js працювати на примітивах Kit.
- [CPI Guard](https://solana.com/docs/uk/tokens/extensions/cpi-guard?utm_source=llms&utm_medium=ai&utm_campaign=txt): Дізнайтеся, як увімкнути CpiGuardExtension.
...
- [Go SDK](https://solana.com/docs/uk/clients/community/go?utm_source=llms&utm_medium=ai&utm_campaign=txt): Дізнайтеся, як взаємодіяти з Solana за допомогою Go SDK (gagliardetto/solana-go).
...
- [Java SDK](https://solana.com/docs/uk/clients/community/java?utm_source=llms&utm_medium=ai&utm_campaign=txt): Дізнайтеся, як взаємодіяти з Solana за допомогою Java SDK (sava-software/sava).
- [Mollusk](https://solana.com/docs/uk/programs/testing/mollusk?utm_source=llms&utm_medium=ai&utm_campaign=txt): Вичерпний посібник з тестування програм Solana за допомогою Mollusk
- [Next.js + хуки Solana React](https://solana.com/docs/uk/frontend/nextjs-solana?utm_source=llms&utm_medium=ai&utm_campaign=txt): Налаштуйте інтеграцію гаманця Solana у Next.js з @solana/client та @solana/react-hooks для відправлення SOL-переказів.
- [Next.js - Solana Kit](https://solana.com/docs/uk/frontend/kit?utm_source=llms&utm_medium=ai&utm_campaign=txt): Налаштуйте інтеграцію гаманця Solana у Next.js за допомогою Solana Kit.
...
- [Python SDK](https://solana.com/docs/uk/clients/community/python?utm_source=llms&utm_medium=ai&utm_campaign=txt): Дізнайтеся, як взаємодіяти з Solana за допомогою Python SDK (michaelhly/solana-py).
- [RPC-ендпоінти](https://solana.com/docs/uk/references/clusters?utm_source=llms&utm_medium=ai&utm_campaign=txt): Дізнайтеся про мережеві кластери Solana (Devnet, Testnet та Mainnet), їхні публічні RPC-ендпоінти, обмеження швидкості та варіанти використання. Навчіться підключатися до різних мереж Solana для розробки, тестування та продакшену.
...
- [Rust SDK](https://solana.com/docs/uk/clients/official/rust?utm_source=llms&utm_medium=ai&utm_campaign=txt): Офіційні пакети Rust для розробки на Solana.
...
- [Typescript SDK](https://solana.com/docs/uk/clients/official/javascript?utm_source=llms&utm_medium=ai&utm_campaign=txt): Дізнайтеся, як взаємодіяти з Solana за допомогою клієнтських бібліотек JavaScript/TypeScript.
...
- [Ігрові SDK для Solana](https://solana.com/docs/uk/clients/community/game-sdks?utm_source=llms&utm_medium=ai&utm_campaign=txt): Список ігрових SDK для Solana, щоб допомогти вам створити вашу першу гру на Solana
- [Інструкції](https://solana.com/docs/uk/core/instructions?utm_source=llms&utm_medium=ai&utm_campaign=txt): Дізнайтеся про інструкції Solana — фундаментальні будівельні блоки для взаємодії з блокчейном Solana. Зрозумійте композицію інструкцій з практичними прикладами.
- [Адреса, похідна від програми](https://solana.com/docs/uk/core/pda?utm_source=llms&utm_medium=ai&utm_campaign=txt): Дізнайтеся про адреси, похідні від програми (PDA) Solana — детерміновані адреси рахунків, які забезпечують безпечне підписання програмами. Зрозумійте виведення PDA, канонічні бампи та як створювати рахунки PDA.
- [Акаунти](https://solana.com/docs/uk/core/accounts?utm_source=llms&utm_medium=ai&utm_campaign=txt): Дізнайтеся про модель облікових записів Solana, включаючи те, як облікові записи зберігають дані та програми, механіку rent, власність облікових записів та взаємозв'язок між програмами та обліковими записами даних. Зрозумійте основні концепції системи зберігання ключ-значення Solana.
...
- [Встановлення залежностей](https://solana.com/docs/uk/intro/installation/dependencies?utm_source=llms&utm_medium=ai&utm_campaign=txt): Посібник з налаштування локального середовища розробки Solana. Дізнайтеся, як встановити Rust, Solana CLI та Anchor Framework на Windows (WSL), Linux та Mac.
- [Встановлення повноважень](https://solana.com/docs/uk/tokens/basics/set-authority?utm_source=llms&utm_medium=ai&utm_campaign=txt): Дізнайтеся, як встановлювати повноваження для mint account або token account.
- [Відкликання делегата](https://solana.com/docs/uk/tokens/basics/revoke-delegate?utm_source=llms&utm_medium=ai&utm_campaign=txt): Дізнайтеся, як відкликати делегата token account.
- [Генерація клієнтів](https://solana.com/docs/uk/programs/codama/clients?utm_source=llms&utm_medium=ai&utm_campaign=txt): Повний посібник з генерації клієнтів для програм Solana за допомогою Codama CLI.
- [Групи токенів та їх учасники](https://solana.com/docs/uk/tokens/extensions/group-member?utm_source=llms&utm_medium=ai&utm_campaign=txt): Дізнайтеся, як увімкнути GroupPointerExtension та GroupMemberPointerExtension.
...
- [Закрити мінт](https://solana.com/docs/uk/tokens/extensions/close-mint?utm_source=llms&utm_medium=ai&utm_campaign=txt): Дізнайтеся, як увімкнути розширення MintCloseAuthority.
- [Закрити токен-рахунок](https://solana.com/docs/uk/tokens/basics/close-account?utm_source=llms&utm_medium=ai&utm_campaign=txt): Дізнайтеся, як закривати токен-рахунки.
- [Заморозити рахунок](https://solana.com/docs/uk/tokens/basics/freeze-account?utm_source=llms&utm_medium=ai&utm_campaign=txt): Дізнайтеся, як заморожувати token account.
...
- [Затвердження делегата](https://solana.com/docs/uk/tokens/basics/approve-delegate?utm_source=llms&utm_medium=ai&utm_campaign=txt): Дізнайтеся, як затверджувати делегатів для token account.
...
- [Комісії за переказ](https://solana.com/docs/uk/tokens/extensions/transfer-fees?utm_source=llms&utm_medium=ai&utm_campaign=txt): Дізнайтеся, як реалізувати TransferFeeExtension.
...
- [Незмінний власник](https://solana.com/docs/uk/tokens/extensions/immutable-owner?utm_source=llms&utm_medium=ai&utm_campaign=txt): Дізнайтеся, як увімкнути розширення ImmutableOwner.
- [Непередавані токени](https://solana.com/docs/uk/tokens/extensions/non-transferrable-tokens?utm_source=llms&utm_medium=ai&utm_campaign=txt): Дізнайтеся, як увімкнути InitializeNonTransferableMint.
...
- [Основи Anchor CLI](https://solana.com/docs/uk/intro/installation/anchor-cli-basics?utm_source=llms&utm_medium=ai&utm_campaign=txt): Цей розділ розглядає деякі поширені команди Anchor CLI для початку роботи.
...
- [Основи Solana CLI](https://solana.com/docs/uk/intro/installation/solana-cli-basics?utm_source=llms&utm_medium=ai&utm_campaign=txt): Цей розділ розглядає деякі поширені команди Solana CLI, щоб допомогти вам почати роботу.
- [Основи Surfpool CLI](https://solana.com/docs/uk/intro/installation/surfpool-cli-basics?utm_source=llms&utm_medium=ai&utm_campaign=txt): Вивчіть основні команди Surfpool CLI для локальної розробки на Solana, включаючи запуск validator та використання Surfpool Studio.
- [Основні концепції](https://solana.com/docs/uk/core/?utm_source=llms&utm_medium=ai&utm_campaign=txt): Вивчіть основні концепції блокчейну Solana, включаючи облікові записи, транзакції, програми, програмно-похідні адреси, міжпрограмні виклики та принципи роботи токенів на Solana.
- [Перевірка програм](https://solana.com/docs/uk/programs/verified-builds?utm_source=llms&utm_medium=ai&utm_campaign=txt): Перевірені збірки — це спосіб пов'язати вашу програму з її вихідним кодом і дозволити кожному незалежно перевірити, що програма дійсно була створена з наданого вихідного коду.
- [Передача з мемо](https://solana.com/docs/uk/tokens/extensions/memo-transfer?utm_source=llms&utm_medium=ai&utm_campaign=txt): Дізнайтеся, як увімкнути MemoTransferExtension.
...
- [Переказ токенів](https://solana.com/docs/uk/tokens/basics/transfer-tokens?utm_source=llms&utm_medium=ai&utm_campaign=txt): Дізнайтеся, як переказувати токени між рахунками токенів.
- [Постійний делегат](https://solana.com/docs/uk/tokens/extensions/permanent-delegate?utm_source=llms&utm_medium=ai&utm_campaign=txt): Дізнайтеся, як реалізувати розширення InitializePermanentDelegate.
...
- [Програми](https://solana.com/docs/uk/core/programs?utm_source=llms&utm_medium=ai&utm_campaign=txt): Дізнайтеся про програми Solana (смарт-контракти) та як розробляти їх за допомогою Rust або фреймворку Anchor. Зрозумійте розгортання, оновлення та верифікацію програм у мережі Solana.
...
- [Розгортання програми](https://solana.com/docs/uk/intro/quick-start/deploying-programs?utm_source=llms&utm_medium=ai&utm_campaign=txt): Дізнайтеся, як створити, розгорнути та протестувати вашу першу програму Solana за допомогою фреймворку Anchor та Solana Playground. Цей посібник для початківців проведе вас через створення простої програми, її розгортання в devnet, запуск тестів та закриття програми.
- [Розморозити рахунок](https://solana.com/docs/uk/tokens/basics/thaw-account?utm_source=llms&utm_medium=ai&utm_campaign=txt): Дізнайтеся, як розморозити заморожений token account.
- [Розширення метаданих та вказівника метаданих](https://solana.com/docs/uk/tokens/extensions/metadata?utm_source=llms&utm_medium=ai&utm_campaign=txt): Дізнайтеся, як увімкнути розширення MetadataPointerExtension та TokenMetadata.
- [Синхронізація нативного SOL](https://solana.com/docs/uk/tokens/basics/sync-native?utm_source=llms&utm_medium=ai&utm_campaign=txt): Дізнайтеся, як конвертувати нативний SOL у wrapped SOL.
- [Спалювання токенів](https://solana.com/docs/uk/tokens/basics/burn-tokens?utm_source=llms&utm_medium=ai&utm_campaign=txt): Дізнайтеся, як спалювати токени.
...
- [Стан за замовчуванням](https://solana.com/docs/uk/tokens/extensions/default-state?utm_source=llms&utm_medium=ai&utm_campaign=txt): Дізнайтеся, як увімкнути DefaultAccountStateExtension.
...
- [Створення токен-акаунта](https://solana.com/docs/uk/tokens/basics/create-token-account?utm_source=llms&utm_medium=ai&utm_campaign=txt): Дізнайтеся, як створювати SPL Token Accounts.
...
- [Створення токен-мінту](https://solana.com/docs/uk/tokens/basics/create-mint?utm_source=llms&utm_medium=ai&utm_campaign=txt): Дізнайтеся, як створити мінт SPL токена.
...
- [Токени з нарахуванням відсотків](https://solana.com/docs/uk/tokens/extensions/interest-bearing-tokens?utm_source=llms&utm_medium=ai&utm_campaign=txt): Дізнайтеся, як увімкнути InterestBearingMintExtension.
...
- [Транзакції](https://solana.com/docs/uk/core/transactions?utm_source=llms&utm_medium=ai&utm_campaign=txt): Дізнайтеся про транзакції Solana — фундаментальні будівельні блоки для взаємодії з блокчейном Solana. Зрозумійте структуру транзакцій та композицію інструкцій з практичними прикладами.
- [Фронтенд](https://solana.com/docs/uk/frontend/?utm_source=llms&utm_medium=ai&utm_campaign=txt): Дізнайтеся про створення інтерфейсів для програм Solana.
- [Читання з мережі](https://solana.com/docs/uk/intro/quick-start/reading-from-network?utm_source=llms&utm_medium=ai&utm_campaign=txt): Дізнайтеся, як читати дані з блокчейн-мережі Solana. Цей посібник охоплює отримання гаманців, програмних рахунків та рахунків токенів, використовуючи JavaScript/TypeScript, з практичними прикладами на основі бібліотеки Solana web3.js.
- [Швидке встановлення](https://solana.com/docs/uk/intro/installation/?utm_source=llms&utm_medium=ai&utm_campaign=txt): Швидкий посібник з встановлення, який дозволяє налаштувати локальне середовище розробки Solana за допомогою однієї команди. Встановіть Rust, Solana CLI та фреймворк Anchor на Windows (WSL), Linux та Mac.
...
- [@solana/client](https://solana.com/docs/vi/frontend/client?utm_source=llms&utm_medium=ai&utm_campaign=txt): Xây dựng giao diện Solana gọn nhẹ với runtime client Solana headless.
- [@solana/react-hooks](https://solana.com/docs/vi/frontend/react-hooks?utm_source=llms&utm_medium=ai&utm_campaign=txt): Chia sẻ trạng thái @solana/client trên toàn bộ ứng dụng React của bạn với các hook sẵn sàng sử dụng.
- [@solana/web3-compat](https://solana.com/docs/vi/frontend/web3-compat?utm_source=llms&utm_medium=ai&utm_campaign=txt): Lớp tương thích thay thế trực tiếp cho phép mã @solana/web3.js cũ chạy trên các nguyên thủy Kit.
...
- [CPI Guard](https://solana.com/docs/vi/tokens/extensions/cpi-guard?utm_source=llms&utm_medium=ai&utm_campaign=txt): Tìm hiểu cách kích hoạt CpiGuardExtension.
...
- [Chuyển Token](https://solana.com/docs/vi/tokens/basics/transfer-tokens?utm_source=llms&utm_medium=ai&utm_campaign=txt): Tìm hiểu cách chuyển token giữa các tài khoản token.
...
- [Chuyển khoản memo](https://solana.com/docs/vi/tokens/extensions/memo-transfer?utm_source=llms&utm_medium=ai&utm_campaign=txt): Tìm hiểu cách kích hoạt MemoTransferExtension.
- [Chủ sở hữu bất biến](https://solana.com/docs/vi/tokens/extensions/immutable-owner?utm_source=llms&utm_medium=ai&utm_campaign=txt): Tìm hiểu cách kích hoạt tiện ích mở rộng ImmutableOwner.
...
- [Cài đặt các phụ thuộc](https://solana.com/docs/vi/intro/installation/dependencies?utm_source=llms&utm_medium=ai&utm_campaign=txt): Hướng dẫn thiết lập môi trường phát triển Solana trên máy tính của bạn. Tìm hiểu cách cài đặt Rust, Solana CLI và Anchor Framework trên Windows (WSL), Linux và Mac.
- [Cài đặt nhanh](https://solana.com/docs/vi/intro/installation/?utm_source=llms&utm_medium=ai&utm_campaign=txt): Hướng dẫn cài đặt nhanh cho phép bạn thiết lập môi trường phát triển Solana cục bộ chỉ với một lệnh. Cài đặt Rust, Solana CLI và Anchor Framework trên Windows (WSL), Linux và Mac.
- [Các chương trình](https://solana.com/docs/vi/core/programs?utm_source=llms&utm_medium=ai&utm_campaign=txt): Tìm hiểu về các chương trình Solana (hợp đồng thông minh) và cách phát triển chúng bằng Rust hoặc framework Anchor. Hiểu về triển khai, nâng cấp và xác minh chương trình trên mạng Solana.
...
- [Các khái niệm cốt lõi](https://solana.com/docs/vi/core/?utm_source=llms&utm_medium=ai&utm_campaign=txt): Tìm hiểu các khái niệm cốt lõi của blockchain Solana bao gồm tài khoản, giao dịch, chương trình, địa chỉ dẫn xuất từ chương trình, lệnh gọi giữa các chương trình, và cách thức hoạt động của token trên Solana.
...
- [Cơ bản về Anchor CLI](https://solana.com/docs/vi/intro/installation/anchor-cli-basics?utm_source=llms&utm_medium=ai&utm_campaign=txt): Phần này hướng dẫn một số lệnh Anchor CLI phổ biến để giúp bạn bắt đầu.
...
- [Cơ bản về Solana CLI](https://solana.com/docs/vi/intro/installation/solana-cli-basics?utm_source=llms&utm_medium=ai&utm_campaign=txt): Phần này hướng dẫn một số lệnh Solana CLI phổ biến để giúp bạn bắt đầu.
- [Cơ bản về Surfpool CLI](https://solana.com/docs/vi/intro/installation/surfpool-cli-basics?utm_source=llms&utm_medium=ai&utm_campaign=txt): Tìm hiểu các lệnh Surfpool CLI cần thiết cho phát triển Solana cục bộ, bao gồm khởi động validator và sử dụng Surfpool Studio.
...
- [Frontend](https://solana.com/docs/vi/frontend/?utm_source=llms&utm_medium=ai&utm_campaign=txt): Tìm hiểu về việc xây dựng giao diện cho các chương trình Solana.
- [Ghi dữ liệu lên Mạng](https://solana.com/docs/vi/intro/quick-start/writing-to-network?utm_source=llms&utm_medium=ai&utm_campaign=txt): Tìm hiểu cách tương tác với mạng Solana bằng cách gửi giao dịch và hướng dẫn. Theo dõi các ví dụ từng bước để chuyển token SOL và tạo token mới bằng System Program và Token Extensions Program.
- [Giao dịch](https://solana.com/docs/vi/core/transactions?utm_source=llms&utm_medium=ai&utm_campaign=txt): Tìm hiểu về giao dịch Solana—các khối xây dựng cơ bản để tương tác với blockchain Solana. Hiểu cấu trúc giao dịch và cách tạo chỉ thị với các ví dụ thực tế.
- [Giải đóng tài khoản](https://solana.com/docs/vi/tokens/basics/thaw-account?utm_source=llms&utm_medium=ai&utm_campaign=txt): Tìm hiểu cách giải đóng một token account đã bị đóng băng.
...
- [Go SDK](https://solana.com/docs/vi/clients/community/go?utm_source=llms&utm_medium=ai&utm_campaign=txt): Tìm hiểu cách tương tác với Solana bằng Go SDK (gagliardetto/solana-go).
...
- [Hướng dẫn](https://solana.com/docs/vi/core/instructions?utm_source=llms&utm_medium=ai&utm_campaign=txt): Tìm hiểu về các lệnh Solana—những khối xây dựng cơ bản để tương tác với blockchain Solana. Hiểu cách cấu trúc lệnh với các ví dụ thực tế.
...
- [Java SDK](https://solana.com/docs/vi/clients/community/java?utm_source=llms&utm_medium=ai&utm_campaign=txt): Tìm hiểu cách tương tác với Solana bằng Java SDK (sava-software/sava).
...
- [Mollusk](https://solana.com/docs/vi/programs/testing/mollusk?utm_source=llms&utm_medium=ai&utm_campaign=txt): Hướng dẫn toàn diện về việc kiểm thử các chương trình Solana sử dụng Mollusk
...
- [Next.js + Solana React Hooks](https://solana.com/docs/vi/frontend/nextjs-solana?utm_source=llms&utm_medium=ai&utm_campaign=txt): Thiết lập tích hợp ví Solana trong Next.js với @solana/client và @solana/react-hooks để gửi chuyển khoản SOL.
- [Next.js - Solana Kit](https://solana.com/docs/vi/frontend/kit?utm_source=llms&utm_medium=ai&utm_campaign=txt): Thiết lập tích hợp ví Solana trong Next.js với Solana Kit.
- [Nhóm Token và Thành viên](https://solana.com/docs/vi/tokens/extensions/group-member?utm_source=llms&utm_medium=ai&utm_campaign=txt): Tìm hiểu cách kích hoạt GroupPointerExtension và GroupMemberPointerExtension.
- [Phê duyệt Ủy quyền](https://solana.com/docs/vi/tokens/basics/approve-delegate?utm_source=llms&utm_medium=ai&utm_campaign=txt): Tìm hiểu cách phê duyệt ủy quyền cho token account.
- [Phí chuyển khoản](https://solana.com/docs/vi/tokens/extensions/transfer-fees?utm_source=llms&utm_medium=ai&utm_campaign=txt): Tìm hiểu cách triển khai TransferFeeExtension.
...
- [Python SDK](https://solana.com/docs/vi/clients/community/python?utm_source=llms&utm_medium=ai&utm_campaign=txt): Tìm hiểu cách tương tác với Solana bằng Python SDK (michaelhly/solana-py).
...
- [Rust SDK](https://solana.com/docs/vi/clients/official/rust?utm_source=llms&utm_medium=ai&utm_campaign=txt): Các crate Rust chính thức để xây dựng trên Solana.
...
- [SDK Game Solana](https://solana.com/docs/vi/clients/community/game-sdks?utm_source=llms&utm_medium=ai&utm_campaign=txt): Danh sách các SDK Game Solana để giúp bạn bắt đầu tạo trò chơi Solana đầu tiên của mình
...
- [Thiết lập quyền hạn](https://solana.com/docs/vi/tokens/basics/set-authority?utm_source=llms&utm_medium=ai&utm_campaign=txt): Tìm hiểu cách thiết lập quyền hạn cho mint account hoặc token account.
- [Thu hồi Ủy quyền](https://solana.com/docs/vi/tokens/basics/revoke-delegate?utm_source=llms&utm_medium=ai&utm_campaign=txt): Tìm hiểu cách thu hồi ủy quyền của token account.
...
- [Tiện ích mở rộng Metadata & Metadata Pointer](https://solana.com/docs/vi/tokens/extensions/metadata?utm_source=llms&utm_medium=ai&utm_campaign=txt): Tìm hiểu cách kích hoạt tiện ích mở rộng MetadataPointerExtension và TokenMetadata.
- [Token không thể chuyển nhượng](https://solana.com/docs/vi/tokens/extensions/non-transferrable-tokens?utm_source=llms&utm_medium=ai&utm_campaign=txt): Tìm hiểu cách kích hoạt InitializeNonTransferableMint.
- [Token sinh lãi](https://solana.com/docs/vi/tokens/extensions/interest-bearing-tokens?utm_source=llms&utm_medium=ai&utm_campaign=txt): Tìm hiểu cách kích hoạt InterestBearingMintExtension.
...
- [Triển khai một Program](https://solana.com/docs/vi/intro/quick-start/deploying-programs?utm_source=llms&utm_medium=ai&utm_campaign=txt): Học cách xây dựng, triển khai và kiểm thử chương trình Solana đầu tiên của bạn bằng framework Anchor và Solana Playground. Hướng dẫn thân thiện với người mới này sẽ hướng dẫn tạo một chương trình đơn giản, triển khai lên devnet, chạy kiểm thử và đóng chương trình.
- [Trạng thái mặc định](https://solana.com/docs/vi/tokens/extensions/default-state?utm_source=llms&utm_medium=ai&utm_campaign=txt): Tìm hiểu cách kích hoạt DefaultAccountStateExtension.
...
- [Tạo Clients](https://solana.com/docs/vi/programs/codama/clients?utm_source=llms&utm_medium=ai&utm_campaign=txt): Hướng dẫn đầy đủ về việc tạo clients cho các chương trình Solana bằng Codama CLI.
...
- [Tạo một Token Account](https://solana.com/docs/vi/tokens/basics/create-token-account?utm_source=llms&utm_medium=ai&utm_campaign=txt): Tìm hiểu cách tạo SPL Token Accounts.
...
- [Xác minh chương trình](https://solana.com/docs/vi/programs/verified-builds?utm_source=llms&utm_medium=ai&utm_campaign=txt): Bản dựng đã xác minh là cách liên kết chương trình của bạn với mã nguồn của nó và cho phép mọi người độc lập xác minh rằng chương trình thực sự được xây dựng từ mã nguồn đã cung cấp.
...
- [Điểm cuối RPC](https://solana.com/docs/vi/references/clusters?utm_source=llms&utm_medium=ai&utm_campaign=txt): Tìm hiểu về các cụm mạng của Solana (Devnet, Testnet và Mainnet), các điểm cuối RPC công khai, giới hạn tốc độ và trường hợp sử dụng. Tìm hiểu cách kết nối với các mạng Solana khác nhau để phát triển, thử nghiệm và triển khai sản phẩm.
- [Đóng Mint](https://solana.com/docs/vi/tokens/extensions/close-mint?utm_source=llms&utm_medium=ai&utm_campaign=txt): Tìm hiểu cách kích hoạt tiện ích mở rộng MintCloseAuthority.
- [Đóng băng tài khoản](https://solana.com/docs/vi/tokens/basics/freeze-account?utm_source=llms&utm_medium=ai&utm_campaign=txt): Tìm hiểu cách đóng băng các token account.
- [Đóng tài khoản token](https://solana.com/docs/vi/tokens/basics/close-account?utm_source=llms&utm_medium=ai&utm_campaign=txt): Tìm hiểu cách đóng tài khoản token.
...
- [Đại diện vĩnh viễn](https://solana.com/docs/vi/tokens/extensions/permanent-delegate?utm_source=llms&utm_medium=ai&utm_campaign=txt): Tìm hiểu cách triển khai tiện ích mở rộng InitializePermanentDelegate.
- [Địa chỉ dẫn xuất từ chương trình](https://solana.com/docs/vi/core/pda?utm_source=llms&utm_medium=ai&utm_campaign=txt): Tìm hiểu về Địa chỉ dẫn xuất từ chương trình (PDAs) của Solana — địa chỉ tài khoản xác định giúp chương trình ký một cách an toàn. Hiểu về cách dẫn xuất PDA, canonical bump và cách tạo tài khoản PDA.
- [Đọc dữ liệu từ mạng](https://solana.com/docs/vi/intro/quick-start/reading-from-network?utm_source=llms&utm_medium=ai&utm_campaign=txt): Tìm hiểu cách đọc dữ liệu từ mạng blockchain Solana. Hướng dẫn này bao gồm việc lấy tài khoản ví, tài khoản chương trình và tài khoản token mint bằng JavaScript/TypeScript, với các ví dụ thực tế sử dụng thư viện Solana web3.js.
- [Đốt token](https://solana.com/docs/vi/tokens/basics/burn-tokens?utm_source=llms&utm_medium=ai&utm_campaign=txt): Tìm hiểu cách đốt token.
- [Đồng bộ Native](https://solana.com/docs/vi/tokens/basics/sync-native?utm_source=llms&utm_medium=ai&utm_campaign=txt): Tìm hiểu cách chuyển đổi SOL gốc sang wrapped SOL.

## Docs - Zh

- [@solana/client](https://solana.com/docs/zh/frontend/client?utm_source=llms&utm_medium=ai&utm_campaign=txt): 使用无界面 Solana 客户端运行时，构建精简的 Solana 前端。
- [@solana/react-hooks](https://solana.com/docs/zh/frontend/react-hooks?utm_source=llms&utm_medium=ai&utm_campaign=txt): 通过即用型 hooks，在你的 React 应用中共享 @solana/client 的状态。
- [@solana/web3-compat](https://solana.com/docs/zh/frontend/web3-compat?utm_source=llms&utm_medium=ai&utm_campaign=txt): 即插即用的兼容层，让旧版 @solana/web3.js 代码能够在 Kit 基础模块上运行。
- [Anchor CLI 基础](https://solana.com/docs/zh/intro/installation/anchor-cli-basics?utm_source=llms&utm_medium=ai&utm_campaign=txt): 本节将介绍一些常见的 Anchor CLI 命令，帮助您快速入门。
- [CPI Guard](https://solana.com/docs/zh/tokens/extensions/cpi-guard?utm_source=llms&utm_medium=ai&utm_campaign=txt): 了解如何启用 CpiGuardExtension。
...
- [Go SDK](https://solana.com/docs/zh/clients/community/go?utm_source=llms&utm_medium=ai&utm_campaign=txt): 了解如何使用 Go SDK (gagliardetto/solana-go) 与 Solana 交互。
...
- [Java SDK](https://solana.com/docs/zh/clients/community/java?utm_source=llms&utm_medium=ai&utm_campaign=txt): 了解如何使用 Java SDK (sava-software/sava) 与 Solana 交互。
- [Memo 转账](https://solana.com/docs/zh/tokens/extensions/memo-transfer?utm_source=llms&utm_medium=ai&utm_campaign=txt): 了解如何启用 MemoTransferExtension。
- [Mollusk](https://solana.com/docs/zh/programs/testing/mollusk?utm_source=llms&utm_medium=ai&utm_campaign=txt): 使用 Mollusk 测试 Solana 程序的综合指南
- [Next.js + Solana React Hooks](https://solana.com/docs/zh/frontend/nextjs-solana?utm_source=llms&utm_medium=ai&utm_campaign=txt): 在 Next.js 中使用 @solana/client 和 @solana/react-hooks 设置 Solana 钱包集成，实现 SOL 转账。
- [Next.js - Solana Kit](https://solana.com/docs/zh/frontend/kit?utm_source=llms&utm_medium=ai&utm_campaign=txt): 使用 Solana Kit 在 Next.js 中设置 Solana 钱包集成。
...
- [Python SDK](https://solana.com/docs/zh/clients/community/python?utm_source=llms&utm_medium=ai&utm_campaign=txt): 了解如何使用 Python SDK (michaelhly/solana-py) 与 Solana 交互。
- [RPC 端点](https://solana.com/docs/zh/references/clusters?utm_source=llms&utm_medium=ai&utm_campaign=txt): 了解 Solana 的网络集群（Devnet、Testnet 和 Mainnet）、它们的公共 RPC 端点、速率限制及其应用场景。学习如何连接到不同的 Solana 网络以进行开发、测试和生产部署。
...
- [Rust SDK](https://solana.com/docs/zh/clients/official/rust?utm_source=llms&utm_medium=ai&utm_campaign=txt): 用于在 Solana 上构建的官方 Rust crates。
...
- [Solana CLI 基础](https://solana.com/docs/zh/intro/installation/solana-cli-basics?utm_source=llms&utm_medium=ai&utm_campaign=txt): 本节将介绍一些常见的 Solana CLI 命令，帮助您快速入门。
...
- [Solana 游戏 SDK](https://solana.com/docs/zh/clients/community/game-sdks?utm_source=llms&utm_medium=ai&utm_campaign=txt): 一份 Solana 游戏 SDK 列表，帮助您开始创建您的第一个 Solana 游戏
- [Surfpool CLI 基础](https://solana.com/docs/zh/intro/installation/surfpool-cli-basics?utm_source=llms&utm_medium=ai&utm_campaign=txt): 学习 Surfpool CLI 的基本命令，用于本地 Solana 开发，包括启动 validator 和使用 Surfpool Studio。
- [Token 组和成员](https://solana.com/docs/zh/tokens/extensions/group-member?utm_source=llms&utm_medium=ai&utm_campaign=txt): 了解如何启用 GroupPointerExtension 和 GroupMemberPointerExtension。
- [TypeScript SDK](https://solana.com/docs/zh/clients/official/javascript?utm_source=llms&utm_medium=ai&utm_campaign=txt): 了解如何使用 JavaScript/TypeScript 客户端库与 Solana 交互。
...
- [不可变所有者](https://solana.com/docs/zh/tokens/extensions/immutable-owner?utm_source=llms&utm_medium=ai&utm_campaign=txt): 了解如何启用 ImmutableOwner 扩展。
- [不可转让代币](https://solana.com/docs/zh/tokens/extensions/non-transferrable-tokens?utm_source=llms&utm_medium=ai&utm_campaign=txt): 了解如何启用 InitializeNonTransferableMint。
...
- [交易](https://solana.com/docs/zh/core/transactions?utm_source=llms&utm_medium=ai&utm_campaign=txt): 了解 Solana 交易——与 Solana 区块链交互的基本构建块。通过实际示例了解交易结构和指令组成。
- [交易费用](https://solana.com/docs/zh/core/fees?utm_source=llms&utm_medium=ai&utm_campaign=txt): 了解 Solana 的交易费用，包括基础费用和优先费用，各自的应用方式，以及在交易中管理计算单元的最佳实践。
- [从网络读取数据](https://solana.com/docs/zh/intro/quick-start/reading-from-network?utm_source=llms&utm_medium=ai&utm_campaign=txt): 学习如何从 Solana 区块链网络读取数据。本指南涵盖了使用 JavaScript/TypeScript 获取钱包账户、程序账户和代币铸造账户的操作，并通过 Solana web3.js 库提供实际示例。
...
- [元数据与元数据指针扩展](https://solana.com/docs/zh/tokens/extensions/metadata?utm_source=llms&utm_medium=ai&utm_campaign=txt): 了解如何启用 MetadataPointerExtension 和 TokenMetadata 扩展。
- [关闭 Mint](https://solana.com/docs/zh/tokens/extensions/close-mint?utm_source=llms&utm_medium=ai&utm_campaign=txt): 了解如何启用 MintCloseAuthority 扩展。
- [关闭 Token Account](https://solana.com/docs/zh/tokens/basics/close-account?utm_source=llms&utm_medium=ai&utm_campaign=txt): 了解如何关闭 token account。
...
- [冻结账户](https://solana.com/docs/zh/tokens/basics/freeze-account?utm_source=llms&utm_medium=ai&utm_campaign=txt): 了解如何冻结 token 账户。
- [创建一个 Token Account](https://solana.com/docs/zh/tokens/basics/create-token-account?utm_source=llms&utm_medium=ai&utm_campaign=txt): 学习如何创建 SPL Token Account。
...
- [前端](https://solana.com/docs/zh/frontend/?utm_source=llms&utm_medium=ai&utm_campaign=txt): 了解如何为 Solana 程序构建界面。
- [同步原生 SOL](https://solana.com/docs/zh/tokens/basics/sync-native?utm_source=llms&utm_medium=ai&utm_campaign=txt): 了解如何将原生 SOL 转换为包装 SOL。
...
- [安装依赖项](https://solana.com/docs/zh/intro/installation/dependencies?utm_source=llms&utm_medium=ai&utm_campaign=txt): 本指南将帮助您设置本地 Solana 开发环境。了解如何在 Windows (WSL)、Linux 和 Mac 上安装 Rust、Solana CLI 和 Anchor Framework。
...
- [快速安装](https://solana.com/docs/zh/intro/installation/?utm_source=llms&utm_medium=ai&utm_campaign=txt): 一份快速安装指南，帮助您通过一条命令设置本地 Solana 开发环境。在 Windows（WSL）、Linux 和 Mac 上安装 Rust、Solana CLI 和 Anchor 框架。
...
- [批准委托](https://solana.com/docs/zh/tokens/basics/approve-delegate?utm_source=llms&utm_medium=ai&utm_campaign=txt): 了解如何为一个 token account 批准委托。
- [指令](https://solana.com/docs/zh/core/instructions?utm_source=llms&utm_medium=ai&utm_campaign=txt): 了解 Solana 指令——与 Solana 区块链交互的基本构建块。通过实际示例理解指令的组成。
...
- [撤销委托](https://solana.com/docs/zh/tokens/basics/revoke-delegate?utm_source=llms&utm_medium=ai&utm_campaign=txt): 了解如何撤销 token account 的委托。
...
- [核心概念](https://solana.com/docs/zh/core/?utm_source=llms&utm_medium=ai&utm_campaign=txt): 了解 Solana 区块链的基本概念，包括账户、交易、程序、程序派生地址、跨程序调用，以及 Solana 上的代币运作方式。
- [永久委托](https://solana.com/docs/zh/tokens/extensions/permanent-delegate?utm_source=llms&utm_medium=ai&utm_campaign=txt): 了解如何实现 InitializePermanentDelegate 扩展。
- [生成客户端](https://solana.com/docs/zh/programs/codama/clients?utm_source=llms&utm_medium=ai&utm_campaign=txt): 使用 Codama CLI 为 Solana 程序生成客户端的完整指南。
- [直接映射](https://solana.com/docs/zh/references/feature-gates/direct-mapping?utm_source=llms&utm_medium=ai&utm_campaign=txt)
- [程序](https://solana.com/docs/zh/core/programs?utm_source=llms&utm_medium=ai&utm_campaign=txt): 了解 Solana 程序（智能合约）以及如何使用 Rust 或 Anchor 框架开发它们。了解程序的部署、升级和在 Solana 网络上的验证。
- [程序派生地址](https://solana.com/docs/zh/core/pda?utm_source=llms&utm_medium=ai&utm_campaign=txt): 了解 Solana 的程序派生地址 (PDA)——一种确定性的账户地址，能够实现安全的程序签名。了解 PDA 的派生、规范性偏移量以及如何创建 PDA 账户。
...
- [解冻账户](https://solana.com/docs/zh/tokens/basics/thaw-account?utm_source=llms&utm_medium=ai&utm_campaign=txt): 了解如何解冻被冻结的 token account。
- [计息代币](https://solana.com/docs/zh/tokens/extensions/interest-bearing-tokens?utm_source=llms&utm_medium=ai&utm_campaign=txt): 了解如何启用 InterestBearingMintExtension。
- [设置权限](https://solana.com/docs/zh/tokens/basics/set-authority?utm_source=llms&utm_medium=ai&utm_campaign=txt): 了解如何为 mint 或 token account 设置权限。
- [账户](https://solana.com/docs/zh/core/accounts?utm_source=llms&utm_medium=ai&utm_campaign=txt): 了解 Solana 的账户模型，包括账户如何存储数据和程序、租金机制、账户所有权，以及程序与数据账户之间的关系。理解 Solana 键值存储系统的核心概念。
...
- [转账费用](https://solana.com/docs/zh/tokens/extensions/transfer-fees?utm_source=llms&utm_medium=ai&utm_campaign=txt): 了解如何实现 TransferFeeExtension。
...
- [销毁代币](https://solana.com/docs/zh/tokens/basics/burn-tokens?utm_source=llms&utm_medium=ai&utm_campaign=txt): 了解如何销毁代币。
- [限制](https://solana.com/docs/zh/programs/limitations?utm_source=llms&utm_medium=ai&utm_campaign=txt)
- [验证程序](https://solana.com/docs/zh/programs/verified-builds?utm_source=llms&utm_medium=ai&utm_campaign=txt): 验证构建是一种将程序与其源代码关联起来的方法，使每个人都可以独立验证该程序确实是从提供的源代码构建而来的。
- [默认状态](https://solana.com/docs/zh/tokens/extensions/default-state?utm_source=llms&utm_medium=ai&utm_campaign=txt): 了解如何启用 DefaultAccountStateExtension。
...
- [Delivery vs Payment (DvP) on Solana](https://solana.com/developers/guides/advanced/dvp?utm_source=llms&utm_medium=ai&utm_campaign=txt): Learn how to implement atomic Delivery vs Payment (DvP) for commercial paper  and securities using SPL Token 2022 extensions and standard USDC, without  writing custom Rust programs.
...
- [IDL - an easy to use Program Interface](https://solana.com/developers/guides/advanced/idls?utm_source=llms&utm_medium=ai&utm_campaign=txt): IDLs are a JSON representation of a program and let you decode the program
- [NAV Strikes for Money Market Funds on Solana](https://solana.com/developers/guides/advanced/nav-strikes?utm_source=llms&utm_medium=ai&utm_campaign=txt): Learn how to implement multiple daily NAV strikes for money market funds  using SPL Token 2022 extensions, enabling institutional-grade subscription and  redemption with atomic settlement.
...
- [How to Authenticate Users with Solana Wallets Using Supabase](https://solana.com/developers/guides/getstarted/supabase-auth-guide?utm_source=llms&utm_medium=ai&utm_campaign=txt): Step-by-step guide to implement Solana wallet authentication in your Next.js  application using Supabase. Learn how to connect Phantom or Solflare wallets,  authenticate users with wallet signatures, and protect routes. Perfect for  developers building Solana dApps who want secure, passwordless authentication.
...
- [How to get started with x402 on Solana](https://solana.com/developers/guides/getstarted/intro-to-x402?utm_source=llms&utm_medium=ai&utm_campaign=txt): This guide explains what x402 is and how to build a simple
- [x402 Integration with Kora - Complete Demo Guide](https://solana.com/developers/guides/getstarted/build-a-x402-facilitator?utm_source=llms&utm_medium=ai&utm_campaign=txt): Learn how to integrate the x402 payment protocol with Kora
